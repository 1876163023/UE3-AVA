...
{
#if XBOX
	DECLARE_CLASS(UXnaForceFeedbackManager,UForceFeedbackManager,CLASS_Config|CLASS_Transient,XeDrv)
#else
	DECLARE_CLASS(UXnaForceFeedbackManager,UForceFeedbackManager,CLASS_Config|CLASS_Transient,WinDrv)
#endif
