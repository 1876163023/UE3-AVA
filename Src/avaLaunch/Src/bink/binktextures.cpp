...
//#include "../../Engine/Inc/RHI.h"
#include "../../D3DDrv/Src/D3DPerfSaver.h"
						...
						F32 alpha_level )
{
	...
	FSamplerStateRHIRef GBinkSamplerStateRHIRef;

	GBinkSamplerStateRHIRef = RHICreateSamplerState( SamplerStateInitializer );

	for( i = 0 ; i < 4 ; i++ )
	{    
		GD3DPerfSaver->SetSamplerState( i, FALSE, GBinkSamplerStateRHIRef );	
	}
