...
class avaSkelControl_TurretConstrained extends SkelControlSingleBone
	native;
...
//! true 값이 설정되면 TickkSkelControl()함수 호출 시
//! 1번만 강제로 적용되고 false로 풀린다.(2007/08/07 고광록)
var bool bIgnoreOnceLagDegreesPerSecond;
