/***
	...
	Name: UIDataProvider_GroupValueList.uc

	Description: 리스트인덱스가 값을 나타내는 단순한 리스트를 위해 사용 (최대인원, 승리조건 등등)

***/
class avaUIDataProvider_GroupValueList extends UIDataProvider
	native(inherit)
	implements(UIListElementCellProvider)
	transient;

var transient byte ClassIndex;
