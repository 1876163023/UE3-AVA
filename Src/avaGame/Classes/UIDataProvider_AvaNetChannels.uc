/***
	...
	Name: UIDataProvider_AvaNetChannels.uc

	Description: Supplys list of channels to the UIDataStore_AvaNet.

***/
class UIDataProvider_AvaNetChannels extends UIDataProvider
	native(inherit)
