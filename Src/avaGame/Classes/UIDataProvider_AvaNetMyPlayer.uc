/***
	...
	Name: UIDataProvider_AvaNetMyPlayer.uc

	Description: Supplys information about my player to the UIDataStore_AvaNet.

***/
class UIDataProvider_AvaNetMyPlayer extends avaUIParamDataProvider
	native(inherit)
	transient;
