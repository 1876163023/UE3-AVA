 ...
 * @ingroup _AVAGame
 *
 * 유료 아이템중 상점 아이템의 정보를 제공하는 데이터 프로바이더
 *
 * @date 2007-11-12
 *
 * @author YTS
 *
 */
class UIDataProvider_AvaNetCashItemShop extends avaUIParamDataProvider
	native(inherit)
...
var input CashItemEffectType	CurrentEffectType;		//!< 리스트에 보여지는 아이템의 종류.
var input int					SelectedItemListIndex;	//!< 선택된 아이템의 리스트 인덱스.
