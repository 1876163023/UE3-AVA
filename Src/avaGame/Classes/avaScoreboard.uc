 ...
 */
class avaScoreboard extends ScoreBoard
	config(Game);
...
function bool SBInputKey(int ControllerID, name Key, EInputEvent Event, float AmountDepressed)
{
...
//	HudTexture=Texture2D'avaUI.Textures.UTOldHUD'
}
