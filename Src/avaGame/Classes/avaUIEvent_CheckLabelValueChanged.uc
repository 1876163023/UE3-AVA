 ...
 */
class avaUIEvent_CheckLabelValueChanged extends UIEvent_ValueChanged
	native;
...
{
	return TargetObject == None || avaUICheckLabelButton(TargetObject) != None;
}

DefaultProperties
{
	ObjName="CheckLabel Value"
