...
/***
	...
	Name: avaUIDataProvider_AudioSettings.uc

	Description: 오디오 설정(음량, 채널수)

***/
class UIDataProvider_AvaNetOptionSettingAudio extends UIDataProvider
	native
	implements(UIListElementCellProvider, UIListElementProvider)
	transient;

const SystemVolumeMax	= 2.0;
const SystemVolumeMin	= 0.001;
const MusicVolumeMax	= 2.0;
const MusicVolumeMin	= 0.001;
const GameVolumeMax		= 2.0;
const GameVolumeMin		= 0.001;
