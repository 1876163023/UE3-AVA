...
***/
class UIDataStore_AvaNet extends UIDataStore
	native(inherit)
...
var UIDataProvider_AvaNetMyPlayer MyPlayerProvider;
var UIDataProvider_AvaNetSelectedRoom SelectedRoomProvider;
var UIDataProvider_AvaNetChannels ChannelsProvider;
var UIDataProvider_AvaNetLobbyRooms LobbyRoomsProvider;
var UIDataProvider_AvaNetLobbyPlayers LobbyPlayersProvider;
var UIDataProvider_AvaNetLobbyFriendPlayers LobbyFriendPlayersProvider;
var UIDataProvider_AvaNetLobbyBlockedPlayers LobbyBlockedPlayersProvider;
var UIDataProvider_AvaNetChatMsgs ChatMsgsProvider;
var UIDataProvider_AvaNetInventory InventoryProvider;
var UIDataProvider_AvaNetShopItems ShopItemsProvider;
var UIDataProvider_AvaNetShopCustomItems ShopCustomItemsProvider;
var UIDataProvider_AvaNetLastResult LastResultProvider;
var UIDataProvider_AvaNetItemDesc ItemDescProvider;
var UIDataProvider_AvaNetItemDescField ItemDescFieldProvider;
var UIDataProvider_AvaNetItemDescList ItemDescListProvider;
var UIDataProvider_AvaNetMisc MiscProvider;
var UIDataProvider_AvaNetMiscField MiscFieldProvider;
var UIDataProvider_AvaNetGuildInfoField GuildInfoFieldProvider;
var UIDataProvider_AvaNetGuildMembers GuildMembersProvider;
var UIDataProvider_AvaNetFilteredWeapons	FilteredWeaponProvider;
var UIDataProvider_AvaNetRoomPlayerField RoomPlayerFieldProvider;
var deprecated UIDataProvider_AvaNetRoomSettings RoomSettingsProvider;
var UIDataProvider_AvaNetLastResultMsgs LastResultMsgProvider;
var UIDataProvider_AvaNetEffectItems EffectItemsProvider;

var array<UIDataProvider> PlayerWeaponProviders;
var array<UIDataProvider> PlayerEquipProviders;
var array<UIDataProvider> PlayerCustomProviders;
...
{
	`log( PlayerOwner @ ": UIDataStore_AvaNet registered" );
}
...
{
	`log( PlayerOwner @ ": UIDataStore_AvaNet unregistered" );
}
...
defaultproperties
{
	...
	InternalProviderData.Add((ProviderClass=class'UIDataProvider_AvaNetRoomSettings',ProviderTag=RoomSettings))
	InternalProviderData.Add((ProviderClass=class'UIDataProvider_AvaNetCashItems',ProviderTag=CashItems))
	InternalProviderData.Add((ProviderClass=class'UIDataProvider_AvaNetOptionSettings',ProviderTag=OptionSettings))
	InternalProviderData.Add((ProviderClass=class'UIDataProvider_AvaNetLastGameResult',ProviderTag=LastGameResult))
	InternalProviderData.Add((ProviderClass=class'UIDataProvider_AvaNetReadyRoom',ProviderTag=ReadyRoom))
	InternalProviderData.Add((ProviderClass=class'UIDataProvider_AvaNetMyPlayer',ProviderTag=MyPlayer))
	InternalProviderData.Add((ProviderClass=class'UIDataProvider_AvaNetMainNavigation',ProviderTag=MainNavigation))
	InternalProviderData.Add((ProviderClass=class'UIDataProvider_AvaNetPlayerInfo',ProviderTag=PlayerInfo))
}
