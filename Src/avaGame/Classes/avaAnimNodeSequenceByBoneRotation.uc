/** when this node becomes relevant, it selects an animation from its list based on the rotation of the given bone
 * relative to the rotation of the owning actor
 */
class avaAnimNodeSequenceByBoneRotation extends AnimNodeSequence;
