/***
	...
	Name: UIDataProvider_AvaNetRoomSettings.uc

	Description: 방 만들기/ 대기방 에서의 방설정( 최대인원, 팀킬, 난입가능 ... ) 정보 표시,조작

***/
class UIDataProvider_AvaNetRoomSettings extends avaUIParamDataProvider
	native(inherit)
...
var() input string	RoomName;
var() input string	RoomPassword;
//var() input int		MapListIndex;

//var() input int		tkLevel;
//var() input bool	autoBalance;
//var() input bool	allowSpectator;
//var() input bool	allowInterrupt;
//var() input bool	allowBackView;
//var() input bool	allowGhostChat;
//var() input int		roundToWin;
//var() input int		maxRoomPlayer;
//var() input bool	automaticTeamSwap;

var			int		PreviousMissionType;
var() input int		SelectedMissionType;

var() input bool	bLoadRoomSetting;		// Lobby - Default Setting, ReadyRoom - Current Setting
var() input bool	bSettingChangeRequest;	// Lobby - CreateRoom Request, ReadyRoom - ReadyRoom Setting Changed Notify

defaultproperties
{
	WriteAccessType=ACCESS_WriteAll
	SelectedMissionType=INDEX_NONE
}