/***
	...
	Name: UIDataProvider_AvaNetEffectItems.uc

	Description: Supplys list of EffectItems (Icon, Desc, Name) 

***/
class UIDataProvider_AvaNetEffectItems extends UIDataProvider
	native(inherit)
