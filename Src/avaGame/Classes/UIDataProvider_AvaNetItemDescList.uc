...
***/
class UIDataProvider_AvaNetItemDescList extends UIDataProvider
	native(inherit)
	implements(UIListElementCellProvider)
	transient;

var transient int ItemId;
var transient int InvenIndex;
var transient int CustomSlotIndex;
var transient int EquipInvenIndex;
var transient bool bHideItemDesc;
