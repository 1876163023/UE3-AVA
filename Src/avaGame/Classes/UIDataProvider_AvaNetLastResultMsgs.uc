/***
	...
	Name: UIDataProvider_AvaNetLastResultMsgs.uc

	Description: Supplys the last messages of the current game result to the UIDataStore_AvaNet.

***/
class UIDataProvider_AvaNetLastResultMsgs extends UIDataProvider
	native(inherit)
