/***
	...
	Name: UIDataProvider_AvaNetOptionSettingVideo.uc

	Description: get/set some video settings

***/
class UIDataProvider_AvaNetOptionSettingVideo extends UIDataProvider
	native
