/***
	...
	Name: UIDataProvider_AvaNetLobbyRooms.uc

	Description: Supplys list of rooms in a lobby to the UIDataStore_AvaNet.

***/
class UIDataProvider_AvaNetLobbyRooms extends UIDataProvider
	native(inherit)
