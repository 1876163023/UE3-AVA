/***
	...
	Name: UIDataProvider_AvaNetRoomPlayerField.uc

	Description: 대기방(일반 대기방/친선 클랜 대기방) 내의 대기중인 플레이어 정보

***/
class UIDataProvider_AvaNetRoomPlayerField extends UIDataProvider
	native(inherit)
	transient;
