/***
	...
	Name: UIDataProvider_AvaNetLastResultAwardSkill.uc

	Description: Supplys the last game results to the UIDataStore_AvaNet.

***/
class avaUIDataProvider_LastResultAwardSkill extends UIDataProvider
	native
	implements(UIListElementCellProvider)
	transient;

const SKILL_LISTINDEX_BASE	= 10000;	/** Not selectable in the scene editor.																									*/
