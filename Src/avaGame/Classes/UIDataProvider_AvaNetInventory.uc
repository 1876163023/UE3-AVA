/***
	...
	Name: UIDataProvider_AvaNetInventory.uc

	Description: Supplys list of the player's inventory to the UIDataStore_AvaNet.

***/
class UIDataProvider_AvaNetInventory extends UIDataProvider
	native(inherit)
