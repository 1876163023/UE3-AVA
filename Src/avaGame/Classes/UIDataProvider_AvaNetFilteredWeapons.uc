/***
	...
	Name: UIDataProvider_AvaNetFilteredWeapons.uc

	Description: 게임이 한판 끝난후에 보여줄 무기목록 ( 내구도, 정비도 일정기준 이하 )

***/
class UIDataProvider_AvaNetFilteredWeapons extends UIDataProvider
	native(inherit)
...
{
	WEAPONDISPFILTER_EQUIPPED_PRIWEAP_POINTMAN,
	WEAPONDISPFILTER_EQUIPPED_PRIWEAP_RIFLEMAN,
	WEAPONDISPFILTER_EQUIPPED_PRIWEAP_SNIPER,
	WEAPONDISPFILTER_CUSTOMPARTS_PRIWEAP_POINTMAN,
	WEAPONDISPFILTER_CUSTOMPARTS_PRIWEAP_RIFLEMAN,
	WEAPONDISPFILTER_CUSTOMPARTS_PRIWEAP_SNIPER,
	WEAPONDISPFILTER_EQUIPPED_WEAP_EXCEPT_PRIWEAP,
	WEAPONDISPFILTER_EQUIPPED_EQUIPS,
	WEAPONDISPFILTER_NONE,
};

var transient EFilteredWeapons_DisplayFilter DisplayFilter;
