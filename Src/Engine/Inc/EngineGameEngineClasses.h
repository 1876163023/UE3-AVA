...
public:
    ...
    class UMaterial* MissingCollisionMaterial;
    FStringNoInit MissingCollisionMaterialName;
    ...
    class UMaterial* PropertyColorationLitMaterial;
    FStringNoInit PropertyColorationLitMaterialName;
    class UMaterial* PropertyColorationUnlitMaterial;
    FStringNoInit PropertyColorationUnlitMaterialName;
    ...
    class UMaterial* EnvCubeActorMaterial;
    FStringNoInit EnvCubeActorMaterialName;
    ...
    class UTrueTypeFontManager* TTFManager;
    FLOAT MeshLODRange;
    INT ShadowFilterQuality;
...
struct FPerMapPackagesInfo
{
    ...
    /** Constructors */
    FPerMapPackagesInfo() {}
    FPerMapPackagesInfo(EEventParm)
    {
        appMemzero(this, sizeof(FPerMapPackagesInfo));
    }
};
...
public:
    ...
    TArrayNoInit<struct FPerMapPackagesInfo> PerMapPackagesToLoad;
    struct FViewportResizer GViewportResizer;
...
VERIFY_CLASS_OFFSET_NODIE(U,Engine,TerrainCollisionMaterialName)
VERIFY_CLASS_SIZE_NODIE(UEngine)
VERIFY_CLASS_OFFSET_NODIE(U,GameEngine,GPendingLevel)
VERIFY_CLASS_OFFSET_NODIE(U,GameEngine,GViewportResizer)
