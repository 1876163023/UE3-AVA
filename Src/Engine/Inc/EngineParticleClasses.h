...
public:
    ...
    void eventSetTemplate(class UParticleSystem* NewTemplate,UBOOL bDestroyOnFinish=0)
    {
        Emitter_eventSetTemplate_Parms Parms(EC_EventParm);
        Parms.NewTemplate=NewTemplate;
        Parms.bDestroyOnFinish=bDestroyOnFinish ? FIRST_BITFIELD : 0;
...
VERIFY_CLASS_OFFSET_NODIE(U,ParticleModuleBeamNoise,NoiseTessellation)
...
VERIFY_CLASS_OFFSET_NODIE(U,ParticleModuleCollision,VerticalFudgeFactor)
...
VERIFY_CLASS_OFFSET_NODIE(U,ParticleModuleRequired,EmitterDuration)
