...
{
    AudioChannel_Auto       =0,
    AudioChannel_Replace    =1,
    AudioChannel_Weapon     =2,
    AudioChannel_Voice      =3,
    AudioChannel_Item       =4,
    AudioChannel_Body       =5,
    AudioChannel_MAX        =6,
};
...
enum ReverbPreset
{
    ...
    REVERB_Cave             =9,
    REVERB_Arena            =10,
    REVERB_CarpettedHallway =11,
    REVERB_Hallway          =12,
    REVERB_StoneCorridor    =13,
    REVERB_Alley            =14,
    REVERB_Forest           =15,
    REVERB_City             =16,
    REVERB_Mountains        =17,
    REVERB_Quarry           =18,
    REVERB_Plain            =19,
    REVERB_ParkingLot       =20,
    REVERB_SewerPipe        =21,
    REVERB_Underwater       =22,
    REVERB_MAX              =23,
};
...
{
    IMENOTIFYCOMPSTR_Cancel =0,
    IMENOTIFYCOMPSTR_Complete=1,
    IMENOTIFYCOMPSTR_Convert=2,
    IMENOTIFYCOMPSTR_Revert =3,
    IMENOTIFYCOMPSTR_MAX    =4,
};
enum EIMENotifyAction
{
    IMENOTIFY_OpenCandidate =0,
    IMENOTIFY_CloseCandidate=1,
    IMENOTIFY_SelectCandidatestr=2,
    IMENOTIFY_ChangeCandidatelist=3,
    IMENOTIFY_FinalizeConversionResult=4,
    IMENOTIFY_CompositionStr=5,
    IMENOTIFY_SetCandidate_PageStart=6,
    IMENOTIFY_SetCandidate_PageSize=7,
    IMENOTIFY_ImeMenuSelected=8,
    IMENOTIFY_MAX           =9,
};
enum EIMECOMPOSITIONType
{
    IMECOMPOSITION_None     =0,
    IMECOMPOSITION_InputLangChanged=1,
    IMECOMPOSITION_Start    =2,
    IMECOMPOSITION_Composition=3,
    IMECOMPOSITION_Result   =4,
    IMECOMPOSITION_End      =5,
    IMECOMPOSITION_MAX      =6,
};
enum EKBDINPUTLANGType
{
    KBDINPUTLANG_Default    =0,
    KBDINPUTLANG_TraditionalChinese=1,
    KBDINPUTLANG_Japanese   =2,
    KBDINPUTLANG_Korean     =3,
    KBDINPUTLANG_SimplifiedChinese=4,
    KBDINPUTLANG_MAX        =5,
};
enum ESafeZoneType
{
...
enum TextureGroup
{
    ...
    TEXTUREGROUP_Weapon     =4,
    TEXTUREGROUP_WeaponNormalMap=5,
    TEXTUREGROUP_Vehicle    =6,
    TEXTUREGROUP_VehicleNormalMap=7,
    TEXTUREGROUP_Effects    =8,
    TEXTUREGROUP_Skybox     =9,
    TEXTUREGROUP_UI         =10,
    TEXTUREGROUP_LightAndShadowMap=11,
...
AUTOGENERATE_NAME(ClientCrossFadeMusicTrack)
...
AUTOGENERATE_NAME(GetCollisionRadius)
AUTOGENERATE_NAME(GetFaceFXAudioComponent)
AUTOGENERATE_NAME(GetForegroundFOVAngle)
...
AUTOGENERATE_NAME(HmAddWeapon)
AUTOGENERATE_NAME(HmAddWeaponBegin)
AUTOGENERATE_NAME(HmAddWeaponEnd)
AUTOGENERATE_NAME(HmLogin)
AUTOGENERATE_NAME(HmReinit)
AUTOGENERATE_NAME(HmSwitchToBestWeapon)
...
AUTOGENERATE_NAME(InputAxis)
AUTOGENERATE_NAME(InputCandidate)
AUTOGENERATE_NAME(InputChar)
AUTOGENERATE_NAME(InputKey)
AUTOGENERATE_NAME(InputReadingString)
...
AUTOGENERATE_NAME(NotifyTakeScreenShot)
AUTOGENERATE_NAME(OnAnimEnd)
AUTOGENERATE_NAME(OnAnimPlay)
AUTOGENERATE_NAME(OnHmBackup)
AUTOGENERATE_NAME(OnHmRestore)
...
struct Actor_eventOnHmRestore_Parms
{
    Actor_eventOnHmRestore_Parms(EEventParm)
    {
    }
};
struct Actor_eventOnHmBackup_Parms
{
    Actor_eventOnHmBackup_Parms(EEventParm)
    {
    }
};
struct Actor_eventHmReinit_Parms
{
    Actor_eventHmReinit_Parms(EEventParm)
    {
    }
};
...
public:
    ...
    struct FAmbientSH CurrentAmbientCube;
    FLOAT LastAmbientCubeUpdatedTime;
    //## END PROPS Actor
    ...
    void DrawDebugLine(FVector LineStart,FVector LineEnd,BYTE R,BYTE G,BYTE B,UBOOL bPersistentLines=0);
    void DrawDebugBox(FVector Center,FVector Extent,BYTE R,BYTE G,BYTE B,UBOOL bPersistentLines=0);
    void DrawDebugCoordinateSystem(FVector AxisLoc,FRotator AxisRot,FLOAT Scale,UBOOL bPersistentLines=0);
    void DrawDebugSphere(FVector Center,FLOAT Radius,INT Segments,BYTE R,BYTE G,BYTE B,UBOOL bPersistentLines=0);
    void DrawDebugCylinder(FVector Start,FVector End,FLOAT Radius,INT Segments,BYTE R,BYTE G,BYTE B,UBOOL bPersistentLines=0);
    void DrawDebugCone(FVector Origin,FVector Direction,FLOAT Length,FLOAT AngleWidth,FLOAT AngleHeight,INT NumSides,FColor DrawColor,UBOOL bPersistentLines=0);
    ...
    UBOOL TouchingActor(class AActor* A);
    void GetComponentsBoundingBox(FBox& ActorBox);
    virtual void GetBoundingCylinder(FLOAT& CollisionRadius,FLOAT& CollisionHeight);
    void SetTimer(FLOAT InRate,UBOOL inbLoop=0,FName inTimerFunc=FName(TEXT("Timer")),class UObject* inObj=NULL);
    ...
    class UAudioComponent* CreateAudioComponent(class USoundCue* InSoundCue,UBOOL bPlay=0,UBOOL bStopWhenOwnerDestroyed=0,UBOOL bUseLocation=0,FVector SourceLocation=FVector(),UBOOL bAttachToSelf=TRUE,BYTE Channel=0);
    ...
    DECLARE_FUNCTION(execDrawDebugLine)
    {
        ...
        P_GET_BYTE(G);
        P_GET_BYTE(B);
        P_GET_UBOOL_OPTX(bPersistentLines,0);
        P_FINISH;
    ...
    DECLARE_FUNCTION(execCreateAudioComponent)
    {
        ...
        P_GET_UBOOL_OPTX(bStopWhenOwnerDestroyed,0);
        P_GET_UBOOL_OPTX(bUseLocation,0);
        P_GET_STRUCT_OPTX(FVector,SourceLocation,FVector());
        P_GET_UBOOL_OPTX(bAttachToSelf,TRUE);
        P_GET_BYTE_OPTX(Channel,0);
        P_FINISH;
        *(class UAudioComponent**)Result=CreateAudioComponent(InSoundCue,bPlay,bStopWhenOwnerDestroyed,bUseLocation,SourceLocation,bAttachToSelf,Channel);
    }
    ...
    void eventSetAnimPosition(FName SlotName,INT ChannelIndex,FName InAnimSeqName,FLOAT InPosition,UBOOL bFireNotifies)
    {
        ...
        Parms.bFireNotifies=bFireNotifies ? FIRST_BITFIELD : 0;
    ...
    void eventTakeDamage(INT DamageAmount,class AController* EventInstigator,FVector HitLocation,FVector Momentum,class UClass* DamageType,struct FTraceHitInfo HitInfo=FTraceHitInfo(),class UClass* DamageCauser=NULL)
    {
    ...
    void eventOnHmRestore()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_OnHmRestore),NULL);
    }
    void eventOnHmBackup()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_OnHmBackup),NULL);
    }
    void eventHmReinit()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_HmReinit),NULL);
    }
    void eventTornOff()
    {
...
public:
    ...
    INT LocationNameIndex;
    BITFIELD bForcePawnWalk:1;
    BITFIELD bProcessAllActors:1;
    BITFIELD bIgnoreBlockRigidBody:1;
    //## END PROPS Volume
...
class AAmbientCubeVolume : public AVolume
{
public:
    //## BEGIN PROPS AmbientCubeVolume
    INT CubeSizeX;
    INT CubeSizeY;
    INT CubeSizeZ;
    INT Priority;
    //## END PROPS AmbientCubeVolume

    DECLARE_CLASS(AAmbientCubeVolume,AVolume,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(AAmbientCubeVolume)
};
...
public:
    ...
    BITFIELD bIgnoreProjectile:1;
    BITFIELD bIgnorePawn:1;
...
class AMinimapVolume : public AVolume
{
public:
    //## BEGIN PROPS MinimapVolume
    //## END PROPS MinimapVolume

    DECLARE_CLASS(AMinimapVolume,AVolume,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(AMinimapVolume)
};

class AOcclusionGroup : public AVolume
{
public:
    //## BEGIN PROPS OcclusionGroup
    class UOcclusionGroupComponent* Component;
    //## END PROPS OcclusionGroup

    DECLARE_CLASS(AOcclusionGroup,AVolume,0,Engine)
	virtual void PostBeginPlay();
};
...
struct FPostProcessSettings
{
    ...
    FLOAT Tonemap_MinExposure;
    FLOAT Tonemap_MaxExposure;
    FLOAT Tonemap_InterpolationDuration;
    FLOAT Tonemap_Beta;
    FLOAT Tonemap_Lmax;
    FLOAT Tonemap_Darkness;
    FLOAT Tonemap_LavgScale;
    FLOAT Tonemap_ScaleBias;
    FLOAT Tonemap_MaxKeyValue;
    FLOAT Tonemap_MinKeyValue;
    FLOAT Tonemap_KeyValueScale;
    FLOAT Tonemap_KeyValueOffset;
    FLOAT Tonemap_Shadow;
    FLOAT Tonemap_Highlight;
    INT ColorCorrection_Index;
    FLOAT ColorCorrection_InterpolationDuration;
...
{
    BYTE ReverbType;
    class UReverbProperty* UserdefinedReverbPreset;
    FLOAT Volume;
    FLOAT FadeTime;
};
...
{
public:
    //## BEGIN PROPS DynamicTriggerVolume
    //## END PROPS DynamicTriggerVolume

    DECLARE_CLASS(ADynamicTriggerVolume,ATriggerVolume,0,Engine)
	/** Returns the size of the extent to use when moving the object through the world */
	virtual FVector GetCylinderExtent() const
	{
		FVector Extent(0.f);
...
public:
    ...
    virtual void RouteCache_RemoveIndex(INT Index,INT Count=1);
    ...
    void FinishRotation();
    class AActor* FindPathTo(FVector aPoint,FLOAT MaxPathLength=0,UBOOL bReturnPartial=0);
    class AActor* FindPathToward(class AActor* anActor,UBOOL bWeightDetours=0,FLOAT MaxPathLength=0,UBOOL bReturnPartial=0);
    class AActor* FindPathTowardNearest(class UClass* GoalClass,UBOOL bWeightDetours=0,FLOAT MaxPathLength=0,UBOOL bReturnPartial=0);
    class ANavigationPoint* FindRandomDest();
    class AActor* FindPathToIntercept(class APawn* P,class AActor* InRouteGoal,UBOOL bWeightDetours=0,FLOAT MaxPathLength=0,UBOOL bReturnPartial=0);
    ...
    DECLARE_FUNCTION(execRouteCache_RemoveIndex)
    {
        ...
        P_FINISH;
        RouteCache_RemoveIndex(Index,Count);
    }
    ...
    DECLARE_FUNCTION(execFindPathTo)
    {
        ...
        P_GET_UBOOL_OPTX(bReturnPartial,0);
        P_FINISH;
    ...
    void eventPossess(class APawn* inPawn,UBOOL bVehicleTransition)
    {
        ...
        Parms.inPawn=inPawn;
        Parms.bVehicleTransition=bVehicleTransition ? FIRST_BITFIELD : 0;
...
#define UCONST_MAXNEARZEROVELOCITYSQUARED 36.0
#define UCONST_MAXPOSITIONERRORSQUARED 12.0

struct PlayerController_eventNotifyTakeScreenShot_Parms
{
    FString ScreenShotPath;
    PlayerController_eventNotifyTakeScreenShot_Parms(EEventParm)
    {
    }
};
...
struct PlayerController_eventClientCrossFadeMusicTrack_Parms
{
    class USeqAct_CrossFadeMusicTracks* MusicAction;
    struct FMusicTrackStruct MusicTrack;
    PlayerController_eventClientCrossFadeMusicTrack_Parms(EEventParm)
    {
    }
};
...
struct PlayerController_eventGetForegroundFOVAngle_Parms
{
    FLOAT ReturnValue;
    PlayerController_eventGetForegroundFOVAngle_Parms(EEventParm)
    {
    }
};
...
public:
    ...
    FLOAT NetClientAdjustTime;
    BITFIELD bHmForceSpectating:1;
    BITFIELD bHmRestoring:1;
    BITFIELD bFrozen:1;
    ...
    BITFIELD bUseFreeCam:1;
    BITFIELD bDisableRagdoll:1;
    ...
    INT ReconfigureNetspeedThreshold;
    INT StableNetspeed;
    FLOAT OldPing;
    ...
    void eventNotifyTakeScreenShot(const FString& ScreenShotPath=TEXT(""))
    {
        PlayerController_eventNotifyTakeScreenShot_Parms Parms(EC_EventParm);
        Parms.ScreenShotPath=ScreenShotPath;
        ProcessEvent(FindFunctionChecked(ENGINE_NotifyTakeScreenShot),&Parms);
    }
    ...
    void eventClientCrossFadeMusicTrack(class USeqAct_CrossFadeMusicTracks* MusicAction,struct FMusicTrackStruct MusicTrack)
    {
        PlayerController_eventClientCrossFadeMusicTrack_Parms Parms(EC_EventParm);
        Parms.MusicAction=MusicAction;
        Parms.MusicTrack=MusicTrack;
        ProcessEvent(FindFunctionChecked(ENGINE_ClientCrossFadeMusicTrack),&Parms);
    }
    ...
    void eventNotifyDirectorControl(UBOOL bNowControlling)
    {
        ...
        Parms.bNowControlling=bNowControlling ? FIRST_BITFIELD : 0;
    ...
    void eventGetSeamlessTravelActorList(UBOOL bToEntry,TArray<class AActor*>& ActorList)
    {
        ...
        Parms.bToEntry=bToEntry ? FIRST_BITFIELD : 0;
    ...
    void eventClientCommitMapChange(UBOOL bShouldSkipLevelStartupEvent=0,UBOOL bShouldSkipLevelBeginningEvent=0)
    {
        PlayerController_eventClientCommitMapChange_Parms Parms(EC_EventParm);
        Parms.bShouldSkipLevelStartupEvent=bShouldSkipLevelStartupEvent ? FIRST_BITFIELD : 0;
        Parms.bShouldSkipLevelBeginningEvent=bShouldSkipLevelBeginningEvent ? FIRST_BITFIELD : 0;
    ...
    void eventClientPrepareMapChange(FName LevelName,UBOOL bFirst,UBOOL bLast)
    {
        ...
        Parms.bFirst=bFirst ? FIRST_BITFIELD : 0;
        Parms.bLast=bLast ? FIRST_BITFIELD : 0;
    ...
    void eventLevelStreamingStatusChanged(class ULevelStreaming* LevelObject,UBOOL bNewShouldBeLoaded,UBOOL bNewShouldBeVisible,UBOOL bNewShouldBlockOnLoad)
    {
        ...
        Parms.bNewShouldBeLoaded=bNewShouldBeLoaded ? FIRST_BITFIELD : 0;
        Parms.bNewShouldBeVisible=bNewShouldBeVisible ? FIRST_BITFIELD : 0;
        Parms.bNewShouldBlockOnLoad=bNewShouldBlockOnLoad ? FIRST_BITFIELD : 0;
    ...
    {
        PlayerController_eventGetForegroundFOVAngle_Parms Parms(EC_EventParm);
        Parms.ReturnValue=0;
        ProcessEvent(FindFunctionChecked(ENGINE_GetForegroundFOVAngle),&Parms);
        return Parms.ReturnValue;
    }
    ...
    void eventClientSetProgressMessage(INT Index,const FString& S,FColor C)
    {
    ...
    void eventConditionalPause(UBOOL bDesiredPauseState)
    {
        ...
        Parms.bDesiredPauseState=bDesiredPauseState ? FIRST_BITFIELD : 0;
    ...
    void eventTeamMessage(class APlayerReplicationInfo* PRI,const FString& S,FName Type,FLOAT MsgLifeTime=0,INT TypeIdx=0)
    {
    ...
    void eventKismet_ClientPlaySound(class USoundCue* ASound,class AActor* SourceActor,FLOAT VolumeMultiplier,FLOAT PitchMultiplier,FLOAT FadeInTime,UBOOL bSuppressSubtitles,UBOOL bSuppressSpatialization,BYTE Channel=0)
    {
        ...
        Parms.bSuppressSubtitles=bSuppressSubtitles ? FIRST_BITFIELD : 0;
        Parms.bSuppressSpatialization=bSuppressSpatialization ? FIRST_BITFIELD : 0;
        Parms.Channel=Channel;
        ProcessEvent(FindFunctionChecked(ENGINE_Kismet_ClientPlaySound),&Parms);
    }
    void eventClientHearSound(class USoundCue* ASound,class AActor* SourceActor,FVector SourceLocation,UBOOL bStopWhenOwnerDestroyed,UBOOL bIsOccluded=0,BYTE Channel=0)
    {
        PlayerController_eventClientHearSound_Parms Parms(EC_EventParm);
        Parms.ASound=ASound;
        Parms.SourceActor=SourceActor;
        Parms.SourceLocation=SourceLocation;
        Parms.bStopWhenOwnerDestroyed=bStopWhenOwnerDestroyed ? FIRST_BITFIELD : 0;
        Parms.bIsOccluded=bIsOccluded ? FIRST_BITFIELD : 0;
        Parms.Channel=Channel;
    ...
    void eventClientTravel(const FString& URL,BYTE TravelType,UBOOL bSeamless=FALSE)
    {
        ...
        Parms.bSeamless=bSeamless ? FIRST_BITFIELD : 0;
...
{
    class UActorComponent* PickupMesh;
...
public:
    ...
    void eventSetPickupMesh(class UActorComponent* PickupMesh)
    {
...
struct DynamicSMActor_eventUpdateNotifyRigidBodyCollision_Parms
{
    DynamicSMActor_eventUpdateNotifyRigidBodyCollision_Parms(EEventParm)
    {
    }
};
...
public:
    ...
    INT ReplicatedMaterialIndex;
    class UMaterialInstance* ReplicatedMaterial;
    BITFIELD ReplicatedNotifyRigidBodyCollision:1;
    BITFIELD bPawnCanBaseOn:1;
    BITFIELD bSafeBaseIfAsleep:1;
    //## END PROPS DynamicSMActor

    void eventUpdateNotifyRigidBodyCollision()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_UpdateNotifyRigidBodyCollision),NULL);
    }
...
class AEnvCubeActor : public AActor
{
public:
    //## BEGIN PROPS EnvCubeActor
    class UTextureCube* Texture;
    class UStaticMeshComponent* StaticMesh;
    class UPackage* TexturePackage;
    INT TextureSize;
    TArrayNoInit<class AActor*> Filter;
    //## END PROPS EnvCubeActor

    DECLARE_CLASS(AEnvCubeActor,AActor,0,Engine)
	// AActor interface
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UCeilingReachSpec)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UCoverSlipReachSpec)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UFloorToCeilingReachSpec)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UMantleReachSpec)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(USwatTurnReachSpec)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UWallTransReachSpec)
};
...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UTeleportReachSpec)
};
...
public:
    ...
    UBOOL GetAllNavInRadius(class AActor* chkActor,FVector ChkPoint,FLOAT Radius,TArray<class ANavigationPoint*>& out_NavList,UBOOL bSkipBlocked=0,INT inNetworkID=-1,FCylinder MinSize=FCylinder());
    ...
    DECLARE_FUNCTION(execGetAllNavInRadius)
    {
        ...
        P_GET_UBOOL_OPTX(bSkipBlocked,0);
...
struct CoverLink_eventUnClaimSlot_Parms
{
    INT SlotIdx;
    CoverLink_eventUnClaimSlot_Parms(EEventParm)
    {
    }
};
...
public:
    ...
    UBOOL IsValidClaim(class AController* ChkClaim,INT SlotIdx,UBOOL bSkipTeamCheck=0,UBOOL bSkipOverlapCheck=0);
    UBOOL FindSlots(FVector CheckLocation,FLOAT MaxDistance,INT& LeftSlotIdx,INT& RightSlotIdx);
    UBOOL IsEdgeSlot(INT SlotIdx,UBOOL bIgnoreLeans=0);
    ...
    DECLARE_FUNCTION(execIsValidClaim)
    {
        ...
        P_GET_INT(SlotIdx);
        P_GET_UBOOL_OPTX(bSkipTeamCheck,0);
        P_GET_UBOOL_OPTX(bSkipOverlapCheck,0);
        P_FINISH;
    ...
    {
        P_GET_INT(SlotIdx);
        P_GET_UBOOL_OPTX(bIgnoreLeans,0);
        P_FINISH;
    ...
    void eventSetDisabled(UBOOL bNewDisabled)
    {
        ...
        Parms.bNewDisabled=bNewDisabled ? FIRST_BITFIELD : 0;
        ProcessEvent(FindFunctionChecked(ENGINE_SetDisabled),&Parms);
    }
    void eventUnClaimSlot(INT SlotIdx)
    {
        CoverLink_eventUnClaimSlot_Parms Parms(EC_EventParm);
        Parms.SlotIdx=SlotIdx;
        ProcessEvent(FindFunctionChecked(ENGINE_UnClaimSlot),&Parms);
    }
    void eventUnClaim(class AController* OldClaim,INT SlotIdx,UBOOL bUnclaimAll)
    {
        CoverLink_eventUnClaim_Parms Parms(EC_EventParm);
        Parms.OldClaim=OldClaim;
        Parms.SlotIdx=SlotIdx;
        Parms.bUnclaimAll=bUnclaimAll ? FIRST_BITFIELD : 0;
...
public:
    ...
    UBOOL OpenFile(const FString& InFilename,BYTE InFileType=0,const FString& InExtension=TEXT(""),UBOOL bUnique=0,UBOOL bIncludeTimeStamp=0);
    void CloseFile();
    ...
    DECLARE_FUNCTION(execOpenFile)
    {
        ...
        P_GET_UBOOL_OPTX(bIncludeTimeStamp,0);
        P_FINISH;
...
struct GameInfo_eventHmLogin_Parms
{
    FString Portal;
    FString Options;
    FVector inLocation;
    ...
    GameInfo_eventHmLogin_Parms(EEventParm)
    {
    }
};
...
public:
    ...
    INT _hm_yaw;
    FStringNoInit DefaultUIPathPrefix;
    FScriptDelegate __CanUnpause__Delegate;
    //## END PROPS GameInfo
    ...
    FString GetFullUIPath(const FString& PartialPath);
    ...
    DECLARE_FUNCTION(execGetFullUIPath)
    {
        P_GET_STR(PartialPath);
        P_FINISH;
        *(FString*)Result=GetFullUIPath(PartialPath);
    }
    ...
    class APlayerController* eventHmLogin(const FString& Portal,const FString& Options,FVector inLocation,FRotator inRotation,UBOOL bDead,FString& ErrorMessage)
    {
        GameInfo_eventHmLogin_Parms Parms(EC_EventParm);
        Parms.ReturnValue=0;
        Parms.Portal=Portal;
        Parms.Options=Options;
        Parms.inLocation=inLocation;
        Parms.inRotation=inRotation;
        Parms.bDead=bDead ? FIRST_BITFIELD : 0;
        Parms.ErrorMessage=ErrorMessage;
        ProcessEvent(FindFunctionChecked(ENGINE_HmLogin),&Parms);
        ErrorMessage=Parms.ErrorMessage;
        return Parms.ReturnValue;
    }
    class APlayerController* eventLogin(const FString& Portal,const FString& Options,FString& ErrorMessage,UBOOL bForceNotSpectating=FALSE)
    {
        ...
        Parms.Options=Options;
        Parms.ErrorMessage=ErrorMessage;
        Parms.bForceNotSpectating=bForceNotSpectating ? FIRST_BITFIELD : 0;
...
{
    FStringNoInit SourcePath;
    INT Resolution;
    TArrayNoInit<FColor> Data;
...
struct FAmbientCubeVolumeInfo
{
    INT NumAmbientCubeX;
    INT NumAmbientCubeY;
    INT NumAmbientCubeZ;
    FVector AmbientCubeMin;
    FVector AmbientCubeMax;
    INT SHStartIndex;
    FVector CubeSize;
    INT Priority;
};

struct FLoadBackgroundInfo
{
    FStringNoInit MapFileName;
    FStringNoInit LoadBG;
    FLOAT U;
    FLOAT V;
    FLOAT UL;
    FLOAT VL;
    ...
    /** Constructors */
    FLoadBackgroundInfo() {}
    FLoadBackgroundInfo(EEventParm)
    {
        appMemzero(this, sizeof(FLoadBackgroundInfo));
    }
};
...
public:
    ...
    BITFIELD bDisplayTonemapInfo:1;
    BITFIELD bMapNeedsLightingFullyRebuilt:1;
    BITFIELD bMapNeedsGeometryFullyRebuilt:1;
    ...
    class UTexture2D* LoadBackgroud;
    class UTexture2D* MinimapTexture;
    class UTexture2D* LargemapTexture;
    class UMaterial* LargemapMaterial;
    FVector MinimapOffset;
    FLOAT MinimapScale;
    FLOAT MinimapMeterPerTexel;
    FLOAT Radiosity_EmissiveScale;
    FLOAT Radiosity_ReflectivityScale;
    FLOAT Reference_dB;
    TArrayNoInit<struct FColorCorrectionData> ColorCorrections;
    ...
    FVector AmbientCubeMin;
    FVector AmbientCubeMax;
    TArrayNoInit<struct FAmbientSH> AmbientSHs;
    TArrayNoInit<struct FAmbientCubeVolumeInfo> AmbientCubeVolumeInfos;
    TArrayNoInit<struct FLoadBackgroundInfo> LoadBackgroundList;
protected:
...
public:
    ...
    virtual FString GetLocalURL();
    UBOOL IsDemoBuild();
    UBOOL IsConsoleBuild();
    void ForceGarbageCollection();
    void VerifyNavList();
    virtual FString GetAddressURL();
...
struct InventoryManager_eventHmSwitchToBestWeapon_Parms
{
    InventoryManager_eventHmSwitchToBestWeapon_Parms(EEventParm)
    {
    }
};
...
public:
    ...
    class UClass* pendingWeaponClass;
    //## END PROPS InventoryManager

    DECLARE_FUNCTION(execInventoryActors);
    void eventHmSwitchToBestWeapon()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_HmSwitchToBestWeapon),NULL);
    }
    void eventDiscardInventory()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_DiscardInventory),NULL);
    }
    class AInventory* eventFindInventoryType(class UClass* DesiredClass,UBOOL bAllowSubclass=0)
    {
        InventoryManager_eventFindInventoryType_Parms Parms(EC_EventParm);
        Parms.ReturnValue=0;
        Parms.DesiredClass=DesiredClass;
        Parms.bAllowSubclass=bAllowSubclass ? FIRST_BITFIELD : 0;
...
{
public:
    //## BEGIN PROPS SunLight
    //## END PROPS SunLight

    DECLARE_CLASS(ASunLight,ALight,0,Engine)
...
struct Pawn_eventHmAddWeaponEnd_Parms
{
    class AWeapon* Weap;
    UBOOL bActive;
    Pawn_eventHmAddWeaponEnd_Parms(EEventParm)
    {
    }
};
struct Pawn_eventHmAddWeaponBegin_Parms
{
    FString WeaponClassStr;
    class AWeapon* ReturnValue;
    Pawn_eventHmAddWeaponBegin_Parms(EEventParm)
    {
    }
};
struct Pawn_eventHmAddWeapon_Parms
{
    FString WeaponClassStr;
    UBOOL bActive;
    class AWeapon* ReturnValue;
    Pawn_eventHmAddWeapon_Parms(EEventParm)
    {
    }
};
...
struct Pawn_eventGetCollisionRadius_Parms
{
    FLOAT ReturnValue;
    Pawn_eventGetCollisionRadius_Parms(EEventParm)
    {
    }
};
...
public:
    ...
    FVector LastLoc;
    FRotator LastRot;
    FLOAT MeshInterpSpeedT;
    FLOAT MeshInterpSpeedR;
    //## END PROPS Pawn

    UBOOL ValidAnchor();
    virtual UBOOL SuggestJumpVelocity(FVector& JumpVelocity,FVector Destination,FVector Start);
    virtual void SetTempLocation(FVector NewLocation,FRotator NewRotation);
    ...
    DECLARE_FUNCTION(execSetTempLocation)
    {
        P_GET_STRUCT(FVector,NewLocation);
        P_GET_STRUCT(FRotator,NewRotation);
        P_FINISH;
        SetTempLocation(NewLocation,NewRotation);
    }
    ...
    void eventHmAddWeaponEnd(class AWeapon* Weap,UBOOL bActive)
    {
        Pawn_eventHmAddWeaponEnd_Parms Parms(EC_EventParm);
        Parms.Weap=Weap;
        Parms.bActive=bActive ? FIRST_BITFIELD : 0;
        ProcessEvent(FindFunctionChecked(ENGINE_HmAddWeaponEnd),&Parms);
    }
    class AWeapon* eventHmAddWeaponBegin(const FString& WeaponClassStr)
    {
        Pawn_eventHmAddWeaponBegin_Parms Parms(EC_EventParm);
        Parms.ReturnValue=0;
        Parms.WeaponClassStr=WeaponClassStr;
        ProcessEvent(FindFunctionChecked(ENGINE_HmAddWeaponBegin),&Parms);
        return Parms.ReturnValue;
    }
    class AWeapon* eventHmAddWeapon(const FString& WeaponClassStr,UBOOL bActive)
    {
        Pawn_eventHmAddWeapon_Parms Parms(EC_EventParm);
        Parms.ReturnValue=0;
        Parms.WeaponClassStr=WeaponClassStr;
        Parms.bActive=bActive ? FIRST_BITFIELD : 0;
        ProcessEvent(FindFunctionChecked(ENGINE_HmAddWeapon),&Parms);
        return Parms.ReturnValue;
    }
    ...
    {
        Pawn_eventGetCollisionRadius_Parms Parms(EC_EventParm);
        Parms.ReturnValue=0;
        ProcessEvent(FindFunctionChecked(ENGINE_GetCollisionRadius),&Parms);
        return Parms.ReturnValue;
    }
    class AInventory* eventCreateInventory(class UClass* NewInvClass,UBOOL bDoNotActivate=0)
    {
        Pawn_eventCreateInventory_Parms Parms(EC_EventParm);
        Parms.ReturnValue=0;
        Parms.NewInvClass=NewInvClass;
        Parms.bDoNotActivate=bDoNotActivate ? FIRST_BITFIELD : 0;
    ...
    void eventPlayFootStepSound(INT FootDown,UBOOL bManual=0)
    {
        Pawn_eventPlayFootStepSound_Parms Parms(EC_EventParm);
        Parms.FootDown=FootDown;
        Parms.bManual=bManual ? FIRST_BITFIELD : 0;
...
class USunLightComponent : public UDirectionalLightComponent
{
public:
    //## BEGIN PROPS SunLightComponent
    FLOAT AmbientBrightness;
    FColor AmbientLightColor;
    FStringNoInit SkyEnvironmentMap;
    FLOAT SkyMax;
    FLOAT SkyScale;
    FLOAT Yaw;
    FLOAT HDRTonemapScale;
    //## END PROPS SunLightComponent

    DECLARE_CLASS(USunLightComponent,UDirectionalLightComponent,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(USunLightComponent)
};
...
public:
    ...
    virtual void SetTranslation(FVector NewTranslation);
...
class USHPointLightComponent : public UPointLightComponent
{
public:
    //## BEGIN PROPS SHPointLightComponent
    //## END PROPS SHPointLightComponent

    DECLARE_CLASS(USHPointLightComponent,UPointLightComponent,0,Engine)
	virtual FLightSceneInfo* CreateSceneInfo() const;
	virtual ELightComponentType GetLightType() const;
...
public:
    ...
    FColor LowerColor;
    struct FAmbientSH IrradianceSH;
...
public:
    ...
    BITFIELD bDynamic:1;
    BITFIELD bUpdateLastLighting:1;
    FVector LastDirection;
    FColor LastColor;
    FLOAT LastBrightness;
    FVector LastPosition;
    FLOAT LastUpperSkyBrightness;
    FColor LastUpperSkyColor;
    FLOAT LastLowerSkyBrightness;
    FColor LastLowerSkyColor;
...
class UOcclusionGroupComponent : public UPrimitiveComponent
{
public:
    //## BEGIN PROPS OcclusionGroupComponent
    //## END PROPS OcclusionGroupComponent

    DECLARE_CLASS(UOcclusionGroupComponent,UPrimitiveComponent,0,Engine)
	virtual FPrimitiveSceneProxy* CreateSceneProxy();
};
...
public:
    ...
    virtual FLOAT Eval(FLOAT InVal,FLOAT Default);
    virtual FLOAT EvalRatio(FLOAT Ratio);
    DECLARE_FUNCTION(execEval)
    {
        P_GET_FLOAT(InVal);
        P_GET_FLOAT(Default);
        P_FINISH;
        *(FLOAT*)Result=Eval(InVal,Default);
    }
    DECLARE_FUNCTION(execEvalRatio)
    {
        P_GET_FLOAT(Ratio);
        P_FINISH;
        *(FLOAT*)Result=EvalRatio(Ratio);
    }
...
struct FInputCompositionStringData
{
    BYTE CompType;
    FString CompStr;
    TArray<BYTE> CompAttr;
    INT CompCursorPos;
    TArray<INT> CompClause;
...
#define UCONST_IMEPROP_AT_CARET 0x00010000

class UIMEComposition : public UObject
{
public:
    //## BEGIN PROPS IMEComposition
    //## END PROPS IMEComposition

    UBOOL NotifyAction(BYTE Action,INT Index,INT Value);
    BYTE GetImeLanguage();
    INT GetImeProperty();
    DECLARE_FUNCTION(execNotifyAction)
    {
        P_GET_BYTE(Action);
        P_GET_INT(Index);
        P_GET_INT(Value);
        P_FINISH;
        *(UBOOL*)Result=NotifyAction(Action,Index,Value);
    }
    DECLARE_FUNCTION(execGetImeLanguage)
    {
        P_FINISH;
        *(BYTE*)Result=GetImeLanguage();
    }
    DECLARE_FUNCTION(execGetImeProperty)
    {
        P_FINISH;
        *(INT*)Result=GetImeProperty();
    }
    DECLARE_ABSTRACT_CLASS(UIMEComposition,UObject,0,Engine)
public:
...
struct GameViewportClient_eventHmReinit_Parms
{
    GameViewportClient_eventHmReinit_Parms(EEventParm)
    {
    }
};
struct GameViewportClient_eventInputReadingString_Parms
{
    INT ControllerId;
    struct FInputReadingStringData ReadStrData;
    UBOOL ReturnValue;
    GameViewportClient_eventInputReadingString_Parms(EEventParm)
    {
    }
};
struct GameViewportClient_eventInputCandidate_Parms
{
    INT ControllerId;
    struct FInputCandidateStringData CandStrData;
    UBOOL ReturnValue;
    GameViewportClient_eventInputCandidate_Parms(EEventParm)
    {
    }
};
struct GameViewportClient_eventInputChar_Parms
{
    INT ControllerId;
    struct FInputCompositionStringData CompStrData;
    UBOOL ReturnValue;
    GameViewportClient_eventInputChar_Parms(EEventParm)
    {
    }
};
struct GameViewportClient_eventInputAxis_Parms
{
    INT ControllerId;
    FName Key;
    FLOAT Delta;
    FLOAT DeltaTime;
    UBOOL ReturnValue;
    GameViewportClient_eventInputAxis_Parms(EEventParm)
    {
    }
};
struct GameViewportClient_eventInputKey_Parms
{
    INT ControllerId;
    FName Key;
    BYTE Event;
    ...
    UBOOL bGamepad;
    UBOOL ReturnValue;
    GameViewportClient_eventInputKey_Parms(EEventParm)
    {
    }
};
...
public:
    ...
    class UDSPPreset* LastDSPPreset;
    class USoundCue* LastAmbientSound;
    FStringNoInit LocationName;
    ...
    {
        GameViewportClient_eventInputReadingString_Parms Parms(EC_EventParm);
        Parms.ReturnValue=0;
    ...
    {
        GameViewportClient_eventInputCandidate_Parms Parms(EC_EventParm);
        Parms.ReturnValue=0;
        Parms.ControllerId=ControllerId;
    ...
    {
        GameViewportClient_eventInputChar_Parms Parms(EC_EventParm);
        Parms.ReturnValue=0;
        Parms.ControllerId=ControllerId;
    ...
    {
        GameViewportClient_eventInputAxis_Parms Parms(EC_EventParm);
        Parms.ReturnValue=0;
        Parms.ControllerId=ControllerId;
        Parms.Key=Key;
        Parms.Delta=Delta;
    ...
    UBOOL eventInputKey(INT ControllerId,FName Key,BYTE Event,FLOAT AmountDepressed,UBOOL bGamepad)
    {
        GameViewportClient_eventInputKey_Parms Parms(EC_EventParm);
        Parms.ReturnValue=0;
        Parms.ControllerId=ControllerId;
        Parms.Key=Key;
        Parms.Event=Event;
    ...
    class ULocalPlayer* eventCreatePlayer(INT ControllerId,FString& OutError,UBOOL bSpawnActor)
    {
        ...
        Parms.ControllerId=ControllerId;
        Parms.OutError=OutError;
        Parms.bSpawnActor=bSpawnActor ? FIRST_BITFIELD : 0;
	 ...
	 * ReadingStringÀº Traditional Chinese, Simplified Chinese¿¡¸¸ ¾²ÀÓ
	 * Áß±¹¾î¿¡¼­´Â Áß±¹¾î¸¦ ÀÔ·ÂÇÏ±â¿¡ ¾Õ¼­ ¹ßÀ½³ª´Â´ë·Î ¿µ¾î·Î Àû±â¶§¹®¿¡ 
	 * ÇöÀç Àû¾î³ÖÀº ¿µ¾î¸¦ ÀÐ´Â´ë·Î(ReadingString) Ç¥ÇöÇØÁà¾ßÇÔ
	 *
	 * @param	Viewport - The viewport which the axis movement is from.
	 * @param	ControllerId - The controller which the axis movement is from.
	 * @param	ReadStrData	-  Àû¾î³ÖÀº ¿µ¾î¸¦ ÀÐ´Â´ë·Î Ç¥ÇöÇÑ StringÁ¤º¸
	 * @return	True to consume the character, false to pass it on.	 
	 */
...
struct FSettingsPropertyPropertyMetaData
{
    INT Id;
    FName Name;
    FStringNoInit MinVal;
    FStringNoInit MaxVal;
...
struct FOnlineProfileSettingMetaData
{
    INT Id;
    FName Name;
    BYTE MappingType;
    ...
    /** Constructors */
    FOnlineProfileSettingMetaData() {}
    FOnlineProfileSettingMetaData(EEventParm)
    {
        appMemzero(this, sizeof(FOnlineProfileSettingMetaData));
    }
};
...
public:
    ...
    TArrayNoInit<struct FOnlineProfileSettingMetaData> ProfileMappings;
    BYTE AsyncState;
...
struct FPlayerWorkSet
{
    TArrayNoInit<class UObject*> objectList;

    /** Constructors */
    FPlayerWorkSet() {}
    FPlayerWorkSet(EEventParm)
    {
        appMemzero(this, sizeof(FPlayerWorkSet));
    }
};
...
public:
    ...
    TArrayNoInit<class UObject*> WorkingSet;
    struct FPlayerWorkSet PlayerSet[16];
    INT PlayerSetCnt;
    //## END PROPS LocalPlayer

    UBOOL SpawnPlayActor(const FString& URL,FString& OutError);
    void SendSplitJoin();
    UBOOL GetActorVisibility(class AActor* TestActor);
...
class UMaterialInstance : public USurface
{
public:
    //## BEGIN PROPS MaterialInstance
    FLOAT ReflectivityScale;
    FColor ReflectivityColor;
    BITFIELD bOverrideReflectivityColor:1;
    BITFIELD bOverrideBrightnessColor:1;
    FLOAT BrightnessScale;
    FColor BrightnessColor;
    ...
    DECLARE_ABSTRACT_CLASS(UMaterialInstance,USurface,0,Engine)
	...
	/**
	 * ÁÖÀÇ : ÀÌ´Â GRHIShaderPlatform, GShaderCompilePlatformÀ» ÀÌ¿ëÇØ¼­ Ã³¸®ÇÑ´Ù. 
			RenderThread´Â ¸ØÃçÀÖ¾î¾ß ÇÑ´Ù!
	 */
...
public:
    ...
    FScalarMaterialInput AmbientMask;
    //## END PROPS Material
...
{
    struct FTextureLODGroup TextureLODGroups[14];
...
class USystemSettings : public UObject, public FExec
{
public:
    //## BEGIN PROPS SystemSettings
    BITFIELD bUseLoadMapCache:1;
    struct FTextureLODSettings TextureLODSettings;
    struct FTextureLODSettings Presets[3];
    INT bAllowStaticDecals;
    INT bAllowDynamicDecals;
    INT bAllowDynamicLights;
    INT bAllowDynamicShadows;
    INT bAllowLightEnvironmentShadows;
    INT bUseCompositeDynamicLights;
    INT bAllowMotionBlur;
    INT bAllowDepthOfField;
    INT bAllowBloom;
    INT bUseHighQualityBloom;
    INT bAllowFog;
    INT bAllowSpeedTreeLeaves;
    INT bAllowSpeedTreeFronds;
    INT bAllowOneFrameThreadLag;
    INT bOnlyStreamInTextures;
    INT bUpscaleScreenPercentage;
    ...
    INT GPUVendorId;
    INT GPUDeviceId;
    BITFIELD bEnableVSync:1;
    BITFIELD bSmoothFrameRate:1;
    FLOAT MaxSmoothedFrameRate;
    FLOAT MinSmoothedFrameRate;
    INT DiffuseCubeResolution;
    //## END PROPS SystemSettings

    DECLARE_CLASS(USystemSettings,UObject,0|CLASS_Transient,Engine)
...
AUTOGENERATE_FUNCTION(UAdvancedReachSpec,-1,execCostFor);
...
AUTOGENERATE_FUNCTION(UCeilingReachSpec,-1,execCostFor);
...
AUTOGENERATE_FUNCTION(UCoverSlipReachSpec,-1,execCostFor);
AUTOGENERATE_FUNCTION(UCurveEdPresetCurve,-1,execEvalRatio);
AUTOGENERATE_FUNCTION(UCurveEdPresetCurve,-1,execEval);
...
AUTOGENERATE_FUNCTION(UFloorToCeilingReachSpec,-1,execCostFor);
AUTOGENERATE_FUNCTION(UFont,-1,execGetScalingFactor);
AUTOGENERATE_FUNCTION(UFont,-1,execGetResolutionPageIndex);
AUTOGENERATE_FUNCTION(UForcedReachSpec,-1,execCostFor);
AUTOGENERATE_FUNCTION(AGameInfo,-1,execGetFullUIPath);
...
AUTOGENERATE_FUNCTION(UIMEComposition,-1,execGetImeProperty);
AUTOGENERATE_FUNCTION(UIMEComposition,-1,execGetImeLanguage);
AUTOGENERATE_FUNCTION(UIMEComposition,-1,execNotifyAction);
AUTOGENERATE_FUNCTION(AInventoryManager,-1,execInventoryActors);
AUTOGENERATE_FUNCTION(ULadderReachSpec,-1,execCostFor);
...
AUTOGENERATE_FUNCTION(UMantleReachSpec,-1,execCostFor);
AUTOGENERATE_FUNCTION(UMaterialInstance,-1,execGetTextureParameterValue);
AUTOGENERATE_FUNCTION(UMaterialInstance,-1,execGetScalarParameterValue);
AUTOGENERATE_FUNCTION(UMaterialInstance,-1,execGetVectorParameterValue);
AUTOGENERATE_FUNCTION(UMaterialInstance,-1,execGetPhysicalMaterial);
...
AUTOGENERATE_FUNCTION(APawn,-1,execSetTempLocation);
...
AUTOGENERATE_FUNCTION(UProscribedReachSpec,-1,execCostFor);
...
AUTOGENERATE_FUNCTION(USwatTurnReachSpec,-1,execCostFor);
AUTOGENERATE_FUNCTION(ATeleporter,-1,execCanTeleport);
AUTOGENERATE_FUNCTION(UTeleportReachSpec,-1,execCostFor);
AUTOGENERATE_FUNCTION(UTexture2DComposite,-1,execUpdateCompositeTextue);
...
AUTOGENERATE_FUNCTION(UWallTransReachSpec,-1,execCostFor);
...
DECLARE_NATIVE_TYPE(Engine,AAmbientCubeVolume);
...
DECLARE_NATIVE_TYPE(Engine,ADynamicTriggerVolume);
DECLARE_NATIVE_TYPE(Engine,UEdCoordSystem);
DECLARE_NATIVE_TYPE(Engine,UEdLayer);
DECLARE_NATIVE_TYPE(Engine,AEnvCubeActor);
...
DECLARE_NATIVE_TYPE(Engine,UIMEComposition);
...
DECLARE_NATIVE_TYPE(Engine,AMinimapVolume);
...
DECLARE_NATIVE_TYPE(Engine,AOcclusionGroup);
DECLARE_NATIVE_TYPE(Engine,UOcclusionGroupComponent);
...
DECLARE_NATIVE_TYPE(Engine,USHPointLightComponent);
...
DECLARE_NATIVE_TYPE(Engine,ASunLight);
DECLARE_NATIVE_TYPE(Engine,USunLightComponent);
DECLARE_NATIVE_TYPE(Engine,USurface);
DECLARE_NATIVE_TYPE(Engine,USwatTurnReachSpec);
DECLARE_NATIVE_TYPE(Engine,USystemSettings);
...
#define AUTO_INITIALIZE_REGISTRANTS_ENGINE \
	...
	GNativeLookupFuncs[Lookup++] = &FindEngineUAdvancedReachSpecNative; \
	AAmbientCubeVolume::StaticClass(); \
	...
	GNativeLookupFuncs[Lookup++] = &FindEngineUCoverSlipReachSpecNative; \
	ACoverSlotMarker::StaticClass(); \
	UCurveEdPresetCurve::StaticClass(); \
	GNativeLookupFuncs[Lookup++] = &FindEngineUCurveEdPresetCurveNative; \
	...
	ADynamicTriggerVolume::StaticClass(); \
	UEdCoordSystem::StaticClass(); \
	UEdLayer::StaticClass(); \
	AEnvCubeActor::StaticClass(); \
	...
	GNativeLookupFuncs[Lookup++] = &FindEngineUForcedReachSpecNative; \
	...
	UIMEComposition::StaticClass(); \
	GNativeLookupFuncs[Lookup++] = &FindEngineUIMECompositionNative; \
	AInfo::StaticClass(); \
	...
	GNativeLookupFuncs[Lookup++] = &FindEngineULadderReachSpecNative; \
	...
	GNativeLookupFuncs[Lookup++] = &FindEngineUMantleReachSpecNative; \
	...
	AOcclusionGroup::StaticClass(); \
	UOcclusionGroupComponent::StaticClass(); \
	...
	GNativeLookupFuncs[Lookup++] = &FindEngineUProscribedReachSpecNative; \
	...
	USHPointLightComponent::StaticClass(); \
	...
	ASunLight::StaticClass(); \
	USunLightComponent::StaticClass(); \
	USurface::StaticClass(); \
	GNativeLookupFuncs[Lookup++] = &FindEngineUSurfaceNative; \
	USwatTurnReachSpec::StaticClass(); \
	GNativeLookupFuncs[Lookup++] = &FindEngineUSwatTurnReachSpecNative; \
	USystemSettings::StaticClass(); \
	...
	GNativeLookupFuncs[Lookup++] = &FindEngineUTeleportReachSpecNative; \
	...
	UTrueTypeFont::StaticClass(); \
	UTrueTypeFontManager::StaticClass(); \
	...
	GNativeLookupFuncs[Lookup++] = &FindEngineUWallTransReachSpecNative; \
	AWeapon::StaticClass(); \
...
NATIVE_INFO(UAdvancedReachSpec) GEngineUAdvancedReachSpecNatives[] = 
{ 
	MAP_NATIVE(UAdvancedReachSpec,execCostFor)
	{NULL,NULL}
};
IMPLEMENT_NATIVE_HANDLER(Engine,UAdvancedReachSpec);
...
{ 
	...
	MAP_NATIVE(UCanvas,execDrawTileRotate)
...
{ 
	...
	MAP_NATIVE(UCeilingReachSpec,execCostFor)
	{NULL,NULL}
};
...
NATIVE_INFO(UCoverSlipReachSpec) GEngineUCoverSlipReachSpecNatives[] = 
{ 
	MAP_NATIVE(UCoverSlipReachSpec,execCostFor)
	{NULL,NULL}
};
IMPLEMENT_NATIVE_HANDLER(Engine,UCoverSlipReachSpec);

NATIVE_INFO(UCurveEdPresetCurve) GEngineUCurveEdPresetCurveNatives[] = 
{ 
	MAP_NATIVE(UCurveEdPresetCurve,execEvalRatio)
	MAP_NATIVE(UCurveEdPresetCurve,execEval)
	{NULL,NULL}
};
IMPLEMENT_NATIVE_HANDLER(Engine,UCurveEdPresetCurve);
...
{ 
	...
	MAP_NATIVE(UFloorToCeilingReachSpec,execCostFor)
	{NULL,NULL}
};
...
NATIVE_INFO(UForcedReachSpec) GEngineUForcedReachSpecNatives[] = 
{ 
	MAP_NATIVE(UForcedReachSpec,execCostFor)
	{NULL,NULL}
};
IMPLEMENT_NATIVE_HANDLER(Engine,UForcedReachSpec);

NATIVE_INFO(AGameInfo) GEngineAGameInfoNatives[] = 
{ 
	MAP_NATIVE(AGameInfo,execGetFullUIPath)
...
NATIVE_INFO(UIMEComposition) GEngineUIMECompositionNatives[] = 
{ 
	MAP_NATIVE(UIMEComposition,execGetImeProperty)
	MAP_NATIVE(UIMEComposition,execGetImeLanguage)
	MAP_NATIVE(UIMEComposition,execNotifyAction)
	{NULL,NULL}
};
IMPLEMENT_NATIVE_HANDLER(Engine,UIMEComposition);
...
NATIVE_INFO(ULadderReachSpec) GEngineULadderReachSpecNatives[] = 
{ 
	MAP_NATIVE(ULadderReachSpec,execCostFor)
	{NULL,NULL}
};
IMPLEMENT_NATIVE_HANDLER(Engine,ULadderReachSpec);
...
NATIVE_INFO(UMantleReachSpec) GEngineUMantleReachSpecNatives[] = 
{ 
	MAP_NATIVE(UMantleReachSpec,execCostFor)
	{NULL,NULL}
};
IMPLEMENT_NATIVE_HANDLER(Engine,UMantleReachSpec);

NATIVE_INFO(UMaterialInstance) GEngineUMaterialInstanceNatives[] = 
{ 
	MAP_NATIVE(UMaterialInstance,execGetTextureParameterValue)
	MAP_NATIVE(UMaterialInstance,execGetScalarParameterValue)
	MAP_NATIVE(UMaterialInstance,execGetVectorParameterValue)
	MAP_NATIVE(UMaterialInstance,execGetPhysicalMaterial)
...
{ 
	...
	MAP_NATIVE(APawn,execSetTempLocation)
...
{ 
	...
	MAP_NATIVE(UPrimitiveComponent,execSetSeeThroughGroupIndex)
	MAP_NATIVE(UPrimitiveComponent,execSetOcclusionGroup)
...
NATIVE_INFO(UProscribedReachSpec) GEngineUProscribedReachSpecNatives[] = 
{ 
	MAP_NATIVE(UProscribedReachSpec,execCostFor)
	{NULL,NULL}
};
IMPLEMENT_NATIVE_HANDLER(Engine,UProscribedReachSpec);
...
{ 
	...
	MAP_NATIVE(USkeletalMeshComponent,execGetBoneNameByIndex)
...
NATIVE_INFO(USwatTurnReachSpec) GEngineUSwatTurnReachSpecNatives[] = 
{ 
	MAP_NATIVE(USwatTurnReachSpec,execCostFor)
	{NULL,NULL}
};
IMPLEMENT_NATIVE_HANDLER(Engine,USwatTurnReachSpec);
...
NATIVE_INFO(UTeleportReachSpec) GEngineUTeleportReachSpecNatives[] = 
{ 
	MAP_NATIVE(UTeleportReachSpec,execCostFor)
	{NULL,NULL}
};
IMPLEMENT_NATIVE_HANDLER(Engine,UTeleportReachSpec);

NATIVE_INFO(UTexture2DComposite) GEngineUTexture2DCompositeNatives[] = 
{ 
	MAP_NATIVE(UTexture2DComposite,execUpdateCompositeTextue)
...
NATIVE_INFO(UWallTransReachSpec) GEngineUWallTransReachSpecNatives[] = 
{ 
	MAP_NATIVE(UWallTransReachSpec,execCostFor)
	{NULL,NULL}
};
IMPLEMENT_NATIVE_HANDLER(Engine,UWallTransReachSpec);
...
VERIFY_CLASS_OFFSET_NODIE(A,Actor,LastAmbientCubeUpdatedTime)
...
VERIFY_CLASS_OFFSET_NODIE(A,AmbientCubeVolume,CubeSizeX)
VERIFY_CLASS_OFFSET_NODIE(A,AmbientCubeVolume,Priority)
VERIFY_CLASS_SIZE_NODIE(AAmbientCubeVolume)
...
VERIFY_CLASS_OFFSET_NODIE(U,AudioComponent,CurrentHeadRelative)
...
VERIFY_CLASS_OFFSET_NODIE(U,AudioComponent,CurrentPriorityMultiplier)
...
VERIFY_CLASS_OFFSET_NODIE(U,AudioComponent,CurrentSoundModeVoice)
VERIFY_CLASS_OFFSET_NODIE(U,AudioComponent,VolumeMultiplier)
VERIFY_CLASS_OFFSET_NODIE(U,AudioComponent,PitchMultiplier)
VERIFY_CLASS_OFFSET_NODIE(U,AudioComponent,PriorityMultiplier)
VERIFY_CLASS_OFFSET_NODIE(U,AudioComponent,PreviewSoundRadius)
VERIFY_CLASS_OFFSET_NODIE(U,AudioComponent,ForceDistMixSolo)
VERIFY_CLASS_OFFSET_NODIE(U,AudioComponent,Channel)
...
VERIFY_CLASS_OFFSET_NODIE(U,AudioDevice,AudioComponents)
VERIFY_CLASS_OFFSET_NODIE(U,AudioDevice,Sources)
VERIFY_CLASS_OFFSET_NODIE(U,AudioDevice,FreeSources)
VERIFY_CLASS_OFFSET_NODIE(U,AudioDevice,WaveInstanceSourceMap)
VERIFY_CLASS_OFFSET_NODIE(U,AudioDevice,bLastRealtime)
VERIFY_CLASS_OFFSET_NODIE(U,AudioDevice,Listeners)
VERIFY_CLASS_OFFSET_NODIE(U,AudioDevice,CurrentTick)
VERIFY_CLASS_OFFSET_NODIE(U,AudioDevice,NameToSoundGroupMap)
VERIFY_CLASS_OFFSET_NODIE(U,AudioDevice,NameToPropagatedSoundGroupPropertiesMap)
VERIFY_CLASS_OFFSET_NODIE(U,AudioDevice,SoundGroups)
VERIFY_CLASS_OFFSET_NODIE(U,AudioDevice,Effects)
...
VERIFY_CLASS_OFFSET_NODIE(A,Controller,TeamIndexFromOption)
...
VERIFY_CLASS_OFFSET_NODIE(U,DirectionalLightComponent,ShadowOffset)
...
VERIFY_CLASS_OFFSET_NODIE(U,DynamicLightEnvironmentComponent,LastLowerSkyColor)
...
VERIFY_CLASS_SIZE_NODIE(ADynamicTriggerVolume)
...
VERIFY_CLASS_OFFSET_NODIE(A,EnvCubeActor,Texture)
VERIFY_CLASS_OFFSET_NODIE(A,EnvCubeActor,Filter)
VERIFY_CLASS_SIZE_NODIE(AEnvCubeActor)
...
VERIFY_CLASS_OFFSET_NODIE(A,GameInfo,PendingArbitrationPCs)
...
VERIFY_CLASS_OFFSET_NODIE(U,GameViewportClient,LocationName)
...
VERIFY_CLASS_SIZE_NODIE(UIMEComposition)
VERIFY_CLASS_SIZE_NODIE(AInfo)
VERIFY_CLASS_SIZE_NODIE(AInternetInfo)
VERIFY_CLASS_OFFSET_NODIE(A,InterpActor,hmId)
...
VERIFY_CLASS_OFFSET_NODIE(A,InventoryManager,pendingWeaponClass)
...
VERIFY_CLASS_OFFSET_NODIE(U,LocalPlayer,PlayerSetCnt)
...
VERIFY_CLASS_OFFSET_NODIE(U,Material,AmbientMask)
...
VERIFY_CLASS_OFFSET_NODIE(U,MaterialInstance,ReflectivityScale)
VERIFY_CLASS_OFFSET_NODIE(U,MaterialInstance,PreviewMesh)
...
VERIFY_CLASS_SIZE_NODIE(AMinimapVolume)
...
VERIFY_CLASS_OFFSET_NODIE(A,Mutator,Description)
...
VERIFY_CLASS_OFFSET_NODIE(A,OcclusionGroup,Component)
VERIFY_CLASS_SIZE_NODIE(AOcclusionGroup)
VERIFY_CLASS_SIZE_NODIE(UOcclusionGroupComponent)
VERIFY_CLASS_OFFSET_NODIE(U,OnlineGameSearch,MaxSearchResults)
VERIFY_CLASS_OFFSET_NODIE(U,OnlineGameSearch,Results)
...
VERIFY_CLASS_OFFSET_NODIE(U,OnlineSubsystem,PlayerInterface)
...
VERIFY_CLASS_OFFSET_NODIE(A,Pawn,MeshInterpSpeedR)
...
VERIFY_CLASS_OFFSET_NODIE(A,PickupFactory,PickupMesh)
...
VERIFY_CLASS_OFFSET_NODIE(A,PlayerController,NetClientAdjustTime)
...
VERIFY_CLASS_OFFSET_NODIE(U,PrimitiveComponent,OcclusionGroup)
VERIFY_CLASS_OFFSET_NODIE(U,PrimitiveComponent,Bounds)
VERIFY_CLASS_OFFSET_NODIE(U,PrimitiveComponent,LightEnvironment)
VERIFY_CLASS_OFFSET_NODIE(U,PrimitiveComponent,CullDistanceEx)
...
VERIFY_CLASS_OFFSET_NODIE(U,PrimitiveComponent,SeeThroughGroup)
...
VERIFY_CLASS_OFFSET_NODIE(U,PrimitiveComponent,FadeStart)
VERIFY_CLASS_OFFSET_NODIE(U,PrimitiveComponent,FadeEnd)
...
VERIFY_CLASS_OFFSET_NODIE(A,ReverbVolume,VolumeName)
...
VERIFY_CLASS_OFFSET_NODIE(U,SampleComponent,Samples)
VERIFY_CLASS_SIZE_NODIE(USampleComponent)
...
VERIFY_CLASS_OFFSET_NODIE(U,SceneCaptureComponent,CaptureInfo)
...
VERIFY_CLASS_SIZE_NODIE(USHPointLightComponent)
...
VERIFY_CLASS_OFFSET_NODIE(U,SkeletalMeshComponent,bNoSkeletonUpdate)
...
VERIFY_CLASS_OFFSET_NODIE(U,SkeletalMeshComponent,LODBias)
VERIFY_CLASS_OFFSET_NODIE(U,SkeletalMeshComponent,SkelVisibleTime)
...
VERIFY_CLASS_OFFSET_NODIE(U,SkyLightComponent,IrradianceSH)
...
VERIFY_CLASS_OFFSET_NODIE(U,SoundNodeWave,NumChannels)
VERIFY_CLASS_OFFSET_NODIE(U,SoundNodeWave,SampleRate)
VERIFY_CLASS_OFFSET_NODIE(U,SoundNodeWave,ChannelOffsets)
VERIFY_CLASS_OFFSET_NODIE(U,SoundNodeWave,ChannelSizes)
VERIFY_CLASS_OFFSET_NODIE(U,SoundNodeWave,RawData)
VERIFY_CLASS_OFFSET_NODIE(U,SoundNodeWave,RawPCMData)
VERIFY_CLASS_OFFSET_NODIE(U,SoundNodeWave,CompressedPCData)
VERIFY_CLASS_OFFSET_NODIE(U,SoundNodeWave,CompressedXbox360Data)
VERIFY_CLASS_OFFSET_NODIE(U,SoundNodeWave,CompressedPS3Data)
VERIFY_CLASS_OFFSET_NODIE(U,SoundNodeWave,ResourceID)
VERIFY_CLASS_OFFSET_NODIE(U,SoundNodeWave,ResourceSize)
VERIFY_CLASS_OFFSET_NODIE(U,SoundNodeWave,ResourceData)
VERIFY_CLASS_OFFSET_NODIE(U,SoundNodeWave,SpokenText)
VERIFY_CLASS_OFFSET_NODIE(U,SoundNodeWave,Subtitles)
...
VERIFY_CLASS_OFFSET_NODIE(U,StaticMeshComponent,FirstExportedFaceNumber)
VERIFY_CLASS_OFFSET_NODIE(U,StaticMeshComponent,ExportId)
VERIFY_CLASS_OFFSET_NODIE(U,StaticMeshComponent,FirstExportedVertexNumber)
VERIFY_CLASS_OFFSET_NODIE(U,StaticMeshComponent,FirstLeaf)
VERIFY_CLASS_OFFSET_NODIE(U,StaticMeshComponent,LeafCount)
...
VERIFY_CLASS_OFFSET_NODIE(U,SunLightComponent,AmbientBrightness)
VERIFY_CLASS_OFFSET_NODIE(U,SunLightComponent,HDRTonemapScale)
VERIFY_CLASS_SIZE_NODIE(USunLightComponent)
VERIFY_CLASS_SIZE_NODIE(USurface)
VERIFY_CLASS_SIZE_NODIE(USwatTurnReachSpec)
VERIFY_CLASS_OFFSET_NODIE(U,SystemSettings,TextureLODSettings)
VERIFY_CLASS_OFFSET_NODIE(U,SystemSettings,DiffuseCubeResolution)
VERIFY_CLASS_SIZE_NODIE(USystemSettings)
...
VERIFY_CLASS_OFFSET_NODIE(U,Texture2DComposite,CompositeLODBias)
...
VERIFY_CLASS_OFFSET_NODIE(U,TextureRenderTarget2D,AddressY)
...
VERIFY_CLASS_OFFSET_NODIE(U,TrueTypeFont,Face)
VERIFY_CLASS_OFFSET_NODIE(U,TrueTypeFont,FontResource)
VERIFY_CLASS_OFFSET_NODIE(U,TrueTypeFont,FontFamily)
VERIFY_CLASS_OFFSET_NODIE(U,TrueTypeFont,Height)
VERIFY_CLASS_OFFSET_NODIE(U,TrueTypeFont,iClass)
VERIFY_CLASS_OFFSET_NODIE(U,TrueTypeFont,DropShadow)
VERIFY_CLASS_OFFSET_NODIE(U,TrueTypeFont,Quality)
VERIFY_CLASS_OFFSET_NODIE(U,TrueTypeFont,WidthScaler)
VERIFY_CLASS_OFFSET_NODIE(U,TrueTypeFont,TTFTextures)
VERIFY_CLASS_SIZE_NODIE(UTrueTypeFont)
VERIFY_CLASS_OFFSET_NODIE(U,TrueTypeFontManager,Pages)
VERIFY_CLASS_SIZE_NODIE(UTrueTypeFontManager)
...
VERIFY_CLASS_OFFSET_NODIE(A,Volume,LocationNameIndex)
...
VERIFY_CLASS_OFFSET_NODIE(A,WorldInfo,NetEntryGameClass)
