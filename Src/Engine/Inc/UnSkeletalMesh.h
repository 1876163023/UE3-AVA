...
class USkeletalMeshComponent : public UMeshComponent
{
	...
	*/
	...
	/** If set, this component won't be drawn */
	BITFIELD bForceNotToDraw:1;

	BITFIELD bForceNotToUseCPUSkinInGame:1;
	...
	*/
	...
	FName	GetBoneNameByIndex( INT BoneIndex );
