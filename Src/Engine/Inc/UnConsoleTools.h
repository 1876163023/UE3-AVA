...
public:
	 ...
	 */
	virtual bool Cook( short* SrcBuffer, DWORD SrcBufferSize, void* WaveFormat, INT Quality, UBOOL bCompressedSample, BYTE* RawWaveData, DWORD RawWaveDataSize ) = 0;
...
typedef FConsoleSoundCooker* (*FuncCreateSoundCooker) (void);
typedef void (*FuncDestroySoundCooker) (FConsoleSoundCooker*);
typedef FConsoleShaderPrecompiler* (*FuncCreateShaderPrecompiler) (void);
typedef void (*FuncDestroyShaderPrecompiler) (FConsoleShaderPrecompiler*);
...
extern "C"
{
	...
	/**
	 * Creates and returns a sound cooker instance.
	 *
	 * @return Returns an instance of the platform specific sound cooker.
	 */
	CONSOLETOOLS_API FConsoleSoundCooker* CreateSoundCooker();
	/**
	 * Destroys an instance.
	 *
	 * @param TextureCooker	Instance to free.
	 */
	CONSOLETOOLS_API void DestroySoundCooker( FConsoleSoundCooker* SoundCooker );

	/**
	 * Creates and returns a shader precompiler instance.
	 *
	 * @return Returns an instance of the platform specific shader precompiler.
	 */
	CONSOLETOOLS_API FConsoleShaderPrecompiler* CreateShaderPrecompiler();
	/**
	 * Destroys an instance.
	 *
	 * @param ShaderPrecompiler	Instance to free.
	 */
	CONSOLETOOLS_API void DestroyShaderPrecompiler( FConsoleShaderPrecompiler* ShaderPrecompiler );
	 ...
	 */
	CONSOLETOOLS_API BOOL CopyFileToConsole( wchar_t* Src, wchar_t* Dst );
