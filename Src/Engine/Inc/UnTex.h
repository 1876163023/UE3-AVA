...
private:
	...
	friend class FUpdateTTFCommand;	
...
// forward decl.
struct FColorCorrectionData;

class FColorCorrectionResource : public FTextureResource
{
public :
	FTextureRHIRef				TextureRHI;
	FTexture3DRHIRef			Texture3DRHI;
	FColorCorrectionData*		Source;

	FColorCorrectionResource( FColorCorrectionData* InSource )
		: Source(InSource)
	{
	}
