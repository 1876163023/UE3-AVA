...
#else
	#define  ENABLE_GETBONEATOM_STATS	1
#endif
...
struct FBoneAtom
{
	...
	{
		D3DXMatrixRotationQuaternion( (D3DXMATRIX*)&OutMatrix, (const D3DXQUATERNION*)&Rotation );

		((D3DXVECTOR4*)&OutMatrix)[0] *= Scale;
		((D3DXVECTOR4*)&OutMatrix)[1] *= Scale;
		((D3DXVECTOR4*)&OutMatrix)[2] *= Scale;
