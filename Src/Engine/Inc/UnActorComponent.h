...
protected:
	...
	class AActor* Owner;
	BITFIELD bAttached:1 GCC_PACK(4);
...
public:
	 ...
	 */
	virtual void TermComponentRBPhys(class FRBPhysScene* Scene) {}
...
public:
	...
	BITFIELD bUseCascadedShadowmap;
	//>@ ava
	...
	*/
	...
	/** determines if this LightComponent draws depth */
	...
	*/
	FORCEINLINE void SetStaticLightListIndex(INT Index)
	{ 
		LightListIndex = Index+1;
	}
	/**
	...
	* @param Index		New index to set
	*/
	FORCEINLINE void SetDynamicLightListIndex(INT Index)
	{ 
		LightListIndex = -Index-1;
	}
	/**
...
class UAudioComponent : public UActorComponent
{
	...
	FLOAT									CurrentPriorityMultiplier;
