...
#define EnableHostMigration // [+] 20070212 dEAthcURe|HM
#define EnableHmFastLoading // [+] 20070907 dEAthcURe|HM
#define EnableClientPreloading // 20071123 dEAthcURe|PL
//#define EnableMaxNetUpdateFrequency // 20071204 dEAthcURe|ON
//#define EnableNetClientAdjustFrequency // 20071205 dEAthcURe|ON
//#define EnableNetDriverTickFrequency // 20071205 dEAthcURe|ON
//#define EnableReliableAck // 20071210 dEAthcURe|ON
//#define EnableNetProfile // 20071211 dEAthcURe|ON
#define EnableOptVelocity // 20071212 dEAthcURe|ON velocity √÷¿˚»≠
//#define EnableNetClientTicksPerSecond // 20080107 dEAthcURe|TC
#define EnableSecureUdpLayer // 20080213 dEAthcURe|SUL

// {{ 20071204 dEAthcURe|ON net update frequency
#ifdef EnableMaxNetUpdateFrequency
#define DefaultMaxNetUpdateFreqency	100
extern float GMaxNetUpdateFreqency;
#endif
// }} 20071204 dEAthcURe|ON net update frequency

// {{ 20071205 dEAthcURe|ON net client adjust time
#ifdef EnableNetClientAdjustFrequency
#define DefaultNetClientAdjustFrequency 100
extern float GNetClientAdjustFrequency;
#endif
...
#define DefaultNetDriverTickFrequency 30
extern float GNetDriverTickFrequency;
#endif
...
#include "UnAudioEffect.h"					// Audio effects code.
...
#include "UnConsoleSupportContainer.h"		// A class that contains the console plug-ins
...
#include "AvaFullBuildGeometryOptions.h"
#include "AvaRadiosityAdapter.h"
//>@ ava
...
struct HActorComplex : public HHitProxy
{
	...
	HActorComplex(AActor *InActor, TCHAR *InDesc, INT InIndex)
	: Actor(InActor)
	, Desc(InDesc)
	, Index(InIndex)
	{
