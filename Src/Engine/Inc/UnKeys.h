...
DEFINE_KEY(XMouseButton, SIE_MouseButton);
DEFINE_KEY(YMouseButton, SIE_MouseButton);
...
DEFINE_KEY(NumPadEnter, SIE_Keyboard);
...
//  [10/25/2006 YTS] PrintScreen 키 추가(VK_SNAPSHOT)
DEFINE_KEY(PrintScreen, SIE_Keyboard);
...
/// 실제로 바인딩 되지는 않지만 코드내에서 쓰기위해 추가
DEFINE_KEY(Shift, SIE_Keyboard);
DEFINE_KEY(Ctrl, SIE_Keyboard);
DEFINE_KEY(Alt, SIE_Keyboard);
