...
class FNullRHITexture3D : public FNullRHITexture
{
};
typedef TNullRHIResourceRef<IDirect3DVolumeTexture9> FTexture3DRHIRef;
typedef FTexture3DRHIRef::ResourcePointer FTexture3DRHIParamRef;
