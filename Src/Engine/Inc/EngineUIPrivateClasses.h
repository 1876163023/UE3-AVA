...
{
    ARROWBUTTONSTATE_Clear  =0,
    ARROWBUTTONSTATE_ClickedUp=1,
    ARROWBUTTONSTATE_HeldUp =2,
    ARROWBUTTONSTATE_ClickedDown=3,
    ARROWBUTTONSTATE_HeldDown=4,
    ARROWBUTTONSTATE_MAX    =5,
};
...
AUTOGENERATE_NAME(ConstructElementSchemaCell)
...
AUTOGENERATE_NAME(OnMouseClicked)
AUTOGENERATE_NAME(OnMouseReleased)
...
AUTOGENERATE_NAME(OnScaleRenderComplete)
...
AUTOGENERATE_NAME(SetClipAlignment)
...
struct FScaleRenderParameters
{
    BITFIELD bEnabled:1;
    FVector2D ScaleAxis;
    FLOAT ScaleDuration;
    class UCurveEdPresetCurve* ScalePresetCurve[2];
    FLOAT ScaleUpdateTime;
...
struct UIComp_DrawComponents_eventOnScaleRenderComplete_Parms
{
    class UUIComp_DrawComponents* Sender;
    UIComp_DrawComponents_eventOnScaleRenderComplete_Parms(EEventParm)
    {
    }
};
...
public:
    ...
    FLOAT FadeDuration;
    BYTE FadeType;
    class UCurveEdPresetCurve* FadePresetCurve;
    FLOAT FadeUpdateTime;
    BITFIELD FadingTrigger:1;
    BITFIELD ScalingTrigger:1;
    struct FScaleRenderParameters ScaleRenderParam;
    FScriptDelegate __OnFadeComplete__Delegate;
    FScriptDelegate __OnScaleRenderComplete__Delegate;
    //## END PROPS UIComp_DrawComponents

    void Fade(BYTE itsFadeType,class UCurveEdPresetCurve* PresetCurve,FLOAT Duration);
    void ResetFade();
    void ScaleRender(class UCurveEdPresetCurve* PresetCurveHorz,class UCurveEdPresetCurve* PresetCurveVert,FLOAT ScaleAxisX,FLOAT ScaleAxisY,FLOAT ScaleDuration);
    void ResetScaleRender();
    virtual void ApplyDrawCompStyle(class UUIStyle_Data* StyleData);
    virtual void RefreshDrawCompStyle();
    class UUIObject* GetOuterUUIObject() const;
    DECLARE_FUNCTION(execFade)
    {
        P_GET_BYTE(itsFadeType);
        P_GET_OBJECT(UCurveEdPresetCurve,PresetCurve);
        P_GET_FLOAT(Duration);
        P_FINISH;
        Fade(itsFadeType,PresetCurve,Duration);
    }
    ...
    DECLARE_FUNCTION(execScaleRender)
    {
        P_GET_OBJECT(UCurveEdPresetCurve,PresetCurveHorz);
        P_GET_OBJECT(UCurveEdPresetCurve,PresetCurveVert);
        P_GET_FLOAT(ScaleAxisX);
        P_GET_FLOAT(ScaleAxisY);
        P_GET_FLOAT(ScaleDuration);
        P_FINISH;
        ScaleRender(PresetCurveHorz,PresetCurveVert,ScaleAxisX,ScaleAxisY,ScaleDuration);
    }
    DECLARE_FUNCTION(execResetScaleRender)
    {
        P_FINISH;
        ResetScaleRender();
    }
    DECLARE_FUNCTION(execApplyDrawCompStyle)
    {
        P_GET_OBJECT(UUIStyle_Data,StyleData);
        P_FINISH;
        ApplyDrawCompStyle(StyleData);
    }
    DECLARE_FUNCTION(execRefreshDrawCompStyle)
    {
        P_FINISH;
        RefreshDrawCompStyle();
    }
    DECLARE_FUNCTION(execGetOuterUUIObject)
    {
        P_FINISH;
        *(class UUIObject**)Result=GetOuterUUIObject();
    }
    void delegateOnScaleRenderComplete(class UUIComp_DrawComponents* Sender)
    {
        UIComp_DrawComponents_eventOnScaleRenderComplete_Parms Parms(EC_EventParm);
        Parms.Sender=Sender;
        ProcessDelegate(ENGINE_OnScaleRenderComplete,&__OnScaleRenderComplete__Delegate,&Parms);
    }
...
struct UIComp_DrawString_eventSetClipAlignment_Parms
{
    BYTE NewClipAlignment;
    UIComp_DrawString_eventSetClipAlignment_Parms(EEventParm)
    {
    }
};
...
public:
    ...
    void eventEnableAutoSizing(BYTE Orientation,UBOOL bShouldEnable=TRUE)
    {
        ...
        Parms.Orientation=Orientation;
        Parms.bShouldEnable=bShouldEnable ? FIRST_BITFIELD : 0;
        ProcessEvent(FindFunctionChecked(ENGINE_EnableAutoSizing),&Parms);
    }
    void eventSetClipAlignment(BYTE NewClipAlignment)
    {
        UIComp_DrawString_eventSetClipAlignment_Parms Parms(EC_EventParm);
        Parms.NewClipAlignment=NewClipAlignment;
        ProcessEvent(FindFunctionChecked(ENGINE_SetClipAlignment),&Parms);
    }
...
public:
    ...
    BITFIELD ShowInvert:1;
    BITFIELD bComposing:1;
    FVector2D CaretOffset;
    INT CertainEndPos;
    INT InsertPos;
    INT InvertStart;
    INT InvertEnd;
    FStringNoInit CurrCompStr;
    struct FInputCompositionStringData LastCompStrData;
...
public:
    ...
    class UUIList* GetOuterUUIList() const;
    DECLARE_FUNCTION(execGetOuterUUIList)
    {
        P_FINISH;
        *(class UUIList**)Result=GetOuterUUIList();
    }
...
public:
    ...
    UBOOL SortItems(INT ColumnIndex,UBOOL bSecondarySort=0,UBOOL bCaseSensitive=0);
    UBOOL ResortItems(UBOOL bCaseSensitive=0);
    ...
    DECLARE_FUNCTION(execSortItems)
    {
        ...
        P_GET_UBOOL_OPTX(bSecondarySort,0);
...
struct FUIListElementCellTemplate : public FUIListElementCell
{
    ...
    struct FUIScreenValue CellSize;
    FLOAT CellPosition;
...
struct FUIListItem
{
    ...
    struct FUIListElementCell ElementCell;
...
struct FUIElementCellSchema
{
    ...
    TArray<struct FUIListElementCell> EmptyCells;
...
struct FInternalUIObjectItem
{
    class UUIObject* Archetype;
    TArrayNoInit<class UUIObject*> Instances;
    BITFIELD bRefresh:1;
    BITFIELD bRemove:1;

    /** Constructors */
    FInternalUIObjectItem() {}
    FInternalUIObjectItem(EEventParm)
    {
        appMemzero(this, sizeof(FInternalUIObjectItem));
    }
};

struct UIComp_ListPresenter_eventConstructElementSchemaCell_Parms
{
    INT InsertIndex;
    UIComp_ListPresenter_eventConstructElementSchemaCell_Parms(EEventParm)
    {
    }
};
...
public:
    ...
    class UUITexture* ColumnHeaderBackground;
    struct FTextureCoordinates ListItemOverlayCoordinates[4];
private:
    BITFIELD bDisplayColumnHeaders:1;
public:
    BITFIELD bReapplyFormatting:1;
    BITFIELD bRecalcCellBounds:1;
    TArrayNoInit<struct FInternalUIObjectItem> InternalUIObjects;
    ...
    void RefreshInternalUIObjectSubscriberValue(INT BindingIndex=-1);
    ...
    DECLARE_FUNCTION(execRefreshInternalUIObjectSubscriberValue)
    {
        P_GET_INT_OPTX(BindingIndex,-1);
        P_FINISH;
        RefreshInternalUIObjectSubscriberValue(BindingIndex);
    }
    void eventConstructElementSchemaCell(INT InsertIndex)
    {
        UIComp_ListPresenter_eventConstructElementSchemaCell_Parms Parms(EC_EventParm);
        Parms.InsertIndex=InsertIndex;
        ProcessEvent(FindFunctionChecked(ENGINE_ConstructElementSchemaCell),&Parms);
    }
...
struct FInternalProviderInfo
{
    class UClass* ProviderClass;
    class UUIDataProvider* ProviderInstance;
    FName ProviderTag;
};
...
public:
    ...
    TArrayNoInit<struct FInternalProviderInfo> InternalProviderData;
...
public:
    ...
    UBOOL eventShowHostGamercard(BYTE ConrollerIndex,INT ListIndex)
    {
    ...
    UBOOL eventSubmitGameSearch(BYTE ConrollerIndex)
    {
...
public:
    ...
    virtual INT FindFieldIndex(FName FieldName,UBOOL bSearchPersistentFields=0) const;
    virtual UBOOL ClearFields(UBOOL bReinitializeRuntimeFields=TRUE);
    virtual void SavePersistentProviderData();
    virtual UBOOL SetCollectionValueArray(FName FieldName,const TArray<FString>& CollectionValues,UBOOL bClearExisting=TRUE,INT InsertIndex=-1,UBOOL bPersistent=0);
    virtual UBOOL InsertCollectionValue(FName FieldName,const FString& NewValue,INT InsertIndex=-1,UBOOL bPersistent=0,UBOOL bAllowDuplicateValues=0);
    virtual UBOOL RemoveCollectionValue(FName FieldName,const FString& ValueToRemove,UBOOL bPersistent=0);
    virtual UBOOL RemoveCollectionValueByIndex(FName FieldName,INT ValueIndex,UBOOL bPersistent=0);
    virtual UBOOL ReplaceCollectionValue(FName FieldName,const FString& CurrentValue,const FString& NewValue,UBOOL bPersistent=0);
    virtual UBOOL ReplaceCollectionValueByIndex(FName FieldName,INT ValueIndex,const FString& NewValue,UBOOL bPersistent=0);
    virtual UBOOL ClearCollectionValueArray(FName FieldName,UBOOL bPersistent=0);
    virtual UBOOL GetCollectionValue(FName FieldName,INT ValueIndex,FString& out_Value,UBOOL bPersistent=0) const;
    virtual INT FindCollectionValueIndex(FName FieldName,const FString& ValueToFind,UBOOL bPersistent=0) const;
    ...
    {
        P_GET_NAME(FieldName);
        P_GET_UBOOL_OPTX(bSearchPersistentFields,0);
        P_FINISH;
    ...
    DECLARE_FUNCTION(execSetCollectionValueArray)
    {
        ...
        P_GET_UBOOL_OPTX(bPersistent,0);
        P_FINISH;
    ...
    DECLARE_FUNCTION(execInsertCollectionValue)
    {
        ...
        P_GET_INT_OPTX(InsertIndex,-1);
        P_GET_UBOOL_OPTX(bPersistent,0);
        P_GET_UBOOL_OPTX(bAllowDuplicateValues,0);
        P_FINISH;
...
struct UIButton_eventOnMouseReleased_Parms
{
    class UUIButton* Sender;
    INT PlayerIndex;
    UIButton_eventOnMouseReleased_Parms(EEventParm)
    {
    }
};
struct UIButton_eventOnMouseClicked_Parms
{
    class UUIButton* Sender;
    INT PlayerIndex;
    UIButton_eventOnMouseClicked_Parms(EEventParm)
    {
    }
};
...
public:
    ...
    FName ClickedCue;
    FScriptDelegate __OnMouseClicked__Delegate;
    FScriptDelegate __OnMouseReleased__Delegate;
    //## END PROPS UIButton

    void delegateOnMouseReleased(class UUIButton* Sender,INT PlayerIndex)
    {
        UIButton_eventOnMouseReleased_Parms Parms(EC_EventParm);
        Parms.Sender=Sender;
        Parms.PlayerIndex=PlayerIndex;
        ProcessDelegate(ENGINE_OnMouseReleased,&__OnMouseReleased__Delegate,&Parms);
    }
    void delegateOnMouseClicked(class UUIButton* Sender,INT PlayerIndex)
    {
        UIButton_eventOnMouseClicked_Parms Parms(EC_EventParm);
        Parms.Sender=Sender;
        Parms.PlayerIndex=PlayerIndex;
        ProcessDelegate(ENGINE_OnMouseClicked,&__OnMouseClicked__Delegate,&Parms);
    }
...
class UUIListButton : public UUILabelButton
{
public:
    //## BEGIN PROPS UIListButton
    INT ElementIndex;
    //## END PROPS UIListButton

    DECLARE_CLASS(UUIListButton,UUILabelButton,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(UUIListButton)
};
...
public:
    ...
    UBOOL IsTargeted(INT PlayerIndex=0) const;
    ...
    DECLARE_FUNCTION(execIsTargeted)
    {
        ...
        P_FINISH;
        *(UBOOL*)Result=IsTargeted(PlayerIndex);
    }
    ...
    NO_DEFAULT_CONSTRUCTOR(UUITabButton)
};
...
class UUIScrollbarMarkerButton : public UUIButton
{
public:
    ...
    DECLARE_CLASS(UUIScrollbarMarkerButton,UUIButton,0,Engine)
...
public:
    ...
    BITFIELD bSetFieldValueOnSubmit:1;
    BITFIELD bSelectListWhenRefresh:1;
    TArrayNoInit<class UUIComboBox*> NextDependencies;
    ...
    virtual void GetBoundDataStores(TArray<class UUIDataStore*>& out_BoundDataStores);
    virtual void ClearBoundDataStores();
    virtual UBOOL SetFieldValueOnSubmit();
    DECLARE_FUNCTION(execSetDataStoreBinding)
    {
        P_GET_STR(MarkupText);
        P_GET_INT_OPTX(BindingIndex,-1);
    ...
    DECLARE_FUNCTION(execSetFieldValueOnSubmit)
    {
        P_FINISH;
        *(UBOOL*)Result=SetFieldValueOnSubmit();
    }
...
public:
    ...
    BITFIELD bDisplayBackground:1;
    class UUIScrollbar* ScrollbarHorizontal;
    class UUIScrollbar* ScrollbarVertical;
    struct FUIScreenValue_Bounds RegionExtent;
    BITFIELD bResolveRegion:1;
    ...
    UBOOL ScrollHorizontal(FLOAT PositionChange,UBOOL bPositionMaxed=FALSE);
    UBOOL ScrollVertical(FLOAT PositionChange,UBOOL bPositionMaxed=FALSE);
    DECLARE_FUNCTION(execOnChildRepositioned)
    {
        P_GET_OBJECT(UUIScreenObject,Sender);
        P_FINISH;
        OnChildRepositioned(Sender);
    }
    DECLARE_FUNCTION(execScrollHorizontal)
    {
        P_GET_FLOAT(PositionChange);
        P_GET_UBOOL_OPTX(bPositionMaxed,FALSE);
        P_FINISH;
        *(UBOOL*)Result=ScrollHorizontal(PositionChange,bPositionMaxed);
    }
    DECLARE_FUNCTION(execScrollVertical)
    {
        ...
        P_GET_UBOOL_OPTX(bPositionMaxed,FALSE);
        P_FINISH;
        *(UBOOL*)Result=ScrollVertical(PositionChange,bPositionMaxed);
    }
...
class UUITabPage : public UUIScrollFrame, public IUIDataStoreSubscriber
{
public:
    ...
    UBOOL eventActivatePage(INT PlayerIndex,UBOOL bActivate,UBOOL bTakeFocus=TRUE)
    {
        ...
        Parms.ReturnValue=0;
        Parms.PlayerIndex=PlayerIndex;
        Parms.bActivate=bActivate ? FIRST_BITFIELD : 0;
        Parms.bTakeFocus=bTakeFocus ? FIRST_BITFIELD : 0;
        ProcessEvent(FindFunctionChecked(ENGINE_ActivatePage),&Parms);
        return Parms.ReturnValue;
    }
    DECLARE_CLASS(UUITabPage,UUIScrollFrame,0,Engine)
    virtual UObject* GetUObjectInterfaceUIDataStoreSubscriber(){return this;}
...
public:
    ...
    class UUIComp_DrawImage* BackgroundImageComponent;
    BITFIELD bShowIMECandidateWindow:1;
    BITFIELD bDisableCopyAndPaste:1;
    ...
    INT MaxCharacters;
    BYTE CharacterSet;
    BITFIELD bLimitTextInRenderBound:1 GCC_BITFIELD_MAGIC;
    class UUILabel* CandidateLabel;
    class UUILabel* ReadingLabel;
    class UUILabel* IndicatorLabel;
    class UUINumericEditBoxButton* PageUpButton;
    class UUINumericEditBoxButton* PageDownButton;
    FScriptDelegate __OnSubmitText__Delegate;
    //## END PROPS UIEditBox

    void SetValue(const FString& NewText,INT PlayerIndex=0,UBOOL bSkipNotification=0);
    ...
    DECLARE_FUNCTION(execSetValue)
    {
        P_GET_STR(NewText);
        P_GET_INT_OPTX(PlayerIndex,GetBestPlayerIndex());
        P_GET_UBOOL_OPTX(bSkipNotification,0);
        P_FINISH;
...
public:
    ...
    UBOOL SetNumericValue(FLOAT NewValue);
    ...
    DECLARE_FUNCTION(execSetNumericValue)
    {
        ...
        P_FINISH;
        *(UBOOL*)Result=SetNumericValue(NewValue);
    }
...
public:
    ...
    DECLARE_FUNCTION(execIsActiveToolTip)
    {
        P_FINISH;
        *(UBOOL*)Result=IsActiveToolTip();
    }
...
public:
    //## BEGIN PROPS UIList
    struct FUIScreenValue RowHeight;
    struct FUIScreenValue RowHeaderHeight;
    struct FUIScreenValue ColumnWidth;
    struct FUIScreenValue ColumnHeaderWidth;
    struct FUIScreenValue CellSpacing;
    struct FUIScreenValue CellPadding;
    INT Index;
    INT ActiveIndex;
    INT TopIndex;
    INT MaxVisibleItems;
protected:
    ...
    INT RowCount;
public:
    BITFIELD bDrawVisibleItems:1;
    BITFIELD bCellUnitDrawing:1;
    BYTE ColumnAutoSizeMode GCC_BITFIELD_MAGIC;
    ...
    BITFIELD bNoSelectWhenRefresh:1;
    ...
    class UUIComp_DrawImage* SelectionOverlayComponent;
...
private:
    TArrayNoInit<INT> SelectedIndices;
public:
    ...
    FName ActiveIndexChangedCue;
    FName ClickCue;
    FName DoubleClickCue;
    FLOAT DoubleClickDuration;
    FLOAT MousePressUpdateTime;
    BITFIELD bWaitSecondClick:1;
    INT PrvSelectedIndex;
    BITFIELD bProcessInput:1;
    BITFIELD bNotifyAlways:1;
    BITFIELD bAlwaysSkipNotification:1;
    ...
    void ClearBoundDataStores();
    virtual UBOOL SaveSubscriberValue(TArray<class UUIDataStore*>& out_BoundDataStores,INT BindingIndex=-1);
    virtual UBOOL CalculateCellFromPosition(FIntPoint HitLocation,struct FCellHitDetectionInfo& out_HitInfo) const;
    ...
    DECLARE_FUNCTION(execGetHeaderSize)
    {
        P_FINISH;
        *(FLOAT*)Result=GetHeaderSize();
    }
    ...
    DECLARE_FUNCTION(execCalculateCellFromPosition)
    {
        P_GET_STRUCT(FIntPoint,HitLocation);
        P_GET_STRUCT_REF(struct FCellHitDetectionInfo,out_HitInfo);
        P_FINISH;
        *(UBOOL*)Result=CalculateCellFromPosition(HitLocation,out_HitInfo);
    }
    DECLARE_FUNCTION(execNotifySubmitSelection)
    {
        P_GET_INT(PlayerIndex);
        P_FINISH;
...
public:
    ...
    UBOOL eventInsertMenuItem(class UUIObject* Widget,const FString& Item,INT InsertIndex=-1,UBOOL bAllowDuplicates=0)
    {
        ...
        Parms.Item=Item;
        Parms.InsertIndex=InsertIndex;
        Parms.bAllowDuplicates=bAllowDuplicates ? FIRST_BITFIELD : 0;
    ...
    UBOOL eventSetMenuItems(class UUIObject* Widget,const TArray<FString>& NewMenuItems,UBOOL bClearExisting=TRUE,INT InsertIndex=-1)
    {
        ...
        Parms.bClearExisting=bClearExisting ? FIRST_BITFIELD : 0;
        Parms.InsertIndex=InsertIndex;
...
struct UIPIP_eventRefresh_Parms
{
    UIPIP_eventRefresh_Parms(EEventParm)
    {
    }
};
class UUIPIP : public UUIObject
{
public:
    //## BEGIN PROPS UIPIP
    ...
    BITFIELD bUsingLookAt:1;
    BITFIELD bTransparentBackground:1;
    FColor FadeColor;
    ...
    void eventRefresh()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_Refresh),NULL);
    }
    DECLARE_CLASS(UUIPIP,UUIObject,0,Engine)
	virtual void FinishDestroy();
...
public:
    ...
    void ClearBoundDataStores();
    virtual UBOOL SaveSubscriberValue(TArray<class UUIDataStore*>& out_BoundDataStores,INT BindingIndex=-1);
    UBOOL SetValue(FLOAT NewValue,UBOOL bPercentageValue=0);
    FLOAT GetValue(UBOOL bPercentageValue=0) const;
    DECLARE_FUNCTION(execSetDataStoreBinding)
    {
        P_GET_STR(MarkupText);
        P_GET_INT_OPTX(BindingIndex,-1);
    ...
    {
        P_GET_FLOAT(NewValue);
        P_GET_UBOOL_OPTX(bPercentageValue,0);
        P_FINISH;
...
#define UCONST_PRIVATE_ArrowClickRepeat 0.05
#define UCONST_PRIVATE_ArrowClickDelay 0.33
...
public:
    struct FUIScreenValue BarWidth;
    struct FUIScreenValue MinimumMarkerSize;
    struct FUIScreenValue ButtonsExtent;
    ...
    BYTE ArrowButtonState GCC_BITFIELD_MAGIC;
    FLOAT ArrowButtonClickTime;
    ...
    UBOOL delegateOnScrollActivity(FLOAT PositionChange,UBOOL bPositionMaxed=FALSE)
    {
        UIScrollbar_eventOnScrollActivity_Parms Parms(EC_EventParm);
        Parms.ReturnValue=0;
        Parms.PositionChange=PositionChange;
        Parms.bPositionMaxed=bPositionMaxed ? FIRST_BITFIELD : 0;
...
public:
    ...
    struct FUIScreenValue BarSize;
    struct FUIScreenValue MarkerHeight;
    struct FUIScreenValue MarkerWidth;
    FName IncrementCue;
    FName DecrementCue;
    //## END PROPS UISlider
...
public:
    ...
    BYTE TabDockFace;
    BYTE TabSizeMode;
    struct FUIScreenValue TabButtonSize;
    struct FUIScreenValue TabButtonPadding;
    ...
    virtual class UUITabPage* CreateTabPage(class UClass* TabPageClass);
    ...
    DECLARE_FUNCTION(execCreateTabPage)
    {
        ...
        P_FINISH;
        *(class UUITabPage**)Result=CreateTabPage(TabPageClass);
    }
    UBOOL eventActivatePreviousPage(INT PlayerIndex,UBOOL bFocusPage=TRUE,UBOOL bAllowWrapping=TRUE)
    {
        ...
        Parms.ReturnValue=0;
        Parms.PlayerIndex=PlayerIndex;
        Parms.bFocusPage=bFocusPage ? FIRST_BITFIELD : 0;
        Parms.bAllowWrapping=bAllowWrapping ? FIRST_BITFIELD : 0;
    ...
    UBOOL eventInsertPage(class UUITabPage* PageToInsert,INT PlayerIndex,INT InsertIndex=-1,UBOOL bActivateImmediately=TRUE)
    {
        ...
        Parms.PlayerIndex=PlayerIndex;
        Parms.InsertIndex=InsertIndex;
        Parms.bActivateImmediately=bActivateImmediately ? FIRST_BITFIELD : 0;
    ...
    DECLARE_CLASS(UUITabControl,UUIObject,0,Engine)
...
public:
    ...
    BITFIELD bEnabled:1;
    BITFIELD bDirty:1;
    BYTE FadeType GCC_BITFIELD_MAGIC;
    class UCurveEdPresetCurve* FadePresetCurve;
    FLOAT FadeDuration;
    class UCurveEdPresetCurve* ScalePresetCurve[2];
    FLOAT ScaleDuration;
...
class UUITileMotionTexture : public UUITexture
{
public:
    //## BEGIN PROPS UITileMotionTexture
    INT TileDimension[2];
    INT NumActivated;
    FLOAT MotionPeriod;
    INT MotionRepeat;
    FLOAT UpdateTime;
    INT OffsetIndex;
    //## END PROPS UITileMotionTexture

    DECLARE_CLASS(UUITileMotionTexture,UUITexture,0,Engine)
	/**
	 * Fills in the extent with the size of this texture's material
	 *
	 * @param	Extent	[out] set to the width/height of this texture's material
...
AUTOGENERATE_FUNCTION(UGameUISceneClient,-1,execFlushPlayerInput);
...
AUTOGENERATE_FUNCTION(UUIComboBox,-1,execSetFieldValueOnSubmit);
...
AUTOGENERATE_FUNCTION(UUIComp_DrawComponents,-1,execGetOuterUUIObject);
AUTOGENERATE_FUNCTION(UUIComp_DrawComponents,-1,execRefreshDrawCompStyle);
AUTOGENERATE_FUNCTION(UUIComp_DrawComponents,-1,execApplyDrawCompStyle);
AUTOGENERATE_FUNCTION(UUIComp_DrawComponents,-1,execResetScaleRender);
AUTOGENERATE_FUNCTION(UUIComp_DrawComponents,-1,execScaleRender);
...
AUTOGENERATE_FUNCTION(UUIComp_ListComponentBase,-1,execGetOuterUUIList);
...
AUTOGENERATE_FUNCTION(UUIComp_ListPresenter,-1,execRefreshInternalUIObjectSubscriberValue);
...
AUTOGENERATE_FUNCTION(UUIList,-1,execNotifySubmitSelection);
AUTOGENERATE_FUNCTION(UUIList,-1,execCalculateCellFromPosition);
...
AUTOGENERATE_FUNCTION(UUIList,-1,execGetHeaderSize);
...
AUTOGENERATE_FUNCTION(UUIPIP,-1,execSetupScene);
AUTOGENERATE_FUNCTION(UUIPIP,-1,execDeleteScene);
...
AUTOGENERATE_FUNCTION(UUIScrollFrame,-1,execScrollVertical);
AUTOGENERATE_FUNCTION(UUIScrollFrame,-1,execScrollHorizontal);
AUTOGENERATE_FUNCTION(UUIScrollFrame,-1,execOnChildRepositioned);
AUTOGENERATE_FUNCTION(UUIScrollFrame,-1,execInsertChild);
...
AUTOGENERATE_FUNCTION(UUIToolTip,-1,execIsActiveToolTip);
...
DECLARE_NATIVE_TYPE(Engine,UUIListButton);
...
DECLARE_NATIVE_TYPE(Engine,UUIPIP);
...
DECLARE_NATIVE_TYPE(Engine,UUITileMotionTexture);
...
#define AUTO_INITIALIZE_REGISTRANTS_ENGINE_UIPRIVATE \
	...
	GNativeLookupFuncs[Lookup++] = &FindEngineUUIComp_ListComponentBaseNative; \
	...
	UUIPIP::StaticClass(); \
	GNativeLookupFuncs[Lookup++] = &FindEngineUUIPIPNative; \
	...
	UUITileMotionTexture::StaticClass(); \
...
{ 
	MAP_NATIVE(UGameUISceneClient,execFlushPlayerInput)
...
{ 
	MAP_NATIVE(UUIComboBox,execSetFieldValueOnSubmit)
...
{ 
	MAP_NATIVE(UUIComp_DrawComponents,execGetOuterUUIObject)
	MAP_NATIVE(UUIComp_DrawComponents,execRefreshDrawCompStyle)
	MAP_NATIVE(UUIComp_DrawComponents,execApplyDrawCompStyle)
	MAP_NATIVE(UUIComp_DrawComponents,execResetScaleRender)
	MAP_NATIVE(UUIComp_DrawComponents,execScaleRender)
...
NATIVE_INFO(UUIComp_ListComponentBase) GEngineUUIComp_ListComponentBaseNatives[] = 
{ 
	MAP_NATIVE(UUIComp_ListComponentBase,execGetOuterUUIList)
	{NULL,NULL}
};
IMPLEMENT_NATIVE_HANDLER(Engine,UUIComp_ListComponentBase);
...
{ 
	MAP_NATIVE(UUIComp_ListPresenter,execRefreshInternalUIObjectSubscriberValue)
...
{ 
	...
	MAP_NATIVE(UUIList,execNotifySubmitSelection)
	MAP_NATIVE(UUIList,execCalculateCellFromPosition)
	...
	MAP_NATIVE(UUIList,execGetHeaderSize)
...
NATIVE_INFO(UUIPIP) GEngineUUIPIPNatives[] = 
{ 
	MAP_NATIVE(UUIPIP,execSetupScene)
	MAP_NATIVE(UUIPIP,execDeleteScene)
	{NULL,NULL}
};
IMPLEMENT_NATIVE_HANDLER(Engine,UUIPIP);
...
{ 
	MAP_NATIVE(UUIScrollFrame,execScrollVertical)
	MAP_NATIVE(UUIScrollFrame,execScrollHorizontal)
	MAP_NATIVE(UUIScrollFrame,execOnChildRepositioned)
	MAP_NATIVE(UUIScrollFrame,execInsertChild)
	{NULL,NULL}
};
...
{ 
	MAP_NATIVE(UUIToolTip,execIsActiveToolTip)
...
VERIFY_CLASS_OFFSET_NODIE(U,ConsoleEntry,InputText)
...
VERIFY_CLASS_OFFSET_NODIE(U,GameUISceneClient,InitialPressedKeys)
...
VERIFY_CLASS_OFFSET_NODIE(U,UIButton,__OnMouseReleased__Delegate)
...
VERIFY_CLASS_OFFSET_NODIE(U,UIComp_DrawComponents,FadeDuration)
VERIFY_CLASS_OFFSET_NODIE(U,UIComp_DrawComponents,__OnScaleRenderComplete__Delegate)
...
VERIFY_CLASS_OFFSET_NODIE(U,UIComp_DrawString,TextAlignmentVertical)
VERIFY_CLASS_SIZE_NODIE(UUIComp_DrawString)
VERIFY_CLASS_OFFSET_NODIE(U,UIComp_DrawStringEditbox,UserText)
VERIFY_CLASS_OFFSET_NODIE(U,UIComp_DrawStringEditbox,LastCompStrData)
...
VERIFY_CLASS_OFFSET_NODIE(U,UIComp_ListPresenter,InternalUIObjects)
...
VERIFY_CLASS_OFFSET_NODIE(U,UIDataStore_OnlineGameSearch,GameSearchClass)
VERIFY_CLASS_OFFSET_NODIE(U,UIDataStore_OnlineGameSearch,GameInterface)
VERIFY_CLASS_SIZE_NODIE(UUIDataStore_OnlineGameSearch)
VERIFY_CLASS_OFFSET_NODIE(U,UIDataStore_OnlineGameSettings,GameSettingsClass)
VERIFY_CLASS_OFFSET_NODIE(U,UIDataStore_OnlineGameSettings,GameSettings)
...
VERIFY_CLASS_OFFSET_NODIE(U,UIListButton,ElementIndex)
VERIFY_CLASS_SIZE_NODIE(UUIListButton)
...
VERIFY_CLASS_OFFSET_NODIE(U,UIPIP,ViewState)
VERIFY_CLASS_OFFSET_NODIE(U,UIPIP,Components)
VERIFY_CLASS_SIZE_NODIE(UUIPIP)
...
VERIFY_CLASS_OFFSET_NODIE(U,UIScrollFrame,BackgroundImageComponent)
VERIFY_CLASS_OFFSET_NODIE(U,UIScrollFrame,RegionExtent)
...
VERIFY_CLASS_OFFSET_NODIE(U,UIStyle_Data,ScaleAxis)
...
VERIFY_CLASS_OFFSET_NODIE(U,UIStyle_Text,Alignment)
...
VERIFY_CLASS_OFFSET_NODIE(U,UITileMotionTexture,TileDimension)
VERIFY_CLASS_OFFSET_NODIE(U,UITileMotionTexture,OffsetIndex)
VERIFY_CLASS_SIZE_NODIE(UUITileMotionTexture)
