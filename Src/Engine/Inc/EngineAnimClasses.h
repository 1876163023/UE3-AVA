...
public:
    ...
    virtual void MAT_SetAnimPosition(FName SlotName,INT ChannelIndex,FName InAnimSeqName,FLOAT InPosition,UBOOL bFireNotifies);
...
public:
    ...
    FLOAT PlayCustomAnim(FName AnimName,FLOAT Rate,FLOAT BlendInTime=0,FLOAT BlendOutTime=0,UBOOL bLooping=0,UBOOL bOverride=0);
    void PlayCustomAnimByDuration(FName AnimName,FLOAT Duration,FLOAT BlendInTime=0,FLOAT BlendOutTime=0,UBOOL bLooping=0,UBOOL bOverride=0);
    ...
    DECLARE_FUNCTION(execPlayCustomAnim)
    {
        ...
        P_GET_UBOOL_OPTX(bLooping,0);
        P_GET_UBOOL_OPTX(bOverride,0);
        P_FINISH;
...
public:
    ...
    FLOAT PlayCustomAnim(FName AnimName,FLOAT Rate,FLOAT BlendInTime=0,FLOAT BlendOutTime=0,UBOOL bLooping=0,UBOOL bOverride=0);
    void PlayCustomAnimByDuration(FName AnimName,FLOAT Duration,FLOAT BlendInTime=0,FLOAT BlendOutTime=0,UBOOL bLooping=0,UBOOL bOverride=TRUE);
...
public:
    ...
    UBOOL SetAnimGroupForNode(class UAnimNodeSequence* SeqNode,FName GroupName,UBOOL bCreateIfNotFound=0);
    ...
    DECLARE_FUNCTION(execSetAnimGroupForNode)
    {
        P_GET_OBJECT(UAnimNodeSequence,SeqNode);
        P_GET_NAME(GroupName);
        P_GET_UBOOL_OPTX(bCreateIfNotFound,0);
        P_FINISH;
...
public:
    ...
    UBOOL CanLookAtPoint(FVector PointLoc,UBOOL bDrawDebugInfo=0,UBOOL bDebugUsePersistentLines=0,UBOOL bDebugFlushLinesFirst=0);
    ...
    DECLARE_FUNCTION(execCanLookAtPoint)
    {
        ...
        P_GET_UBOOL_OPTX(bDrawDebugInfo,0);
        P_GET_UBOOL_OPTX(bDebugUsePersistentLines,0);
        P_GET_UBOOL_OPTX(bDebugFlushLinesFirst,0);
        P_FINISH;
...
VERIFY_CLASS_OFFSET_NODIE(U,AnimNodeSequence,PreviousTime)
...
VERIFY_CLASS_OFFSET_NODIE(U,MorphNodePose,MorphName)
...
VERIFY_CLASS_OFFSET_NODIE(U,SkelControlFootPlacement,ToePos)
