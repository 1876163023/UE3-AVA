...
VERIFY_CLASS_OFFSET_NODIE(A,Terrain,ExportDispInfoOffset)
...
VERIFY_CLASS_OFFSET_NODIE(U,TerrainComponent,BoxCheckTree)
VERIFY_CLASS_OFFSET_NODIE(U,TerrainComponent,CollisionVertices)
VERIFY_CLASS_OFFSET_NODIE(U,TerrainComponent,RBHeightfield)
VERIFY_CLASS_OFFSET_NODIE(U,TerrainComponent,FirstExportedFaceNumber)
