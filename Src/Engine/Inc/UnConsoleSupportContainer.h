...
public:
	 ...
	 *
	 */
	void LoadAllConsoleSupportModules();
	 ...
	 */
	FConsoleSupport* GetConsoleSupport(INT Index);
	 ...
	 * @return	Requested Console support object
	 */
	FConsoleSupport* GetConsoleSupport(TCHAR* ConsoleName);
