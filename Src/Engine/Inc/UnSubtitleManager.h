...
public:
	 ...
	 */
	void		KillSubtitles( DWORD SubtitleID );
	 ...
	 */
	DWORD		FindHighestPrioritySubtitle( FLOAT CurrentTime );
	 ...
	 */
	void		QueueSubtitles( DWORD SubtitleID, FLOAT Priority, UBOOL bManualWordWrap, FLOAT SoundDuration, TArray<FSubtitleCue>& Subtitles );
...
private:
	 ...
	 */
	TMap<DWORD, FActiveSubtitle>	ActiveSubtitles;
};
