...
extern FString TextureGroupNames[];
...
extern void DrawBox(class FPrimitiveDrawInterface* PDI,const FMatrix& BoxToWorld,const FVector& Radii,const FMaterialInstance* MaterialInstance,BYTE DepthPriority);
extern void DrawSphere(class FPrimitiveDrawInterface* PDI,const FVector& Center,const FVector& Radii,INT NumSides,INT NumRings,const FMaterialInstance* MaterialInstance,BYTE DepthPriority);
extern void DrawCone(class FPrimitiveDrawInterface* PDI,const FMatrix& ConeToWorld, FLOAT Angle1, FLOAT Angle2, INT NumSides, UBOOL bDrawSideLines, const FColor& SideLineColor, const FMaterialInstance* MaterialInstance, BYTE DepthPriority);
