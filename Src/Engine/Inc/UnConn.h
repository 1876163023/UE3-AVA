...
#else
#define DO_ENABLE_NET_TEST 0
#endif

//#define _BT_TEST_BY_CRAZY

#ifdef _BT_TEST_BY_CRAZY

#if !FINAL_RELEASE
//#define _BT_TEST_BY_CRAZY_LOG
#endif

//#define _NET_BALANCE_VALUE		3000
//#define _NET_SPEED_CALC_BYTES	1000
//#define _NET_SPEED_MIN			500
//#define _NET_SPEED_MAX			6000
//#define _NET_SPEED_SUM_RATE		0.4f
//#define _NET_MAX_QUEUED_BYTES	100
//#define _NET_DELTA_BYTES_RATE	1.1f

#define _NET_BALANCE_VALUE		UNetConnection::NetBalanceValue
#define _NET_SPEED_CALC_BYTES	UNetConnection::NetSpeedCalcBytes
#define _NET_SPEED_MIN			UNetConnection::NetSpeedMin
#define _NET_SPEED_MAX			UNetConnection::NetSpeedMax
#define _NET_SPEED_SUM_RATE		UNetConnection::NetSpeedSumRate
#define _NET_MAX_QUEUED_BYTES	UNetConnection::NetMaxQueuedBytes
#define _NET_DELTA_BYTES_RATE	UNetConnection::NetDeltaBytesRate
#endif

#ifdef _BT_TEST_BY_CRAZY_LOG
void BTPrintF(LPCTSTR fmt, ...);
#else
#define BTPrintF __noop
#endif
...
#ifdef _BT_TEST_BY_CRAZY
	INT				OutLagPacketLen[256];	// For net speed measuring.
	INT				NetFrameBytes;
	INT				NetBytes;
	DOUBLE			LastNewNetSpeedTime;
	INT				NewNetSpeed;
#endif
...
#ifdef _BT_TEST_BY_CRAZY
	static UBOOL ParseSettings(const TCHAR* Cmd, FOutputDevice& Ar);

	static INT NetBalanceValue;
	static INT NetSpeedCalcBytes;
	static INT NetSpeedMin;
	static INT NetSpeedMax;
	static FLOAT NetSpeedSumRate;
	static INT NetMaxQueuedBytes;
	static FLOAT NetDeltaBytesRate;

	static UBOOL bIgnoreNetReadyCheck;
