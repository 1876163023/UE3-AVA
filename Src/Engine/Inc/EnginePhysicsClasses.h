...
public:
    ...
    void SetNamedBodiesFixed(UBOOL bNewFixed,const TArray<FName>& BoneNames,class USkeletalMeshComponent* SkelMesh,UBOOL bSetOtherBodiesToComplement=0);
    void SetAllMotorsAngularPositionDrive(UBOOL bEnableSwingDrive,UBOOL bEnableTwistDrive);
    void SetNamedMotorsAngularPositionDrive(UBOOL bEnableSwingDrive,UBOOL bEnableTwistDrive,const TArray<FName>& BoneNames,class USkeletalMeshComponent* SkelMeshComp,UBOOL bSetOtherBodiesToComplement=0);
    ...
    DECLARE_FUNCTION(execSetNamedBodiesFixed)
    {
        ...
        P_GET_UBOOL_OPTX(bSetOtherBodiesToComplement,0);
        P_FINISH;
