...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UUIAction_GetListItemCount)
};
...
class UUIAction_GetLabelText : public UUIAction_GetValue
{
public:
    //## BEGIN PROPS UIAction_GetLabelText
    FStringNoInit OutText;
    //## END PROPS UIAction_GetLabelText

    DECLARE_CLASS(UUIAction_GetLabelText,UUIAction_GetValue,0,Engine)
	/**
	 * Activated event handler.
	 */
	virtual void Activated(void);
...
class UUIAction_SetSceneDisplayCursorProperty : public UUIAction_Scene
{
public:
    //## BEGIN PROPS UIAction_SetSceneDisplayCursorProperty
    BITFIELD bDisplayCursor:1;
    //## END PROPS UIAction_SetSceneDisplayCursorProperty

    DECLARE_CLASS(UUIAction_SetSceneDisplayCursorProperty,UUIAction_Scene,0,Engine)
	virtual void Activated();
};
...
class UUIEvent_Hidden : public UUIEvent
{
public:
    //## BEGIN PROPS UIEvent_Hidden
    //## END PROPS UIEvent_Hidden

    DECLARE_CLASS(UUIEvent_Hidden,UUIEvent,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(UUIEvent_Hidden)
};
...
class UUIEvent_OnChar : public UUIEvent
{
public:
    //## BEGIN PROPS UIEvent_OnChar
    //## END PROPS UIEvent_OnChar

    DECLARE_CLASS(UUIEvent_OnChar,UUIEvent,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(UUIEvent_OnChar)
};
...
class UUIEvent_OnGainFocus : public UUIEvent
{
public:
    //## BEGIN PROPS UIEvent_OnGainFocus
    //## END PROPS UIEvent_OnGainFocus

    DECLARE_CLASS(UUIEvent_OnGainFocus,UUIEvent,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(UUIEvent_OnGainFocus)
};

class UUIEvent_OnLoseFocus : public UUIEvent
{
public:
    //## BEGIN PROPS UIEvent_OnLoseFocus
    //## END PROPS UIEvent_OnLoseFocus

    DECLARE_CLASS(UUIEvent_OnLoseFocus,UUIEvent,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(UUIEvent_OnLoseFocus)
};

class UUIEvent_OnRightClick : public UUIEvent
{
public:
    //## BEGIN PROPS UIEvent_OnRightClick
    //## END PROPS UIEvent_OnRightClick

    DECLARE_CLASS(UUIEvent_OnRightClick,UUIEvent,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(UUIEvent_OnRightClick)
};
...
class UUIEvent_Show : public UUIEvent
{
public:
    //## BEGIN PROPS UIEvent_Show
    //## END PROPS UIEvent_Show

    DECLARE_CLASS(UUIEvent_Show,UUIEvent,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(UUIEvent_Show)
};
...
class UUIEvent_ListActiveIndexChanged : public UUIEvent_ValueChanged
{
public:
    //## BEGIN PROPS UIEvent_ListActiveIndexChanged
    INT PreviousIndex;
    INT CurrentIndex;
    INT CurrentItem;
    //## END PROPS UIEvent_ListActiveIndexChanged

    DECLARE_CLASS(UUIEvent_ListActiveIndexChanged,UUIEvent_ValueChanged,0,Engine)
	/** USequenceOp interface */
	/**
	 * Allows the operation to initialize the values for any VariableLinks that need to be filled prior to executing this
	 * op's logic.  This is a convenient hook for filling VariableLinks that aren't necessarily associated with an actual
...
class UUIEvent_ListTopIndexChanged : public UUIEvent_ValueChanged
{
public:
    //## BEGIN PROPS UIEvent_ListTopIndexChanged
    INT PreviousTopIndex;
    INT CurrentTopIndex;
    //## END PROPS UIEvent_ListTopIndexChanged

    DECLARE_CLASS(UUIEvent_ListTopIndexChanged,UUIEvent_ValueChanged,0,Engine)
	/** USequenceOp interface */
	/**
	 * Allows the operation to initialize the values for any VariableLinks that need to be filled prior to executing this
	 * op's logic.  This is a convenient hook for filling VariableLinks that aren't necessarily associated with an actual
...
DECLARE_NATIVE_TYPE(Engine,UUIAction_GetLabelText);
...
DECLARE_NATIVE_TYPE(Engine,UUIAction_SetSceneDisplayCursorProperty);
...
DECLARE_NATIVE_TYPE(Engine,UUIEvent_Hidden);
DECLARE_NATIVE_TYPE(Engine,UUIEvent_ListActiveIndexChanged);
DECLARE_NATIVE_TYPE(Engine,UUIEvent_ListIndexChanged);
DECLARE_NATIVE_TYPE(Engine,UUIEvent_ListTopIndexChanged);
DECLARE_NATIVE_TYPE(Engine,UUIEvent_MetaObject);
DECLARE_NATIVE_TYPE(Engine,UUIEvent_OnChar);
...
DECLARE_NATIVE_TYPE(Engine,UUIEvent_OnGainFocus);
DECLARE_NATIVE_TYPE(Engine,UUIEvent_OnLeaveState);
DECLARE_NATIVE_TYPE(Engine,UUIEvent_OnLoseFocus);
DECLARE_NATIVE_TYPE(Engine,UUIEvent_OnRightClick);
...
DECLARE_NATIVE_TYPE(Engine,UUIEvent_Show);
...
#define AUTO_INITIALIZE_REGISTRANTS_ENGINE_UISEQUENCE \
	...
	UUIAction_GetLabelText::StaticClass(); \
	...
	UUIAction_SetSceneDisplayCursorProperty::StaticClass(); \
...
VERIFY_CLASS_OFFSET_NODIE(U,UIAction_CloseScene,SceneTags)
...
VERIFY_CLASS_OFFSET_NODIE(U,UIAction_GetLabelText,OutText)
VERIFY_CLASS_SIZE_NODIE(UUIAction_GetLabelText)
...
VERIFY_CLASS_OFFSET_NODIE(U,UIAction_OpenScene,Priority)
...
VERIFY_CLASS_SIZE_NODIE(UUIAction_SetSceneDisplayCursorProperty)
...
VERIFY_CLASS_OFFSET_NODIE(U,UIEvent,Description)
...
VERIFY_CLASS_SIZE_NODIE(UUIEvent_Hidden)
VERIFY_CLASS_OFFSET_NODIE(U,UIEvent_ListActiveIndexChanged,PreviousIndex)
VERIFY_CLASS_OFFSET_NODIE(U,UIEvent_ListActiveIndexChanged,CurrentItem)
VERIFY_CLASS_SIZE_NODIE(UUIEvent_ListActiveIndexChanged)
...
VERIFY_CLASS_OFFSET_NODIE(U,UIEvent_ListTopIndexChanged,PreviousTopIndex)
VERIFY_CLASS_OFFSET_NODIE(U,UIEvent_ListTopIndexChanged,CurrentTopIndex)
VERIFY_CLASS_SIZE_NODIE(UUIEvent_ListTopIndexChanged)
VERIFY_CLASS_SIZE_NODIE(UUIEvent_MetaObject)
VERIFY_CLASS_SIZE_NODIE(UUIEvent_OnChar)
...
VERIFY_CLASS_SIZE_NODIE(UUIEvent_OnGainFocus)
VERIFY_CLASS_SIZE_NODIE(UUIEvent_OnLeaveState)
VERIFY_CLASS_SIZE_NODIE(UUIEvent_OnLoseFocus)
VERIFY_CLASS_SIZE_NODIE(UUIEvent_OnRightClick)
...
VERIFY_CLASS_SIZE_NODIE(UUIEvent_Show)
