...
var hmserialize bool bIsPlaying, bReversePlayback, bPaused; // 20070723 dEAthcURe|HM
var hmserialize float PlayRate; // 20070723 dEAthcURe|HM
var hmserialize float Position; // 20070723 dEAthcURe|HM
...
// {{ 20070723 dEAthcURe|HM
event function OnHmRestore()
{
	`log("[MatineeActor::OnHmRestore] Position, bReversePlayback =" @ Position @ bReversePlayback);	
	...
	InterpAction.SetPosition(Position, false);
}
// }} 20070723 dEAthcURe|HM
