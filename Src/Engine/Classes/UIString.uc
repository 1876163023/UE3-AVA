...
/**
 * The default style that will be applied to the nodes contained by this UIString.
 * The combo style's text and image styles are always set by whichever object owns this UIString.
 */
var deprecated private{private}	UIStyle_Combo		DefaultStringStyle;

/** Determines what happens when the text doesn't fit into the bounding region. */
var transient			ETextClipMode				StringClipMode;

/** Determines how the nodes of this string are ordered when the string is being clipped */
var	transient			EUIAlignment				StringClipAlignment;
