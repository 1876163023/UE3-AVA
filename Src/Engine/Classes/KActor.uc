...
cpptext
{
	...
	virtual void hmSerialize(FArchive& Ar); // 20061130 dEAthcURe|HM
	#endif
...
var() hmserialize repnotify bool bWakeOnLevelStart;	// [!] 20070323 dEAthcURe|HM 'hmserialize'
...
var hmserialize native const RigidBodyState RBState;	// [!] 20070323 dEAthcURe|HM 'hmserialize'
var	native const float			AngErrorAccumulator;
/** replicated components of DrawScale3D */
var hmserialize repnotify float DrawScaleX, DrawScaleY, DrawScaleZ;	// [!] 20070323 dEAthcURe|HM 'hmserialize'
...
// {{ 20070111 dEAthcURe|HM
event HmReinit()
{
	super.HmReinit();
	bWakeOnLevelStart=true;
	`log("[dEAthcURe] KActor::HmReinit bWakeOnLevelStart enabled");
}
// }} 20070111 dEAthcURe|HM
