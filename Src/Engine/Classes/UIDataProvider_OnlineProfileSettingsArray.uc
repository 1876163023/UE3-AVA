...
cpptext
{
	 ...
	 */
	UBOOL BindSettings(UOnlineProfileSettings* NewProfile,INT NewProfileSettingsId);
...
// IUIListElementProvider interface
	 ...
	 */
	virtual TScriptInterface<IUIListElementCellProvider> GetElementCellSchemaProvider(FName DataTag);
