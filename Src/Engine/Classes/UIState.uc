...
native function bool DeactivateStateNative( UIScreenObject Target, int PlayerIndex );
native function OnDeactivateNative( UIScreenObject Target, int PlayerIndex, bool bPoppedState );
