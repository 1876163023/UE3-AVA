...
/** Decal material. */
var(Decal) MaterialInstance	DecalMaterial;
 ...
 */
var DecalLifetimeData LifetimeData;
...
var native private noimport duplicatetransient const array<pointer> StaticReceivers{class FStaticReceiverData};
