 ...
 */
class UITabPage extends UIScrollFrame
	native(inherit)
...
DefaultProperties
{
	...
	ButtonCaption=(RequiredFieldType=DATATYPE_Property)
	ButtonToolTip=(RequiredFieldType=DATATYPE_Property)
	PageDescription=(RequiredFieldType=DATATYPE_Property)
}
