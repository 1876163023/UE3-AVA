/**
 * This event is activated when the value of a UISlider changes.
 *
 * Copyright © 1998-2007 Epic Games, Inc. All Rights Reserved.
 *
 * @note: native because C++ code activates this event
 */
class UIEvent_SliderValueChanged extends UIEvent_ValueChanged
	native(inherit);
...
{
	return TargetObject == None || UISlider(TargetObject) != None;
}
...
DefaultProperties
{
	...
	VariableLinks.Add((ExpectedType=class'SeqVar_Float',LinkDesc="Value",bWriteable=false))
}
