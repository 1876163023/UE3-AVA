...
var hmserialize databinding float	Score;	// [!] 20070323 dEAthcURe|HM 'hmserialize'	// Player's current score.
var hmserialize databinding float	Deaths;	// [!] 20070323 dEAthcURe|HM 'hmserialize'	// Number of player's deaths.
var hmserialize byte				Ping;	// [!] 20070323 dEAthcURe|HM 'hmserialize'
var repnotify				Actor	PlayerLocationHint;
var hmserialize databinding int		NumLives;	// [!] 20070323 dEAthcURe|HM 'hmserialize'

var hmserialize databinding repnotify string	PlayerName;		// [!] 20070323 dEAthcURe|HM 'hmserialize'	// Player name, or blank if none.
var hmserialize string	OldName, PreviousName;	// [!] 20070323 dEAthcURe|HM 'hmserialize'	
var hmserialize int		PlayerID;	// [!] 20070323 dEAthcURe|HM 'hmserialize'	 // Unique id number.
var repnotify TeamInfo	Team;			// Player Team
var hmserialize int		TeamID;	// [!] 20070323 dEAthcURe|HM 'hmserialize'	 // Player position in team.

var hmserialize databinding bool	bAdmin;	// [!] 20070323 dEAthcURe|HM 'hmserialize'	// Player logged in as Administrator
var hmserialize databinding bool	bIsFemale;	// [!] 20070323 dEAthcURe|HM 'hmserialize'
var hmserialize databinding bool	bIsSpectator;	// [!] 20070323 dEAthcURe|HM 'hmserialize'
var hmserialize repnotify databinding bool	bOnlySpectator;	// [!] 20070323 dEAthcURe|HM 'hmserialize'
var hmserialize databinding bool	bWaitingPlayer;	// [!] 20070323 dEAthcURe|HM 'hmserialize'
var hmserialize databinding bool	bReadyToPlay;	// [!] 20070323 dEAthcURe|HM 'hmserialize'
var databinding repnotify	bool	bOutOfLives;
var hmserialize databinding bool	bBot;	// [!] 20070323 dEAthcURe|HM 'hmserialize'
var hmserialize databinding bool	bHasFlag;	// [!] 20070323 dEAthcURe|HM 'hmserialize'
var	hmserialize databinding bool	bHasBeenWelcomed;	// client side flag - whether this player has been welcomed or not

/** Means this PRI came from the GameInfo's InactivePRIArray */
var hmserialize repnotify bool bIsInactive;	// [!] 20070323 dEAthcURe|HM 'hmserialize'

/** This determines whether the user has turned on or off their Controller Vibration **/
var hmserialize bool	bControllerVibrationAllowed;	// [!] 20070323 dEAthcURe|HM 'hmserialize'

var hmserialize byte	PacketLoss;	// [!] 20070323 dEAthcURe|HM 'hmserialize'

// Time elapsed.
var hmserialize int	StartTime;	// [!] 20070323 dEAthcURe|HM 'hmserialize'

var hmserialize localized String	StringDead;			// [!] 20070323 dEAthcURe|HM 'hmserialize'
var hmserialize localized String    StringSpectating;	// [!] 20070323 dEAthcURe|HM 'hmserialize'
var hmserialize localized String	StringUnknown;		// [!] 20070323 dEAthcURe|HM 'hmserialize'

var hmserialize databinding int	GoalsScored;	// [!] 20070323 dEAthcURe|HM 'hmserialize'	// not replicated - used on server side only
var hmserialize databinding int	Kills;	// [!] 20070323 dEAthcURe|HM 'hmserialize'	// not replicated

var class<GameMessage>	GameMessageClass;

var hmserialize float	ExactPing;	// [!] 20070323 dEAthcURe|HM 'hmserialize'	

var hmserialize string	SavedNetworkAddress;	// [!] 20070323 dEAthcURe|HM 'hmserialize'	/** Used to match up InactivePRI with rejoining playercontroller. */
 ...
 */
var hmserialize repnotify UniqueNetId UniqueId;	// [!] 20070323 dEAthcURe|HM 'hmserialize'
...
function bool UpdatePlayerLocation()
{
	...
	else
	{
		...
		{
		if( V.LocationName == "" && V.LocationNameIndex < 0 )
			continue;
		...
		if ( Best != None )
			...
			PlayerLocationHint = P.WorldInfo;
	}

	if ( PrvHint == PlayerLocationHint )
		return false;
	else
		return true;
}
