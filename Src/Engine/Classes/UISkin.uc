...
cpptext
{
	 ...
	 *
	 * @param	StyleToSearchFor			where this skin has the style or not
	 ...
	 * @param	out_DerivedStyles	[out] An array that will be filled with pointers to the derived styles
