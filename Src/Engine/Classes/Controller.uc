...
var		byte TeamIndexFromOption; // 20061221 dEAthcURe|HM
var 	Pawn							Pawn;
...
cpptext
{
	...
	AActor* FindPath(FVector point, AActor* goal, UBOOL bWeightDetours, FLOAT MaxPathLength, UBOOL bReturnPartial );
...
replication
{
	if (bNetDirty && Role==ROLE_Authority)
		PlayerReplicationInfo, Pawn; // 20061221 dEAthcURe|HM TeamIndexFromOption Ãß°¡
}
...
native function RouteCache_RemoveIndex( int Index, int Count=1 );
...
simulated event byte GetTeamNum()
{
	...
	{
		// 255 == no team
		return TeamIndexFromOption; // 20061221 dEAthcURe|HM original return 255;
	}
...
defaultproperties
{
	TeamIndexFromOption = 255; // 20061221 dEAthcURe|HM
