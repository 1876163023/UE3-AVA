...
/** The tesselation amount to use for each beam												*/
var											int							TessellationFactor;
...
//*************************************************************************************************
var											rawdistributionvector		Source;
var											rawdistributionfloat		SourceStrength;
var											name						SourceName;
var											bool						bSourceDirect;
/***
var	deprecated export noclear				distributionvector			Source;
var	deprecated export noclear				distributionfloat			SourceStrength;
var	deprecated export noclear				name						SourceName;
...
//*************************************************************************************************
var											rawdistributionvector		Target;
var											float						LockRadius;
var											bool						bTargetDirect;
var											rawdistributionfloat		TargetStrength;
var											name						TargetName;
/***
var	deprecated	export noclear				distributionvector			Target;
var	deprecated								float						LockRadius;
var	deprecated								bool						bTargetDirect;
var	deprecated	export noclear				distributionfloat			TargetStrength;
...
var											array<BeamTargetData>		MultipleTargets;
/***
...
var											bool						bNoise;
var											int							Frequency;
var											rawdistributionvector		NoiseRange;
var											bool						bMoving;
var											rawdistributionvector		NoiseSpeed;
var											bool						bSmooth;
var											bool						bNoiseLock;
var											float						NoiseLockTime;
var											float						NoiseTension;
/***
var	deprecated								bool						bNoise;
var deprecated								int							Frequency;
var deprecated								distributionvector			NoiseRange;
var deprecated								bool						bMoving;
var deprecated								distributionvector			NoiseSpeed;
...
cpptext
{
	...
	virtual void	GetDataPointers(FParticleEmitterInstance* Owner, const BYTE* ParticleBase, 
			...
			FVector*& NextNoisePoints, FLOAT*& TaperValues);
