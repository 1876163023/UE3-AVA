...
cpptext
{
	 ...
	 */
	UBOOL ReferencesObject(const UObject* InObject) const;
 ...
 */
native noexport final function FindSeqObjectsByClass( class<SequenceObject> DesiredClass, bool bRecursive, out array<SequenceObject> OutputObjects );
