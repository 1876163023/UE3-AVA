...
var protected{private}	deprecated	UITexture				SliderBar;
var protected{private}	deprecated	UITexture				Marker;
var protected{private}	deprecated	TextureCoordinates		BackgroundCoordinates;
var protected{private}	deprecated	TextureCoordinates		BarCoordinates;
var protected{private}	deprecated	TextureCoordinates		MarkerCoordinates;
var protected{private}	deprecated	UIStyleReference		BarStyle;
var protected{private}	deprecated	UIStyleReference		MarkerStyle;
...
/** the minimum and maximum values that this slider can contain */
var			deprecated	private{private}	float					MinValue, MaxValue;

/** the current value of the slider */
var			deprecated	private{private}	float					CurrentValue;

/**
 * Controls how much is added to CurrentValue when using nav keys to modify the value of the slider.
 * If NudgeValue is zero, pressing left/right will nudge the slider by 1% of the slider's range.
 */
var			deprecated	private{private}	float					NudgeValue;

/** If false, treats all slider values as ints */
var			deprecated	private{private}	bool					bIntValuesOnly;
 ...
 */
var(Slider)									UIScreenValue			BarSize;

/** @fixme - temp....the size of the region to use for rendering the marker */
var(Slider)									UIScreenValue			MarkerHeight, MarkerWidth;
...
DefaultProperties
{
	...
	BarSize=(Value=32,ScaleType=EVALPOS_PixelViewport)
	MarkerWidth=(Value=16,ScaleType=EVALPOS_PixelViewport,Orientation=UIORIENT_Horizontal)
	MarkerHeight=(Value=16,ScaleType=EVALPOS_PixelViewport,Orientation=UIORIENT_Vertical)

	PrimaryStyle=(DefaultStyleTag="DefaultSliderStyle",RequiredStyleClass=class'Engine.UIStyle_Image')
	BarStyle=(DefaultStyleTag="DefaultSliderBarStyle",RequiredStyleClass=class'UIStyle_Image')
	MarkerStyle=(DefaultStyleTag="DefaultSliderMarkerStyle",RequiredStyleClass=class'UIStyle_Image')
