 ...
 */
struct native transient UIAxisEmulationData
{
	/**
 ...
 */
final function bool OpenScene( UIScene Scene, optional LocalPlayer SceneOwner, optional out UIScene OpenedScene, optional byte Priority = 1 /* EScenePrior_UIScene_Normal */)
{
	return SceneClient.OpenScene(Scene,SceneOwner,OpenedScene,Priority);
}
