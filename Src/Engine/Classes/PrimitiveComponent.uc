...
var const PrimitiveComponent OcclusionGroup;
...
struct native SmartCullDistance
{
	var() editinline float Value[8];	
};
 ...
 */
var(Rendering) SmartCullDistance CullDistanceEx;
...
// add cascaded shadow ; 2007. 11. 12 changmin
var(AvaLighting) bool bCastSunShadow;

var(Rendering) int SeeThroughGroup;
...
/** Enum indicating whay type of object this should be considered for rigid body collision. */
...
var(Rendering) bool bFadingOut;
var(Rendering) float FadeStart, FadeEnd;
...
native final function SetOcclusionGroup(PrimitiveComponent NewOcclusionGroup);
native final function SetSeeThroughGroupIndex(int NewSeeThroughGroupIndex);
