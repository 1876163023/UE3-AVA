...
var() int ReplicatedMaterialIndex;
var repnotify MaterialInstance ReplicatedMaterial;
var repnotify bool			   ReplicatedNotifyRigidBodyCollision;
...
{
	if (bNetDirty)
		ReplicatedMesh, ReplicatedMaterial, ReplicatedNotifyRigidBodyCollision;
}
...
simulated event UpdateNotifyRigidBodyCollision();
...
simulated event ReplicatedEvent(name VarName)
{
	...
	{
		StaticMeshComponent.SetMaterial( ReplicatedMaterialIndex, ReplicatedMaterial );
	}
	else if (VarName == 'ReplicatedNotifyRigidBodyCollision')
	{
		StaticMeshComponent.SetNotifyRigidBodyCollision( ReplicatedNotifyRigidBodyCollision );
		UpdateNotifyRigidBodyCollision();
	}
	else
	{
...
{	
	...
	if (ReplicatedMaterialIndex == Action.MaterialIndex)
	{
