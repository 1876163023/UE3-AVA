...
function SetInventoryManager( InventoryManager Manager )
{
	InvManager = Manager;
	ClientSetInventoryManager( Manager );
}

reliable client function ClientSetInventoryManager( InventoryManager Manager )
{
	InvManager = Manager;
}
