...
cpptext
{
	...
	class UInterpGroupInst* FindGroupInst(AActor* Actor,UUIObject* Object);
...
/** Time position to always start at if bForceReversePos is set to TRUE. */
var()	float					ForceReversePosition;
...
//!< 역방향 재생을 위한 플래그.(2007/02/13 고광록)
var()	bool					bForceReversePos;


var()	float					SkipPosition;
...
var() bool bHostMigration; // 20070723 dEAthcURe|HM
var int hmId; // 20070723 dEAthcURe|HM
var() float ReplicatingDiffPosition; // 20070723 dEAthcURe|HM
var float prevPosition; // 20070723 dEAthcURe|HM
...
defaultproperties
{
	...
	InputLinks(5)=(LinkDesc="Set Position")	
