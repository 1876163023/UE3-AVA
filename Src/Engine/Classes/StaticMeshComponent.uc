...
var const bool bIsOwnerAStaticMeshActor;
...
var(AVA_Radiosity) const bool bSelfShadowing;
var(AVA_Radiosity) const bool bBlockLight;
//>@ ava
...
var private native transient const int ExportId;
var private native transient const int FirstExportedVertexNumber;
var const int FirstLeaf;
var const int LeafCount;
//>>@ ava
...
defaultproperties
{
	...
	MinSubDivisions=2	
	MaxSubDivisions=8
	bUseSubDivisions=FALSE
	
	bSelfShadowing=FALSE
	bBlockLight=TRUE
