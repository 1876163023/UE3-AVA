 ...
 */
var private transient const array<StaticMeshComponent>				SMComponents;
//var private transient const array<MaterialInstance>					SMMaterialInterfaces;
...
/**
 *	INTERNAL. Used to accumulate the number of seconds between LOD checks
 */
var		float									AccumLODDistanceCheckTime;
