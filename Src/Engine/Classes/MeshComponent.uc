 ...
 */
native function MaterialInstance GetMaterial(int ElementIndex);
 ...
 * @return the material used by the indexed element of this mesh.
 */
native function SetMaterial(int ElementIndex,MaterialInstance Material);
 ...
 */
function MaterialInstanceConstant CreateMaterialInstance(int ElementIndex)
{
