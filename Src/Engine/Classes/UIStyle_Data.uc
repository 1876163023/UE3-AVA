...
/** Fading, Scaling 을 위한 효과 추가 */
var					byte					FadeType;
var					CurveEdPresetCurve		FadePresetCurve;
var					float					FadeDuration;
var					CurveEdPresetCurve		ScalePresetCurve[EUIOrientation.UIORIENT_MAX];
var					float					ScaleDuration;
var					float					ScaleAxis[EUIOrientation.UIORIENT_MAX];
...
cpptext
{
	 ...
	 *
	 * @param	AssociatedState	the menu state that this style data has been created for.
	 */
