...
public:
	...
	virtual void SetDepthBounds(FCommandContextRHI* Context,const FSceneView* View) const
	{
		...
		RHISetDepthBoundsTest(Context, TRUE, ClipSpaceNearPos, ClipSpaceFarPos);
	}
	...
	*/
	...
	{
		return GetModProjPixelShaderRef <LightPolicyType> (ShadowProjectionTechnique);
	}
	...
	*/
	...
	{
		return GetBranchingPCFModProjPixelShaderRef <LightPolicyType> (ShadowProjectionTechnique);
	}
