...
IMPLEMENT_SHADER_TYPE(,FMotionBlurVertexShader,TEXT("MotionBlurShader"),TEXT("MainVertexShader"),SF_Vertex,0,0);
...
IMPLEMENT_SHADER_TYPE(,FMotionBlurPixelShader,TEXT("MotionBlurShader"),TEXT("MainPixelShader"),SF_Pixel,VER_EPIC_MERGE_APR_6,0);
IMPLEMENT_SHADER_TYPE(,FMotionBlurPixelShaderDynamicVelocitiesOnly,TEXT("MotionBlurShader"),TEXT("MainPixelShaderDynamicVelocitiesOnly"),SF_Pixel,VER_EPIC_MERGE_APR_6,0);
