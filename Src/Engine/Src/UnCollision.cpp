...
static const FLOAT ParallelRegion = 0.0001f;
...
inline UBOOL TestSeparatingAxis(
								const FVector& V0,
								const FVector& V1,
								const FVector& V2,
						 ...
						 )
{
	...
	if(!TestSeparatingAxis(V0,V1,V2,BoxX,BoxY,Start,End,BoxX,BoxY,BoxZ,BoxExtent,MinIntersectTime,MaxIntersectTime,HitNormal,ExitDir))
		return FALSE;

	if(!TestSeparatingAxis(V0,V1,V2,BoxY,BoxZ,Start,End,BoxX,BoxY,BoxZ,BoxExtent,MinIntersectTime,MaxIntersectTime,HitNormal,ExitDir))
		return FALSE;

	if(!TestSeparatingAxis(V0,V1,V2,BoxZ,BoxX,Start,End,BoxX,BoxY,BoxZ,BoxExtent,MinIntersectTime,MaxIntersectTime,HitNormal,ExitDir))
		return FALSE;

	// Triangle normal.

	if(!TestSeparatingAxis(V0,V1,V2,EdgeDir1,EdgeDir0,Start,End,BoxX,BoxY,BoxZ,BoxExtent,MinIntersectTime,MaxIntersectTime,HitNormal,ExitDir))
		return FALSE;

	// Box X edge x triangle edges.

	if(!TestSeparatingAxis(V0,V1,V2,EdgeDir0,BoxX,Start,End,BoxX,BoxY,BoxZ,BoxExtent,MinIntersectTime,MaxIntersectTime,HitNormal,ExitDir))
		return FALSE;

	if(!TestSeparatingAxis(V0,V1,V2,EdgeDir1,BoxX,Start,End,BoxX,BoxY,BoxZ,BoxExtent,MinIntersectTime,MaxIntersectTime,HitNormal,ExitDir))
		return FALSE;

	if(!TestSeparatingAxis(V0,V1,V2,EdgeDir2,BoxX,Start,End,BoxX,BoxY,BoxZ,BoxExtent,MinIntersectTime,MaxIntersectTime,HitNormal,ExitDir))
		return FALSE;

	// Box Y edge x triangle edges.

	if(!TestSeparatingAxis(V0,V1,V2,EdgeDir0,BoxY,Start,End,BoxX,BoxY,BoxZ,BoxExtent,MinIntersectTime,MaxIntersectTime,HitNormal,ExitDir))
		return FALSE;

	if(!TestSeparatingAxis(V0,V1,V2,EdgeDir1,BoxY,Start,End,BoxX,BoxY,BoxZ,BoxExtent,MinIntersectTime,MaxIntersectTime,HitNormal,ExitDir))
		return FALSE;

	if(!TestSeparatingAxis(V0,V1,V2,EdgeDir2,BoxY,Start,End,BoxX,BoxY,BoxZ,BoxExtent,MinIntersectTime,MaxIntersectTime,HitNormal,ExitDir))
		return FALSE;

	// Box Z edge x triangle edges.

	if(!TestSeparatingAxis(V0,V1,V2,EdgeDir0,BoxZ,Start,End,BoxX,BoxY,BoxZ,BoxExtent,MinIntersectTime,MaxIntersectTime,HitNormal,ExitDir))
		return FALSE;

	if(!TestSeparatingAxis(V0,V1,V2,EdgeDir1,BoxZ,Start,End,BoxX,BoxY,BoxZ,BoxExtent,MinIntersectTime,MaxIntersectTime,HitNormal,ExitDir))
		return FALSE;

	if(!TestSeparatingAxis(V0,V1,V2,EdgeDir2,BoxZ,Start,End,BoxX,BoxY,BoxZ,BoxExtent,MinIntersectTime,MaxIntersectTime,HitNormal,ExitDir))
		return FALSE;
