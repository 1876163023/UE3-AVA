 ...
 */
FString UShadowMapTexture2D::GetDetailedDescription( INT Index )
{
...
UShadowMap2D::UShadowMap2D(const FShadowMapData2D& RawData,const FGuid& InLightGuid,UMaterialInstance* Material,const FBoxSphereBounds& Bounds):
