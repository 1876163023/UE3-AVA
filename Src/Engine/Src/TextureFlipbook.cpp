 ...
 */
void UTextureFlipBook::PostEditChange(UProperty* PropertyThatChanged)
{
	//@todo. Remove this if it doesn't extend the base functionality
 ...
 */
FString UTextureFlipBook::GetDetailedDescription( INT Index )
{
...
void UTextureFlipBook::GetTextureOffset_RenderThread(FLinearColor& UVOffset)
{
