 ...
 */
static inline UBOOL IsValidDecalMaterial(UMaterialInstance* MaterialInstance)
{
	return ( MaterialInstance && MaterialInstance->IsA( UDecalMaterial::StaticClass() ) );
}
