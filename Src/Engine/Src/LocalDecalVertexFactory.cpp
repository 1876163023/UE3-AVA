...
IMPLEMENT_VERTEX_FACTORY_TYPE(FLocalDecalVertexFactory,FLocalDecalVertexFactoryShaderParameters,"LocalDecalVertexFactory",TRUE,TRUE,VER_DECAL_CPU_SKELETAL_MESHES);
