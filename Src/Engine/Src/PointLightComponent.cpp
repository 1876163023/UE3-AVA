...
//<@ ava specific ; 2007. 10. 19 changmin ; add bump only view mode
IMPLEMENT_BUMPLIGHT_SHADER_TYPE(FPointLightPolicy, FPointLightPolicy, TEXT("PointLightVertexShader"),TEXT("PointLightBumpPixelShader"),VER_FP_BLENDING_FALLBACK,VER_AVA_ADD_BUMPONLY_VIEWMODE);
//>@ ava
