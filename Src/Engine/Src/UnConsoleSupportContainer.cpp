 ...
 */
INT FConsoleSupportContainer::GetNumConsoleSupports()
{
 ...
 */
FConsoleSupport* FConsoleSupportContainer::GetConsoleSupport(INT Index)
{
	// validate index
 ...
 * @return	Requested Console support object
 */
FConsoleSupport* FConsoleSupportContainer::GetConsoleSupport(TCHAR* ConsoleName)
{
