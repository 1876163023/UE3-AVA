...
* Constructor
*/
FFullScreenMovieFallback::FFullScreenMovieFallback()
{
...
*/
FFullScreenMovieSupport* FFullScreenMovieFallback::StaticInitialize()
{
	static FFullScreenMovieFallback* StaticInstance = NULL;
	if( !StaticInstance )
	{
		StaticInstance = new FFullScreenMovieFallback();
	}
...
*/
UBOOL FFullScreenMovieFallback::IsTickable()
{
...
*/
void FFullScreenMovieFallback::GameThreadPlayMovie(EMovieMode InMovieMode, const TCHAR* MovieFilename, INT StartFrame)
{
