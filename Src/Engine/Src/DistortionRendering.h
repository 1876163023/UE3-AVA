...
/**
* Policy for drawing distortion mesh depths
*/
class FDistortMeshDepthPolicy : public FDistortMeshPolicy
{
};
...
public:
	...
	*/
	TDistortionMeshDrawingPolicy(const FVertexFactory* InVertexFactory,const FMaterialInstance* InMaterialInstance);
...
public:
	...
	*/
	...
	static UBOOL IsMaterialIgnored(const FMaterialInstance* Material);
};
...
public:
	...
	* @return TRUE if anything was drawn
	*/
	UBOOL DrawClosestDepths(FCommandContextRHI* Context,const class FViewInfo* ViewInfo,UINT DPGIndex);
