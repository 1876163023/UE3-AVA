...
static void AddForceFieldToCloth(NxCloth* Cloth, FForceApplicator* Applicator, FLOAT ClothForceScale)
{
	...
	NxVec3* ClothVelocities = (NxVec3 *)appMalloc(NumClothVertices * sizeof(NxVec3));
	NxVec3* NewClothVelocities = (NxVec3 *)appMalloc(NumClothVertices * sizeof(NxVec3));
	...
	appFree(ClothVelocities);
	appFree(NewClothVelocities);
}
...
void UPrimitiveComponent::execWakeRigidBody _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UPrimitiveComponent::execPutRigidBodyToSleep _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_NAME_OPTX(BoneName, NAME_None);
	P_FINISH;
...
void UPrimitiveComponent::execSetBlockRigidBody _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UPrimitiveComponent::execSetNotifyRigidBodyCollision _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UPrimitiveComponent::execSetPhysMaterialOverride _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UPrimitiveComponent::execSetRBDominanceGroup _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UPrimitiveComponent::execGetRootBodyInstance _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_FINISH;
...
void UPrimitiveComponent::execSetRBLinearVelocity _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(NewVel);
...
void UPrimitiveComponent::execSetRBAngularVelocity _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UPrimitiveComponent::execSetRBPosition _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(NewPos);
	P_GET_NAME_OPTX(BoneName, NAME_None);
	P_FINISH;
...
void UPrimitiveComponent::execSetRBRotation _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UPrimitiveComponent::execRigidBodyIsAwake _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_NAME_OPTX(BoneName, NAME_None);
	P_FINISH;
...
void UPrimitiveComponent::execAddImpulse _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UPrimitiveComponent::execAddRadialImpulse _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(Origin);
	P_GET_FLOAT(Radius);
...
void UPrimitiveComponent::execAddRadialForce _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(Origin);
	P_GET_FLOAT(Radius);
	P_GET_FLOAT(Strength);
...
void UPrimitiveComponent::execAddForce _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(Force);
	P_GET_VECTOR_OPTX(Position, FVector(0,0,0));
	P_GET_NAME_OPTX(BoneName, NAME_None);
...
void UPrimitiveComponent::execSetRBCollidesWithChannel _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_BYTE(Channel);
...
void UPrimitiveComponent::execSetRBChannel _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_BYTE(Channel);
	P_FINISH;
...
void USkeletalMeshComponent::execSetHasPhysicsAssetInstance _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void USkeletalMeshComponent::execUpdateClothParams _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_FINISH;
...
void USkeletalMeshComponent::execSetClothExternalForce _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void USkeletalMeshComponent::execSetAttachClothVertsToBaseBody _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void USkeletalMeshComponent::execSetClothFrozen _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
