...
void ADirectionalLight::DetermineAndSetEditorIcon()
{
	...
	case LAC_USER_SELECTED:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Directional_Stationary_UserSelected") );
		break;
	case LAC_DYNAMIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Directional_Stationary_Dynamics") );
		break;
	case LAC_STATIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Directional_Stationary_Statics") );
		break;
	case LAC_DYNAMIC_AND_STATIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Directional_Stationary_DynamicsAndStatics") );
		break;
	default:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Directional_Stationary_UserSelected") );
		break;
...
void ADirectionalLightToggleable::DetermineAndSetEditorIcon()
{
	...
	{
	case LAC_USER_SELECTED:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Directional_Toggleable_UserSelected") );
		break;
	case LAC_DYNAMIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Directional_Toggleable_Dynamics") );
		break;
	case LAC_STATIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Directional_Toggleable_Statics") );
		break;
	case LAC_DYNAMIC_AND_STATIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Directional_Toggleable_DynamicsAndStatics") );
		break;
	default:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Directional_Toggleable_UserSelected") );
		break;
...
void APointLight::DetermineAndSetEditorIcon()
{
	...
	{
	case LAC_USER_SELECTED:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Point_Stationary_UserSelected") );
		break;
	case LAC_DYNAMIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Point_Toggleable_Dynamics") );
		break;
	case LAC_STATIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Point_Stationary_Statics") );
		break;
	case LAC_DYNAMIC_AND_STATIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Point_Stationary_DynamicsAndStatics") );
		break;
	default:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Point_Stationary_UserSelected") );
		break;
...
void APointLightMovable::DetermineAndSetEditorIcon()
{
	...
	{
	case LAC_USER_SELECTED:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Point_Moveable_UserSelected") );
		break;
	case LAC_DYNAMIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Point_Moveable_Dynamics") );
		break;
	case LAC_STATIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Point_Moveable_Statics") );
		break;
	case LAC_DYNAMIC_AND_STATIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Point_Moveable_DynamicsAndStatics") );
		break;
	default:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Point_Moveable_UserSelected") );
		break;
...
void APointLightToggleable::DetermineAndSetEditorIcon()
{
	...
	{
	case LAC_USER_SELECTED:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Point_Toggleable_UserSelected") );
		break;
	case LAC_DYNAMIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Point_Toggleable_Dynamics") );
		break;
	case LAC_STATIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Point_Toggleable_Statics") );
		break;
	case LAC_DYNAMIC_AND_STATIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Point_Toggleable_DynamicsAndStatics") );
		break;
	default:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Point_Toggleable_UserSelected") );
		break;
...
void ASpotLight::DetermineAndSetEditorIcon()
{
	...
	{
	case LAC_USER_SELECTED:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Spot_Stationary_UserSelected") );
		break;
	case LAC_DYNAMIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Spot_Stationary_Dynamics") );
		break;
	case LAC_STATIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Spot_Stationary_Statics") );
		break;
	case LAC_DYNAMIC_AND_STATIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Spot_Stationary_DynamicsAndStatics") );
		break;
	default:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Spot_Stationary_UserSelected") );
		break;
...
void ASpotLightMovable::DetermineAndSetEditorIcon()
{
	...
	{
	case LAC_USER_SELECTED:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Spot_Moveable_UserSelected") );
		break;
	case LAC_DYNAMIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Spot_Moveable_Dynamics") );
		break;
	case LAC_STATIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Spot_Moveable_Statics") );
		break;
	case LAC_DYNAMIC_AND_STATIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Spot_Moveable_DynamicsAndStatics") );
		break;
	default:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Spot_Moveable_UserSelected") );
		break;
...
void ASpotLightToggleable::DetermineAndSetEditorIcon()
{
	...
	{
	case LAC_USER_SELECTED:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Spot_Toggleable_UserSelected") );
		break;
	case LAC_DYNAMIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Spot_Toggleable_Dynamics") );
		break;
	case LAC_STATIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Spot_Toggleable_Statics") );
		break;
	case LAC_DYNAMIC_AND_STATIC_AFFECTING:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Spot_Toggleable_DynamicsAndStatics") );
		break;
	default:
		SetIcon( SpriteComp, TEXT("EngineResources.LightIcons.Light_Spot_Toggleable_UserSelected") );
		break;
 ...
 */
void ALightVolume::PostEditChange(UProperty* PropertyThatChanged)
{
	// Update the volumes for all lights.
...
void AStaticLightCollectionActor::Serialize( FArchive& Ar )
{
	...
	if (!HasAnyFlags(RF_ClassDefaultObject) && Ar.GetLinker() != NULL )
	{
		...
		else if ( Ar.IsSaving() )
		{
			...
			check(GIsCooking || GIsCookingForAva);
