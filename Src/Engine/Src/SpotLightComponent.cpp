...
IMPLEMENT_BUMPLIGHT_SHADER_TYPE(FSpotLightPolicy, FSpotLightPolicy, TEXT("SpotLightVertexShader"),TEXT("SpotLightBumpPixelShader"),VER_FP_BLENDING_FALLBACK,VER_AVA_ADD_BUMPONLY_VIEWMODE);
//>@ ava
