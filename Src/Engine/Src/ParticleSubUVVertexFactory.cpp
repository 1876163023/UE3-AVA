...
IMPLEMENT_VERTEX_FACTORY_TYPE(FParticleSubUVVertexFactory,FParticleVertexFactoryShaderParameters,"ParticleSubUVVertexFactory",TRUE,FALSE, VER_SIMPLE_ELEMENT_SHADER_RECOMPILE);
