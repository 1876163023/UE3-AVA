...
public:
		...
		,	DOFParameters(Initializer.ParameterMap)
	{
		...
		BloomThresholdParameter.Bind(Initializer.ParameterMap,TEXT("BloomThreshold"),TRUE);		
	}
	...
	virtual void Serialize(FArchive& Ar)
	{
		...
		Ar << DOFParameters << SceneTextureParameters << BloomScaleParameter << BloomThresholdParameter;
	}

	FDOFShaderParameters DOFParameters;
	FSceneTextureShaderParameters SceneTextureParameters;
	FShaderParameter BloomScaleParameter;
	FShaderParameter BloomThresholdParameter;
};
