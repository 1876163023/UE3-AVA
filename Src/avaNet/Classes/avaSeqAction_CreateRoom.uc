class avaSeqAction_CreateRoom extends avaSeqAction;
...
event Activated()
{
	...
	class'avaNet.avaNetRequest'.static.GetAvaNetRequest().CreateRoom(RoomName, RoomPassword, RoomSetting);
}


defaultproperties
{
	ObjName="(Lobby) Create Room"

    VariableLinks.Empty
	VariableLinks.Add((ExpectedType=class'SeqVar_String',LinkDesc="Room Name",PropertyName=RoomName))
