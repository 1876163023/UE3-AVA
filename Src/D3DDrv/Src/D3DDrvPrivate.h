...
enum ED3DRHIStats
{
	...
	STAT_RHITriangles,
	STAT_RHILines,
	STAT_RHICreateVertexBuffer,
	STAT_RHICreateIndexBuffer,
	STAT_RHICreateTexture,
	STAT_RHILockVertexBuffer,
	STAT_RHILockIndexBuffer,

	STAT_RHICreateVertexBufferTime,
	STAT_RHICreateIndexBufferTime,	
};
