...
FSamplerStateRHIRef RHICreateSamplerState(const FSamplerStateInitializerRHI& Initializer)
{
	...
	case SF_AnisotropicLinear:
		SamplerState->MinFilter = GSystemSettings->Anisotropy > 1 ? D3DTEXF_ANISOTROPIC : D3DTEXF_LINEAR;
		SamplerState->MagFilter	= D3DTEXF_LINEAR;
		SamplerState->MipFilter	= GSystemSettings->Anisotropy > 0 ? D3DTEXF_LINEAR : D3DTEXF_POINT;
		break;		
	case SF_Linear:
