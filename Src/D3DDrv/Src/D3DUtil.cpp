...
DECLARE_DWORD_COUNTER_STAT(TEXT("VB alloc"),STAT_RHICreateVertexBuffer,STATGROUP_RHI);
DECLARE_DWORD_COUNTER_STAT(TEXT("IB alloc"),STAT_RHICreateIndexBuffer,STATGROUP_RHI);
DECLARE_DWORD_COUNTER_STAT(TEXT("Tex alloc"),STAT_RHICreateTexture,STATGROUP_RHI);
DECLARE_DWORD_COUNTER_STAT(TEXT("VB lock"),STAT_RHILockVertexBuffer,STATGROUP_RHI);
DECLARE_DWORD_COUNTER_STAT(TEXT("IB lock"),STAT_RHILockIndexBuffer,STATGROUP_RHI);

DECLARE_CYCLE_STAT(TEXT("VB alloc time"),STAT_RHICreateVertexBufferTime,STATGROUP_RHI);
DECLARE_CYCLE_STAT(TEXT("IB alloc time"),STAT_RHICreateIndexBufferTime,STATGROUP_RHI);
