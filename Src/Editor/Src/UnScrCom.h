...
public:
	...
	*/
	...
	UBOOL			CompileFieldExpr( UStruct* Scope, FPropertyBase& RequiredType, FToken Token, FToken& ResultToken, UBOOL IsSelf, UBOOL IsConcrete );
	...
	*/
	void			EmitPlaceholderForJumpAddress( FNestInfo* Nest, EFixupType Type, FName Name, INT Location=INDEX_NONE, WORD Value=0 );
