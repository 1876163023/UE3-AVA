...
void UBrushBuilder::BeginBrush(UBOOL InMergeCoplanars, FName InGroup)
{
	Group = InGroup;
...
UBOOL UBrushBuilder::EndBrush()
{
	...
	// Ensure the buidler brush is unhidden.
	...
	if( Brush )
	{
		...
		GEditor->SetPivot( BuilderBrush->Location, 0, 0, 1 );
