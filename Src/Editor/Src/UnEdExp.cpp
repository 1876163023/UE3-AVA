...
{
	Ar.Logf( TEXT("%sBegin Object Class=%s Name=%s ObjName=%s Archetype=%s'%s'\r\n"),appSpc(TextIndent), *Object->GetClass()->GetName(), *Object->GetName(), *Object->GetName(), *Object->GetArchetype()->GetClass()->GetName(), *Object->GetArchetype()->GetPathName() );
