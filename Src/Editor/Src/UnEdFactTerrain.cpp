...
***/
	...
	if (OutTerrain)
	{
		OutTerrain->PostEditChange(NULL);
	}
...
UObject* UTerrainLayerSetupFactory::FactoryCreateText(UClass* Class, UObject* InParent, FName Name, EObjectFlags Flags, UObject* Context, const TCHAR* Type, const TCHAR*& Buffer, const TCHAR* BufferEnd, FFeedbackContext* Warn)
{
	return NULL;
}
