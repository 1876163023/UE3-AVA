...
public:
	...
	// ApplyTool
	virtual void ApplyTool(ATerrain* Terrain,
		UBOOL DecoLayer,INT LayerIndex,INT MaterialIndex,
	...
	// Render
	virtual UBOOL Render(ATerrain* Terrain, const FVector HitLocation,FPrimitiveDrawInterface* PDI ) { return TRUE; }
...
public:
	...
	virtual void ApplyTool(ATerrain* Terrain,
		...
		UBOOL bMirrorX = FALSE, UBOOL bMirrorY = FALSE) {};
	virtual UBOOL Render(ATerrain* Terrain, const FVector HitLocation,FPrimitiveDrawInterface* PDI );
};
/*-----------------------------------------------------------------------------
