 ...
 */
struct FPCSoundCooker : public FConsoleSoundCooker
{
public:
	/**
	 * Constructor
	 ...
	 */
	virtual bool Cook( short* SrcBuffer, DWORD SrcBufferSize, void* WaveFormat, INT Quality, UBOOL bCompressedSample, BYTE* RawWaveData, DWORD RawWaveDataSize );
	...
	*/
	...
	bool CookMP3( short* SrcBuffer, DWORD SrcBufferSize, void* WaveFormat, INT Quality, BYTE* RawWaveData, DWORD RawWaveDataSize );
