...
/** CurveEdPresetCurve factor */
class UDSPPresetFactoryNew : public UFactory
{
	DECLARE_CLASS(UDSPPresetFactoryNew,UFactory,CLASS_CollapseCategories,Editor);
public:
...
/** CurveEdPresetCurve factor */
class UTrueTypeFontFactoryNew : public UFactory
{
	DECLARE_CLASS(UTrueTypeFontFactoryNew,UFactory,CLASS_CollapseCategories,Editor);
	FStringNoInit FontResource;
	INT Height;	
	UBOOL bAntialiased;
	UBOOL bPrecacheAlphabets;
public:
...
/** CurveEdPresetCurve factor */
class UReverbPropertyFactoryNew : public UFactory
{
	DECLARE_CLASS(UReverbPropertyFactoryNew,UFactory,CLASS_CollapseCategories,Editor);
public:
...
class UReverbPropertyFactory : public UFactory
{
	DECLARE_CLASS(UReverbPropertyFactory,UFactory,0,Editor);
	UReverbPropertyFactory();
	/**
	* Initializes property values for intrinsic classes.  It is called immediately after the class default object
	* is initialized against its archetype, but before any objects of this class are created.
	*/
...
/** CurveEdPresetCurve factor */
class UUIAnimationSeqFactoryNew : public UFactory
{
	DECLARE_CLASS(UUIAnimationSeqFactoryNew,UFactory,CLASS_CollapseCategories,Editor);
public:
