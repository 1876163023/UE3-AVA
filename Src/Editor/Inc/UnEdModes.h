...
public:
	...
	void DrawTool( FPrimitiveDrawInterface* PDI, class ATerrain* Terrain, FVector& Location, FLOAT InnerRadius, FLOAT OuterRadius, TArray<ATerrain*>& Terrains );
	void DrawToolCircle( FPrimitiveDrawInterface* PDI, class ATerrain* Terrain, FVector& Location, FLOAT Radius, TArray<ATerrain*>& Terrains, UBOOL bMirror = FALSE );
	void DrawToolCircleBallAndSticks( FPrimitiveDrawInterface* PDI, class ATerrain* Terrain, FVector& Location, FLOAT InnerRadius, FLOAT OuterRadius, TArray<ATerrain*>& Terrains, UBOOL bMirror = FALSE );
	void DrawToolGrid( FPrimitiveDrawInterface* PDI, class ATerrain* Terrain, FVector& Location, FLOAT InnerRadius, FLOAT OuterRadius, TArray<ATerrain*>& Terrains, UBOOL bMirror = FALSE );
	void DrawToolGridBallAndSticks( FPrimitiveDrawInterface* PDI, class ATerrain* Terrain, FVector& Location, FLOAT InnerRadius, FLOAT OuterRadius, TArray<ATerrain*>& Terrains, UBOOL bMirror = FALSE );
	virtual void Render(const FSceneView* View,FViewport* Viewport,FPrimitiveDrawInterface* PDI);
