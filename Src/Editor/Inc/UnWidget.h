...
public:
	 ...
	 */
	void Render_Axis( const FSceneView* View, FPrimitiveDrawInterface* PDI, EAxis InAxis, FMatrix& InMatrix, UMaterialInstance* InMaterial, FColor* InColor, FVector2D& OutAxisEnd, float InScale, UBOOL bDrawWidget );
