 ...
 */
WxDlgGenericComboEntry::WxDlgGenericComboEntry(UBOOL bDisableCancelButton)
{
	const bool bSuccess = wxXmlResource::Get()->LoadDialog( this, GApp->EditorFrame, TEXT("ID_GENERICCOMBOENTRY") );
	check( bSuccess );
