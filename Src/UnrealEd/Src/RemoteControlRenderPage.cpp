...
BEGIN_EVENT_TABLE(WxRemoteControlRenderPage, WxRemoteControlPage)
	...
	EVT_MENU( IDM_VIEWPORT_SHOW_FOLIAGE, WxRemoteControlRenderPage::OnShowFoliage )
	...
	EVT_MENU( IDM_VIEWPORT_SHOW_PORTALS, WxRemoteControlRenderPage::OnShowPortals )
	...
	EVT_MENU( IDM_VIEWPORT_SHOW_MISSINGCOLLISION, WxRemoteControlRenderPage::OnShowMissingCollision )
	...
	,	bShowBones(FALSE)
{
	...
	const UBOOL bDownArrowLargeLoadSuccessful = bitmap.Load(TEXT("DownArrowLarge"));
 ...
 */
void WxRemoteControlRenderPage::RefreshPage()
{
	// Get the current display info.
...
void WxRemoteControlRenderPage::OnShowFlags(wxCommandEvent &In)
{
	...
	menu->AppendCheckItem( IDM_VIEWPORT_SHOW_FOLIAGE, TEXT("Foliage") );
	...
	menu->AppendCheckItem( IDM_VIEWPORT_SHOW_MISSINGCOLLISION, TEXT("Missing Collision") );
	...
	menu->Check( IDM_VIEWPORT_SHOW_FOLIAGE, (ShowFlags&SHOW_Foliage)!= 0 );
	...
	menu->Check( IDM_VIEWPORT_SHOW_PORTALS, (ShowFlags & SHOW_Portals)!= 0 );
	...
	menu->Check( IDM_VIEWPORT_SHOW_MISSINGCOLLISION, (ShowFlags&SHOW_MissingCollisionModel) != 0 );
...
/**
    toggle show flag - foliage
*/
void WxRemoteControlRenderPage::OnShowFoliage(wxCommandEvent &In)
{
	GetGame()->ExecConsoleCommand(TEXT("show FOLIAGE"));
}
...
/**
    toggle show flag - portals
*/
void WxRemoteControlRenderPage::OnShowPortals (wxCommandEvent &In)
{
	GetGame()->ExecConsoleCommand(TEXT("show PORTALS"));
}
...
void WxRemoteControlRenderPage::OnShowMissingCollision(wxCommandEvent &In)
{
	GetGame()->ExecConsoleCommand(TEXT("show MISSINGCOLLISION"));
}
