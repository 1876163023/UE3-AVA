/*=============================================================================
	...
	Copyright 1997-2006 Epic Games, Inc. All Rights ReserveDesc.
=============================================================================*/

#include "UnrealEd.h"
#include "..\..\..\External\ConvexDecomposition\Include\ConvexDecomposition.h"
...
public:
	...
	virtual void ConvexDecompResult(ConvexResult &result)
	{
		...
		{
			const FLOAT* V = &result.mHullVertices[i*3];
			FVector HullVert( V[0], V[1], V[2] );
