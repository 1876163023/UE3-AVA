 ...
 */
void FFeedbackContextEditor::MapCheck_Add(MapCheckType InType, void* InActor, const TCHAR* InMessage, MapCheckAction InRecommendedAction, const TCHAR* InUDNPage)
{
	UObject* Object	= (UObject*)InActor;
	AActor* Actor	= Cast<AActor>( Object );
	GApp->DlgMapCheck->AddItem( InType, Actor, InMessage, InRecommendedAction, InUDNPage );
}
