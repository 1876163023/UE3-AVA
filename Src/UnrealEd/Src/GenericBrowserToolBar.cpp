	...
	: wxToolBar( InParent, InID, wxDefaultPosition, wxDefaultSize, wxTB_HORIZONTAL | wxTB_3DBUTTONS )
{
	...
	ViewCB->Append( *LocalizeUnrealEd("300Pct") );
	ViewCB->Append( *LocalizeUnrealEd("200Pct") );
	ViewCB->Append( *LocalizeUnrealEd("100Pct") );
	ViewCB->Append( *LocalizeUnrealEd("50Pct") );
	ViewCB->Append( *LocalizeUnrealEd("25Pct") );
	ViewCB->Append( *LocalizeUnrealEd("10Pct") );
