...
/* ==========================================================================================================
	WxCustomPropertyItem_ScreenPositionRange
========================================================================================================== */
// IMPLEMENT_DYNAMIC_CLASS( WxCustomPropertyItem_ScreenPositionRange, WxPropertyWindow_Item )
// 
// BEGIN_EVENT_TABLE( WxCustomPropertyItem_ScreenPositionRange, WxPropertyWindow_Item )
// 	EVT_PAINT( WxCustomPropertyItem_ScreenPositionRange::OnPaint)
// 	EVT_TEXT_ENTER( ID_PROPWINDOW_EDIT, WxCustomPropertyItem_ScreenPositionRange::OnInputTextEnter )
// 	EVT_TEXT( ID_PROPWINDOW_EDIT, WxCustomPropertyItem_ScreenPositionRange::OnInputTextChanged )
// 	EVT_COMBOBOX( ID_PROPWINDOW_COMBOBOX, WxCustomPropertyItem_ScreenPositionRange::OnInputComboBox )
// END_EVENT_TABLE()
// 
// void WxCustomPropertyItem_ScreenPositionRange::Create(	wxWindow* InParent,
...
// {
// 	WxPropertyWindow_Item::Create( InParent, InParentItem, InTopPropertyWindow, InProperty, InPropertyOffset, InArrayIdx, bInSupportsCustomControls );
// }
// 
// 
// void WxCustomPropertyItem_ScreenPositionRange::OnPaint( wxPaintEvent& Event )
// {
// 	Event.Skip();
// }
// 
// void WxCustomPropertyItem_ScreenPositionRange::OnInputTextChanged( wxCommandEvent& Event )
// {
// 	Event.Skip();
// // 	Refresh();
// }
// 
// void WxCustomPropertyItem_ScreenPositionRange::OnInputTextEnter( wxCommandEvent& Event )
// {
// 	Event.Skip();
...
// }
// 
// void WxCustomPropertyItem_ScreenPositionRange::OnInputComboBox( wxCommandEvent& Event )
// {
// 	Event.Skip();
// // 	InputProxy->SendToObjects( this );
// // 	Refresh();
...
// void WxCustomPropertyItem_ScreenPositionRange::CreateChildItems()
// {
// 	UStructProperty* StructProperty = Cast<UStructProperty>(Property,CLASS_IsAUStructProperty);
// 	checkSlow(StructProperty);
// 	checkSlow(StructProperty->GetName()==TEXT("UIImageAdjustmentData"));
// 
// 	// Copy IsSorted() flag from parent.  Default sorted to TRUE if no parent exists.
// 	SetSorted( ParentItem ? ParentItem->IsSorted() : TRUE );
// 
// 	if( Property->ArrayDim > 1 && ArrayIndex == INDEX_NONE )
// 	{
// 		// Expand array.
// 		SetSorted( FALSE );
...
//@todo: Didn't like the way this was turning out so nuked it for now, but it is a good example on how to create a custom property so I will probably refer to it later. - ASM 3/23/2006
#if 0
