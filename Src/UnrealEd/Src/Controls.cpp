...
#define IDPB_TEXTUREBROWSE 27015
#define IDEC_TEXTUREGROUP 27016
/*-----------------------------------------------------------------------------
	WxStatusBar.
-----------------------------------------------------------------------------*/
	...
	: wxPanel( parent, id )
{
	...
	if( InParentSizer )
	{
		InParentSizer->Add( FlexGridSizer, 1, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	}
	...
	BrowseButton = new WxBitmapButton( this, IDPB_BROWSE, BrowseB, wxDefaultPosition, wxSize(24, 24) );
	FlexGridSizer->Add( BrowseButton, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 5 );
...
BEGIN_EVENT_TABLE( WxPkgGrpNameTxtCtrl, WxPkgGrpNameCtrl )
	EVT_BUTTON( IDPB_TEXTUREBROWSE, WxPkgGrpNameTxtCtrl::OnBrowseTxtGroup )
END_EVENT_TABLE()
	...
	:	WxPkgGrpNameCtrl( InParent, InID, InParentSizer, TRUE )
{
	...
	// Checkbox
	IncludeRefsLabel = new wxStaticText( this, wxID_STATIC, *LocalizeUnrealEd("References"), wxDefaultPosition, wxDefaultSize, 0 );
	FlexGridSizer->Add( IncludeRefsLabel, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxALL|wxADJUST_MINSIZE, 5 );

	IncludeRefsCheck = new wxCheckBox( this, -1, TEXT(""), 
		wxDefaultPosition, wxDefaultSize, wxCHK_2STATE );
	FlexGridSizer->Add( IncludeRefsCheck, 0, wxALIGN_LEFT|wxGROW|wxALL, 5 );

	FlexGridSizer->Add( 5, 5, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5 );

	// Texture Package combo box
	//const FString LocalizedTexturePackage( LocalizeUnrealEd("TexturePackage") );
	TxtPkgLabel = new wxStaticText( this, wxID_STATIC, TEXT("TexturePackage"), wxDefaultPosition, wxDefaultSize, 0 );
	FlexGridSizer->Add(TxtPkgLabel, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxALL|wxADJUST_MINSIZE, 5);

	TxtPkgCombo = new wxComboBox( this, IDCB_PACKAGE, TEXT(""), wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_DROPDOWN|wxCB_SORT );
	FlexGridSizer->Add( TxtPkgCombo, 0, wxALIGN_LEFT|wxGROW|wxALL, 5 );

	// Populate Texture Package combo
	TArray<UPackage*> Packages;
	GEditor->GetPackageList( &Packages, NULL );

	for( INT PackageInde = 0 ; PackageInde < Packages.Num() ; ++PackageInde )
	{
		if( Packages(PackageInde)->SCCCanEdit() )
		{
			TxtPkgCombo->Append( *Packages(PackageInde)->GetName(), Packages(PackageInde) );
		}
	}
	...
	//const FString LocalizedTextureGroup( LocalizeUnrealEd("TextureGroup") );
	TxtGrpLabel = new wxStaticText( this, wxID_STATIC, TEXT("TextureGroup"), wxDefaultPosition, wxDefaultSize, 0 );
	FlexGridSizer->Add( TxtGrpLabel, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxALL|wxADJUST_MINSIZE, 5 );

	TxtGrpEdit = new wxTextCtrl( this, IDEC_TEXTUREGROUP, TEXT(""), wxDefaultPosition, wxDefaultSize, 0 );
	FlexGridSizer->Add( TxtGrpEdit, 0, wxALIGN_LEFT|wxGROW|wxALL, 5 );

	TxtBrowseButton = new WxBitmapButton( this, IDPB_TEXTUREBROWSE, BrowseB, wxDefaultPosition, wxSize(24, -1) );
	FlexGridSizer->Add( TxtBrowseButton, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 5 );
}

void WxPkgGrpNameTxtCtrl::OnBrowseTxtGroup( wxCommandEvent& In )
{
	const FString PkgName(PkgCombo->GetValue());
	const FString GroupName(TxtGrpEdit->GetValue());

	WxDlgSelectGroup dlg( this );
	if( dlg.ShowModal( PkgName, GroupName ) == wxID_OK )
	{
		//PkgCombo->SetValue( *dlg.Package );
		TxtGrpEdit->SetValue( *dlg.Group );
	}
}
...
MaxValue(InMaxValue)
{
	...
	{
		TextCtrl = new wxTextCtrl(this, IDT_SPINCTRLREAL, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER, wxTextValidator(wxFILTER_NUMERIC));
