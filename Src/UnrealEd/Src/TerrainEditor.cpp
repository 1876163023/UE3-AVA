...
FTerrainBrowserBlock::FTerrainBrowserBlock() :
	...
	, WireframeColor(1.0f, 1.0f, 1.0f, 1.0f)
 ...
 *	@param	InFoliageMesh		Pointer to the FTerrainFoliageMesh
...
void FTerrainBrowserBlock::SetupBlock(ETerrainLayerType InType, INT InArrayIndex, 
    ...
    FTerrainFoliageMesh* InFoliageMesh, FTerrainDecoLayer* InDecoLayer,
	...
	FTerrainBrowserBlock* InParentBlock)
{
	...
	case TLT_Foliage:				FoliageMesh			= InFoliageMesh;		break;
	}
...
INT WxMBTerrainEditorRightClick::FillMenu_New(INT InNewOptions, UBOOL bPreviousEntries)
{
	...
	{
		MenuString	= FString::Printf(*LocalizeUnrealEd("TerrainBrowser_CreateNewLayer"),
	...
	{
		MenuString	= FString::Printf(*LocalizeUnrealEd("TerrainBrowser_CreateNewLayer"), TEXT(""));
	...
	{
		MenuString	= FString::Printf(*LocalizeUnrealEd("TerrainBrowser_CreateNewMaterial"),
			*LocalizeUnrealEd("TerrainBrowser_CreateBefore"));
	...
	{
		MenuString	= FString::Printf(*LocalizeUnrealEd("TerrainBrowser_CreateNewMaterial"), TEXT(""));
	...
	{
		MenuString	= FString::Printf(*LocalizeUnrealEd("TerrainBrowser_CreateNewDecoLayer"),
			*LocalizeUnrealEd("TerrainBrowser_CreateBefore"));
	...
	{
		MenuString	= FString::Printf(*LocalizeUnrealEd("TerrainBrowser_CreateNewDecoLayer"), TEXT(""));
...
INT WxMBTerrainEditorRightClick::FillMenu_Add(INT InAddOptions, UBOOL bPreviousEntries)
{
	...
	{
		MenuString	= FString::Printf(*LocalizeUnrealEd("TerrainBrowser_AddSelectedLayer"),
			*LocalizeUnrealEd("TerrainBrowser_CreateBefore"));
	...
	{
		MenuString	= FString::Printf(*LocalizeUnrealEd("TerrainBrowser_AddSelectedLayer"), TEXT(""));
	...
	{
		MenuString	= FString::Printf(*LocalizeUnrealEd("TerrainBrowser_AddSelectedMaterial"),
			*LocalizeUnrealEd("TerrainBrowser_CreateBefore"));
	...
	{
		MenuString	= FString::Printf(*LocalizeUnrealEd("TerrainBrowser_AddSelectedMaterial"), TEXT(""));
	...
	{
		MenuString	= FString::Printf(*LocalizeUnrealEd("TerrainBrowser_AddSelectedDisplacement"), TEXT(""));
		Append(IDM_TERRAINBROWSER_ADDSELECTED_DISPLACEMENT, *MenuString, TEXT(""));
		EntryCount++;
	}

	if (InAddOptions & OPT_ADDSELECTED_FOLIAGE_BEFORE)
	{
		MenuString	= FString::Printf(*LocalizeUnrealEd("TerrainBrowser_AddSelectedFoliage"),
			*LocalizeUnrealEd("TerrainBrowser_CreateBefore"));
		Append(IDM_TERRAINBROWSER_ADDSELECTED_FOLIAGE_BEFORE, *MenuString, TEXT(""));
		EntryCount++;
	}
	if (InAddOptions & OPT_ADDSELECTED_FOLIAGE)
	{
		MenuString	= FString::Printf(*LocalizeUnrealEd("TerrainBrowser_AddSelectedFoliage"), TEXT(""));
		Append(IDM_TERRAINBROWSER_ADDSELECTED_FOLIAGE, *MenuString, TEXT(""));
		EntryCount++;
	}
	if (InAddOptions & OPT_ADDSELECTED_FOLIAGE_AFTER)
	{
		MenuString	= FString::Printf(*LocalizeUnrealEd("TerrainBrowser_AddSelectedFoliage"),
			*LocalizeUnrealEd("TerrainBrowser_CreateAfter"));
		Append(IDM_TERRAINBROWSER_ADDSELECTED_FOLIAGE_AFTER, *MenuString, TEXT(""));
		EntryCount++;
	}

	if (InAddOptions & OPT_ADDSELECTED_DECORATION_BEFORE)
	{
		MenuString	= FString::Printf(*LocalizeUnrealEd("TerrainBrowser_AddSelectedDecoration"),
			*LocalizeUnrealEd("TerrainBrowser_CreateBefore"));
	...
	{
		MenuString	= FString::Printf(*LocalizeUnrealEd("TerrainBrowser_AddSelectedDecoration"), TEXT(""));
						...
						case TLVCI_Stub:
							{
								...
								if (Info->GetLayerType() == TLT_Layer)
								{
									...
									AddFlags	|= WxMBTerrainEditorRightClick::OPT_ADDSELECTED_FOLIAGE;
								}
								...
								if (Info->GetLayerType() == TLT_Foliage)
								{
									Flags		|= WxMBTerrainEditorRightClick::OPT_USESELECTED;
									AddFlags	|= WxMBTerrainEditorRightClick::OPT_ADDSELECTED_FOLIAGE_BEFORE;
									AddFlags	|= WxMBTerrainEditorRightClick::OPT_ADDSELECTED_FOLIAGE;
									AddFlags	|= WxMBTerrainEditorRightClick::OPT_ADDSELECTED_FOLIAGE_AFTER;
								}
...
UBOOL FTerrainLayerViewportClient::CreateIcons()
{
	...
	FoliageIcon				= (UTexture2D*)UObject::StaticLoadObject(UTexture2D::StaticClass(), NULL, TEXT("EditorMaterials.TerrainLayerBrowser.TLB_Foliage_Icon_Alpha"), NULL, LoadFlags, NULL);
	check(FoliageIcon);
	...
	FoliageOverlayIcon		= (UTexture2D*)UObject::StaticLoadObject(UTexture2D::StaticClass(), NULL, TEXT("EditorMaterials.TerrainLayerBrowser.TerrainProp_FoliageOverlay"), NULL, LoadFlags, NULL);
	check(FoliageOverlayIcon);
	FoliageOverlayIcon2		= (UTexture2D*)UObject::StaticLoadObject(UTexture2D::StaticClass(), NULL, TEXT("EditorMaterials.TerrainLayerBrowser.TerrainProp_FoliageOverlay_Left"), NULL, LoadFlags, NULL);
	check(FoliageOverlayIcon2);
...
FTexture* FTerrainLayerViewportClient::GetIcon(ViewIcons eIcon, INT InfoIndex, FLinearColor& Color)
{
	...
	case TLVCI_LayerType:
		...
		case TLT_Foliage:				return GetFoliageIcon()->Resource;
		}
	case TLVCI_ProceduralOverlay:
		return GetProceduralOverlayIcon()->Resource;
	case TLVCI_FoliageOverlay:
		return GetFoliageOverlayIcon()->Resource;
	}
		...
		case TLT_FilteredMaterial:
			if (Info->GetFilteredMaterial() && Info->GetFilteredMaterial()->Material)
			{
				if (eIcon == TLVCI_Thumbnail)
				{
					...
					{
						if (Material->Material->FoliageMeshes.Num() > 0)
						{
							Overlay = GetIcon(TLVCI_FoliageOverlay, InfoIndex, HighlightColor);
						}
					}
...
//				YPos += Canvas->GetTransform().GetOrigin().Y;
		...
		case TLT_Decoration:
			...
			break;
		case TLT_Foliage:
			if (Info->GetFoliageMesh())
			{
				RenderObject	= Info->GetFoliageMesh()->StaticMesh;
				YPos += Canvas->GetTransform().GetOrigin().Y;
			}
			break;
		}
		...
		if (RenderObject)
		{
			...
			{
				// Now draw it
				RenderInfo->Renderer->Draw(RenderObject, TPT_Plane, TLBIconInfo[eIcon].PositionOffset + XOffset, YPos, TLBIconInfo[eIcon].Size, TLBIconInfo[eIcon].Size, Viewport, Canvas, FALSE);
				if (Overlay)
				{
	...
	FViewport* Viewport, FCanvas* Canvas, INT XOffset)
{
	...
	case TLT_Foliage:
		{
			FTerrainFoliageMesh* Mesh = Info->GetFoliageMesh();
			if (Mesh->StaticMesh)
			{
				Name	= FString::Printf(TEXT("%s"), *Mesh->StaticMesh->GetName());
			}
		}
		break;
	}
...
void FTerrainLayerViewportClient::ToggleViewHideInfoBlock(INT InfoIndex)
{
	...
	if (Info->GetLayerType() == TLT_Layer)
	{
		...
		{
			TerrainEditor->GetCurrentTerrain()->PostEditChange(NULL);
		}
	}
}
...
***/
	...
	if (DisplayObject)
	{
		...
		Properties->Create(TerrainEditor, -1, 0);
		Properties->AllowClose();
		Properties->SetObject(DisplayObject, 1,1,1);
...
BEGIN_EVENT_TABLE(WxTerrainEditor, wxDialog)
	// Tools
	...
	EVT_BUTTON(ID_TERRAIN_VIEWSETTINGS_OVERLAY_SOLID,				WxTerrainEditor::OnTerrainSolid)
	...
	EVT_COMMAND_RIGHT_CLICK(ID_TERRAIN_VIEWSETTINGS_OVERLAY_SOLID,	WxTerrainEditor::OnTerrainRightClick)
	EVT_TOOL_RCLICKED(ID_TERRAIN_VIEWSETTINGS_OVERLAY_WIRE,			WxTerrainEditor::OnTerrainRightClick)
	EVT_TOOL_RCLICKED(ID_TERRAIN_VIEWSETTINGS_OVERLAY_SOLID,		WxTerrainEditor::OnTerrainRightClick)
    ...
    EVT_BUTTON(ID_TERRAIN_SETTINGS_COLOR,							WxTerrainEditor::OnSettingsColorButton)
    ...
    EVT_COMBOBOX(ID_TERRAIN_SETTINGS_COMBOBOX_STRENGTH,				WxTerrainEditor::OnSettingsCombo)
    EVT_TEXT(ID_TERRAIN_SETTINGS_COMBOBOX_STRENGTH,					WxTerrainEditor::OnSettingsComboText)
    EVT_COMMAND_SCROLL(ID_TERRAIN_SETTINGS_SLIDER_RADIUS,			WxTerrainEditor::OnSettingsSlider)
	EVT_COMBOBOX(ID_TERRAIN_SETTINGS_COMBOBOX_RADIUS,				WxTerrainEditor::OnSettingsCombo)
	EVT_TEXT(ID_TERRAIN_SETTINGS_COMBOBOX_RADIUS,					WxTerrainEditor::OnSettingsComboText)
    EVT_COMMAND_SCROLL(ID_TERRAIN_SETTINGS_SLIDER_FALLOFF,			WxTerrainEditor::OnSettingsSlider)
    EVT_COMBOBOX(ID_TERRAIN_SETTINGS_COMBOBOX_FALLOFF,				WxTerrainEditor::OnSettingsCombo)
    EVT_TEXT(ID_TERRAIN_SETTINGS_COMBOBOX_FALLOFF,					WxTerrainEditor::OnSettingsComboText)
	...
	EVT_MENU(IDM_TERRAINBROWSER_ADDSELECTED_FOLIAGE_BEFORE,			WxTerrainEditor::OnAddSelectedFoliage)
	EVT_MENU(IDM_TERRAINBROWSER_ADDSELECTED_FOLIAGE,				WxTerrainEditor::OnAddSelectedFoliage)
	EVT_MENU(IDM_TERRAINBROWSER_ADDSELECTED_FOLIAGE_AFTER,			WxTerrainEditor::OnAddSelectedFoliage)
...
//	  wxWindow(InParent, -1, wxDefaultPosition, wxDefaultSize)
	  wxDialog(InParent, -1, wxString(*LocalizeUnrealEd("TerrainEdit_Title")))
	, EdMode(NULL)
	...
	, CurrentRightClickIndex(-1)
{
	...
	ViewSettingsSolid.Button	= NULL;
	ViewSettingsSolid.Active	= NULL;
	ViewSettingsSolid.Inactive	= NULL;

	ColorSwatch.Color		= FColor(255,255,255);
	ColorSwatch.Image		= NULL;
	ColorSwatch.Button		= NULL;
	ColorSwatch.Active		= NULL;
	ColorSwatch.Inactive	= NULL;

	for (Index = 0; Index < ETETS_MAX; Index++)
	{
		Settings[Index].Label	= NULL;
		Settings[Index].Slider	= NULL;
		Settings[Index].Combo	= NULL;
	}

	EditorOptions = ConstructObject<UTerrainEditOptions>(UTerrainEditOptions::StaticClass());
	check(EditorOptions);

	bShowFoliageMeshes		= EditorOptions->bShowFoliageMeshes;
	...
	bTerrainSolidOverlayActive	= FALSE;
	TerrainSolidColor			= FColor(200,200,  0);
	bTerrainWireOverlayActive	= FALSE;
	TerrainWireColor			= FColor(100,100,  0);;
...
//				SetStrength(EditorOptions->Current_Strength);
...
UBOOL WxTerrainEditor::SetSelected(ATerrain* Terrain, ETerrainLayerType eType, INT Index)
{
	...
	for (INT TerrainIndex = 0; TerrainIndex < ViewSettingsTerrainCombo->GetCount(); TerrainIndex++)
	{
 ...
 */
UBOOL WxTerrainEditor::DeletedSelected()
{
	...
	if (SelectedBlock != -1)
	{
		...
		if (Info)
		{
			...
			FString	DeletePrompt	= FString::Printf(*LocalizeUnrealEd("TerrainBrowser_ConfirmDeletion"), GetTerrainLayerTypeString(Info->GetLayerType()));
			...
			case TLT_Foliage:
				{
					FTerrainFilteredMaterial* Material = ParentInfo->GetFilteredMaterial();
					if (Material && Material->Material)
					{
						INT	Index	= Info->GetArrayIndex();
						if (Index >= 0)
						{
							Material->Material->FoliageMeshes.Remove(Index);
							bRefreshTerrain	= TRUE;
...
void WxTerrainEditor::OnImpExpHeightMapClassCombo(wxCommandEvent& In)
{
	...
	GConfig->SetString(TEXT("Editor.EditorEngine"), TEXT("HeightMapExportClassName"), *strSelected, GEditorIni);
}
...
void WxTerrainEditor::OnTerrainProperties(wxCommandEvent& In)
{
	...
	{
		WxPropertyWindowFrame* Properties = new WxPropertyWindowFrame;
		Properties->Create(this, -1, 0);
		Properties->AllowClose();
		Properties->SetObject(Terrain,0,1,1);
...
void WxTerrainEditor::OnTerrainHide(wxCommandEvent& In)
{
	...
	// Toggle the button
	CurrentTerrain->bHiddenEd = !CurrentTerrain->bHiddenEd;
	CurrentTerrain->PostEditChange(NULL);
	if (CurrentTerrain->bHiddenEd)
	{
 ...
 *	@param	In	wxCommandEvent 
 */
void WxTerrainEditor::OnTerrainSolid(wxCommandEvent& In)
{
	// Toggle the button
	ViewSettingsSolid.Button->SetBitmapLabel(*ViewSettingsSolid.Active);
...
void WxTerrainEditor::OnTerrainRightClick(wxCommandEvent& In)
{
	...
	if (In.GetId() == ID_TERRAIN_VIEWSETTINGS_OVERLAY_SOLID)
	{
		debugf(TEXT("Right-clicked SOLID!"));
	}
	else
	{
...
void WxTerrainEditor::OnTerrainRightDown(wxMouseEvent& In)
{
	...
	INT	Id = In.GetId();
	if ((Id == ID_TERRAIN_VIEWSETTINGS_OVERLAY_WIRE) || (In.GetId() == ID_TERRAIN_VIEWSETTINGS_OVERLAY_SOLID))
	{
		Menu = new WxMBTerrainEditorRightClick(this, WxMBTerrainEditorRightClick::OPT_COLOR);
	}
...
{
	debugf(TEXT("Right-clicked a brush button bitch!"));
}
...
/**
 *	Called when the Settings Color button is pressed
 *
 *	@param	In	wxCommandEvent 
 */
void WxTerrainEditor::OnSettingsColorButton(wxCommandEvent& In)
{
	if (EdMode == NULL)
	{
		return;
	...
	wxColour wxColorIn(ColorSwatch.Color.R, ColorSwatch.Color.G, ColorSwatch.Color.B);
	wxColour wxColorOut = wxGetColourFromUser(this, wxColorIn);

	ColorSwatch.Color.R	= wxColorOut.Red();
	ColorSwatch.Color.G	= wxColorOut.Green();
	ColorSwatch.Color.B	= wxColorOut.Blue();

	unsigned char* Data = ColorSwatch.Image->GetData();
	for (INT ColorIndex = 0; ColorIndex < (28*28); ColorIndex++)
	{
		*Data++	= (unsigned char)(ColorSwatch.Color.R);
		*Data++	= (unsigned char)(ColorSwatch.Color.G);
		*Data++	= (unsigned char)(ColorSwatch.Color.B);
	}
	WxBitmap*	NewBitmap	= new WxBitmap(ColorSwatch.Image);
	ColorSwatch.Button->SetBitmapLabel(*NewBitmap);
	delete ColorSwatch.Active;
	ColorSwatch.Active	= NewBitmap;

	EdMode->ModeColor	= ColorSwatch.Color;
	SaveData();
}
...
void WxTerrainEditor::OnSettingsSlider(wxScrollEvent& In)
{
    ...
    if (InSlider)
	{
		...
		if (Tool != ETETS_MAX)
		{
			Settings[Tool].Combo->SetValue(wxString(*FString::Printf(TEXT("%d"), In.GetPosition())));
...
/**
 *	Called when a Settings combo is changed
 *
 *	@param	In	wxCommandEvent 
 */
void WxTerrainEditor::OnSettingsCombo(wxCommandEvent& In)
{
    wxComboBox* InCombo = wxDynamicCast(In.GetEventObject(), wxComboBox);
    if (InCombo)
	{
		EToolSettings Tool = ETETS_MAX;
		switch (InCombo->GetId())
		{
		case ID_TERRAIN_SETTINGS_COMBOBOX_STRENGTH:	Tool = ETETS_Strength;	break;
		case ID_TERRAIN_SETTINGS_COMBOBOX_RADIUS:	Tool = ETETS_Radius;	break;
		case ID_TERRAIN_SETTINGS_COMBOBOX_FALLOFF:	Tool = ETETS_Falloff;	break;
		}
 ...
 *	@param	In	wxCommandEvent 
 */
void WxTerrainEditor::OnSettingsComboText(wxCommandEvent& In)
{
    wxComboBox* InCombo = wxDynamicCast(In.GetEventObject(), wxComboBox);
    if (InCombo)
	{
		...
		if (Tool != ETETS_MAX)
		{
			INT Value = appAtoi(InCombo->GetValue());
...
void WxTerrainEditor::OnBrowserScroll(wxScrollEvent& In)
{
    ...
    if (InScrollBar && (InScrollBar->GetId() == ID_TERRAIN_BROWSER_SCROLLBAR)) 
	{
		...
		if (TerrainBrowserPos_Vert != NewPosition)
		{
			...
			debugf(TEXT("Scrolling End - %d"), TerrainBrowserPos_Vert);
		}
    }
}
...
void WxTerrainEditor::OnSavePreset(wxCommandEvent& In)
{
	if ((CurrentPresetBrush >= ETEBB_Brush0) && (CurrentPresetBrush <= ETEBB_Brush9))
	{
		...
		FString ToolTip = FString::Printf(TEXT("S=%d\nR=%d\nF=%d"), BrushButtons[ButtonIndex].Strength, BrushButtons[ButtonIndex].Radius, BrushButtons[ButtonIndex].Falloff);
...
{
	debugf(TEXT("Add Layer"));

	if (CheckAddValidity(TLT_Layer))
	{
		BeginTransaction(TEXT("TLB_AddLayer"));

		INT	LayerIndex = CurrentTerrain->Layers.AddZeroed(1);
		FTerrainLayer* Layer = &(CurrentTerrain->Layers(LayerIndex));
		Layer->Name				= FString::Printf(TEXT("Layer%d"), LayerIndex);
...
void WxTerrainEditor::OnRenameItem(wxCommandEvent& In)
{
	...
	if (dlg.ShowModal(*LocalizeUnrealEd("TerrainBrowser_Rename"), *LocalizeUnrealEd("Name"), *CurrentName) == wxID_OK)
	{
...
void WxTerrainEditor::OnChangeColor(wxCommandEvent& In)
{
	...
	wxColour	wxColorIn(100, 100, 100);
	
	switch (eCurrentRightClick)
	{
	case FTerrainLayerViewportClient::TLVCI_Wireframe:
		{
			FColor OldColor = Info->GetWireframeColor();
			wxColorIn = wxColour(OldColor.R, OldColor.G, OldColor.B);
		}
		break;
	case FTerrainLayerViewportClient::TLVCI_Solid:
		{
			FColor OldColor = Info->GetHighlightColor();
			wxColorIn = wxColour(OldColor.R, OldColor.G, OldColor.B);
		}
		break;
	}
	...
	wxColour	wxColorOut = wxGetColourFromUser(this, wxColorIn);
	FColor		NewColor(wxColorOut.Red(), wxColorOut.Green(), wxColorOut.Blue(), 64);
	UBOOL		bRefreshTerrain	= FALSE;
...
void WxTerrainEditor::OnDelete(wxCommandEvent& In)
{
	...
	if (CurrentRightClickIndex != -1)
	{
		...
		if (ClickedInfo)
		{
			ParentInfo	= ClickedInfo->GetParentBlock();

			FString	DeletePrompt	= FString::Printf(*LocalizeUnrealEd("TerrainBrowser_ConfirmDeletion"), GetTerrainLayerTypeString(ClickedInfo->GetLayerType()));
			UBOOL	bDoDelete		= appMsgf(AMT_YesNo, *DeletePrompt);
			if (bDoDelete == FALSE)
			{
				return;
			...
			switch (ClickedInfo->GetLayerType())
			{
			case TLT_HeightMap:
				{
					appMsgf(AMT_OK, TEXT("Deleting the HeightMap is not allowed"));
			...
			case TLT_Layer:
				{
					INT	Index	= ClickedInfo->GetArrayIndex();
					if (Index >= 0)
					{
						CurrentTerrain->Layers.Remove(Index);
						bRefreshTerrain	= TRUE;
...
void WxTerrainEditor::OnNewLayer(wxCommandEvent& In)
{
	...
	if (CheckAddValidity(TLT_Layer))
	{
		FString	CurrentName(TEXT("NewLayer"));
		WxDlgGenericStringEntry dlg;
		if (dlg.ShowModal(*LocalizeUnrealEd("TerrainBrowser_Rename"), *LocalizeUnrealEd("Name"), *CurrentName) != wxID_OK)
		{
			return;
		...
		if (In.GetId() == IDM_TERRAINBROWSER_NEWLAYER_AFTER)
		{
			IndexOffset = 1;
		}
...
void WxTerrainEditor::OnNewLayerAuto(wxCommandEvent& In)
{
	...
	if (CheckAddValidity(TLT_Layer))
	{
		...
		if (GetResult > 0)
		{
			...
			UTerrainLayerSetup* NewLayerSetup = CreateNewLayer(TLSName, FALSE);
			if (NewLayerSetup == NULL)
			{
			...
			if (ObjMaterial || ObjMaterialInst)
			{
				...
				UTerrainMaterial* NewMaterial = CreateNewTerrainMaterial(TMATName, FALSE);
				if (NewMaterial)
				{
...
/**
 *	Called when the right-click menu 'New Foliage' option is selected
 *
 *	@param	In	wxCommandEvent
 */
void WxTerrainEditor::OnNewFoliage(wxCommandEvent& In)
{
	debugf(TEXT("New Foliage"));
}
...
/**
 *	Called when the right-click menu 'Add Current Foliage' option is selected
 *
 *	@param	In	wxCommandEvent
 */
void WxTerrainEditor::OnAddSelectedFoliage(wxCommandEvent& In)
{
	debugf(TEXT("AddSelected Foliage"));
	...
	INT GetResult = GetSelectedItem(TLT_Foliage, SelectedItem);
	if (GetResult > 0)
	{
		UObject* Object = (UObject*)SelectedItem;
		if (Object && Object->IsA(UStaticMesh::StaticClass()))
		{
			...
			if (Mesh)
			{
				INT NewIndex = TerrainMaterial->FoliageMeshes.AddZeroed();

				FTerrainFoliageMesh* FoliageMesh = &(TerrainMaterial->FoliageMeshes(NewIndex));
				if (FoliageMesh)
				{
					FoliageMesh->StaticMesh = Mesh;
					RefreshTerrain();
					FillInfoArray();
					CurrentTerrain->MarkPackageDirty();
				}
...
//	EdMode->SetCurrentTool(NewTool);
	...
	for (Index = 0; Index < ETETB_MAX; Index++)
	{
		...
		case ETETB_AddRemoveSectors:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_AddRemoveSectors.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_AddRemoveSectors_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip			= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_AddRemoveSectors"));
			break;
		case ETETB_AddRemovePolys:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_AddRemovePolys.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_AddRemovePolys_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip			= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_AddRemovePolys"));
			break;
		case ETETB_Paint:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Paint.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Paint_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip			= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_Paint"));
			break;
		case ETETB_PaintVertex:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_PaintVertex.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_PaintVertex_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip			= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_PaintVertex"));
			break;
		case ETETB_ManualEdit:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_ManualEdit.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_ManualEdit_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip			= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_ManualEdit"));
			break;
		case ETETB_Flatten:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Flatten.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Flatten_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip			= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_Flatten"));
			break;
		case ETETB_FlattenSpecific:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_FlattenSpecific.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_FlattenSpecific_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip			= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_FlattenSpecific"));
			break;
		case ETETB_Smooth:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Smooth.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Smooth_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip			= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_Smooth"));
			break;
		case ETETB_Average:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Average.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Average_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip			= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_Average"));
			break;
		case ETETB_Noise:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Noise.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Noise_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip			= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_Noise"));
			break;
		case ETETB_Visibility:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Visibility.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Visibility_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip	= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_Visibility"));
			break;
		case ETETB_TexturePan:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_TexturePan.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_TexturePan_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip	= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_TexturePan"));
			break;
		case ETETB_TextureRotate:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_TextureRotate.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_TextureRotate_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip	= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_TextureRotate"));
			break;
		case ETETB_TextureScale:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_TextureScale.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_TextureScale_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip	= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_TextureScale"));
			break;
		case ETETB_VertexLock:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_LockVertex.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_LockVertex_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip	= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_VertexLock"));
			break;
		case ETETB_MarkUnreachable:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_MarkUnreachable.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_MarkUnreachable_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip	= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_MarkUnreachable"));
			break;
		case ETETB_SplitX:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_SplitX.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_SplitX_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip	= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_SplitX"));
			break;
		case ETETB_SplitY:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_SplitY.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_SplitY_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip	= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_SplitY"));
			break;
		case ETETB_Merge:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Merge.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Merge_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip	= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_Merge"));
			break;
		case ETETB_Custom1:
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Custom.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Custom_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip	= *FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_Custom"));
			break;
		}
	...
	ViewSettingsTerrainCombo = new wxComboBox(this, ID_TERRAIN_VIEWSETTINGS_COMBOBOX_TERRAIN, TEXT(""), wxDefaultPosition, wxDefaultSize, 0, ComboBoxStrings, wxCB_DROPDOWN);
	...
	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainProp_Properties.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	...
	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainProp_Empty.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	ViewSettingsView.Inactive = new WxBitmap(TempImage);
	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainProp_View.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	...
	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainProp_Lock.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	...
	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainProp_Wireframe.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	...
	ViewSettingsSolidLabel = new wxStaticText(this, ID_TERRAIN_VIEWSETTINGS_LABEL_OVERLAY_SOLID, *LocalizeUnrealEd("TerrainViewSettingsSolidLabel"), wxDefaultPosition, wxDefaultSize, 0 );
	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainProp_Solid.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	ViewSettingsSolid.Inactive = new WxBitmap(TempImage);
	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainProp_Solid.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	ViewSettingsSolid.Active = new WxBitmap(TempImage);
	ViewSettingsSolid.Button = new WxBitmapButton(this, ID_TERRAIN_VIEWSETTINGS_OVERLAY_SOLID, *ViewSettingsSolid.Active, wxDefaultPosition, wxSize(24, 24));
	ViewSettingsSolid.Button->SetBitmapLabel(*ViewSettingsSolid.Inactive);
	ViewSettingsSolid.Button->SetBitmapSelected(*ViewSettingsSolid.Active);
	ViewSettingsSolid.Button->SetToolTip(wxString(*LocalizeUnrealEd("TerrainViewSettingsSolid_ToolTip")));

	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainProp_RecacheMaterials.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	TempBitmap = new WxBitmap(TempImage);
	...
	for (Index = 0; Index < ETEBB_MAX; Index++)
	{
		...
		case ID_TERRAIN_BRUSH_0:
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Solid1_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Solid1.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip = FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_Solid1"));
			break;
		case ID_TERRAIN_BRUSH_1:
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Solid2_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Solid2.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip = FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_Solid2"));
			break;
		case ID_TERRAIN_BRUSH_2:
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Solid3_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Solid3.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip = FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_Solid3"));
			break;
		case ID_TERRAIN_BRUSH_3:
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Solid4_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Solid4.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip = FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_Solid4"));
			break;
		case ID_TERRAIN_BRUSH_4:
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Solid5_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Solid5.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip = FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_Solid5"));
			break;
		case ID_TERRAIN_BRUSH_5:
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Noisy1_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Noisy1.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip = FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_Noisy1"));
			break;
		case ID_TERRAIN_BRUSH_6:
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Noisy2_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Noisy2.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip = FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_Noisy2"));
			break;
		case ID_TERRAIN_BRUSH_7:
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Noisy3_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Noisy3.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip = FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_Noisy3"));
			break;
		case ID_TERRAIN_BRUSH_8:
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Noisy4_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Noisy4.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip = FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_Noisy4"));
			break;
		case ID_TERRAIN_BRUSH_9:
			Image_Active.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Noisy5_Active.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			Image_Inactive.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEdit_Noisy5.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
			ToolTip = FString::Printf(*LocalizeUnrealEd("TerrainEdit_Tooltip_Noisy5"));
			break;
		}

		ToolTip = FString::Printf(TEXT("S=%d\nR=%d\nF=%d"), BrushButtons[Index].Strength, BrushButtons[Index].Radius, BrushButtons[Index].Falloff);
	...
	ColorLabel = new wxStaticText(this, wxID_STATIC, *LocalizeUnrealEd("TerrainEdit_ColorLabel"), wxDefaultPosition, wxDefaultSize, 0 );
	ColorSwatch.Image	= new wxImage(28, 28);
	unsigned char* Data = ColorSwatch.Image->GetData();
	for (INT ColorIndex = 0; ColorIndex < (28*28); ColorIndex++)
	{
		*Data++	= (unsigned char)(ColorSwatch.Color.R);
	...
	ColorSwatch.Active	= new WxBitmap(ColorSwatch.Image);
	ColorSwatch.Button	= new WxBitmapButton(this, ID_TERRAIN_SETTINGS_COLOR, *ColorSwatch.Active, wxDefaultPosition, wxSize(32, 32));
	ColorSwatch.Button->SetBitmapLabel(*ColorSwatch.Active);
	...
	ToolScaleCombo = new wxComboBox(this, ID_TERRAIN_SETTINGS_COMBOBOX_SCALE, TEXT(""), wxDefaultPosition, wxSize(64, -1), 0, ComboBoxStrings, wxCB_DROPDOWN);
	...
	for (Index = 0; Index < ETETS_MAX; Index++)
	{
		...
		Settings[Index].Combo = new wxComboBox(this, ID_TERRAIN_SETTINGS_COMBOBOX_STRENGTH + (3 * Index), TEXT(""), wxDefaultPosition, wxSize(64, -1), 0, ComboBoxStrings, wxCB_DROPDOWN);
	}
	...
	ToolMirrorCombo = new wxComboBox(this, ID_TERRAIN_SETTINGS_COMBOBOX_MIRROR, TEXT(""), wxDefaultPosition, wxSize(64, -1), 0, ComboBoxStrings, wxCB_DROPDOWN|wxCB_READONLY);
	...
	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainTessellation_Increase.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	TempBitmap = new WxBitmap(TempImage);
	...
	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainTessellation_Decrease.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	TempBitmap = new WxBitmap(TempImage);
	...
	/** Bottom row Controls										*/
	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainProp_BrowserSelect.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	TempBitmap = new WxBitmap(TempImage);
	...
	delete TempBitmap;
	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainProp_BrowserSelect_Pressed.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	TempBitmap	= new WxBitmap(TempImage);
	UseSelectedButton->SetBitmapSelected(*TempBitmap);
	delete TempBitmap;

	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainProp_AddLayer.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	TempBitmap = new WxBitmap(TempImage);
	...
	delete TempBitmap;
	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainProp_AddLayer_Pressed.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	TempBitmap	= new WxBitmap(TempImage);
	NewLayerButton->SetBitmapSelected(*TempBitmap);
	delete TempBitmap;

	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainProp_AddMaterial.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	TempBitmap = new WxBitmap(TempImage);
	...
	delete TempBitmap;
	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainProp_AddMaterial_Pressed.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	TempBitmap	= new WxBitmap(TempImage);
	NewMaterialButton->SetBitmapSelected(*TempBitmap);
	delete TempBitmap;

	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainProp_DecoLayer.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	TempBitmap = new WxBitmap(TempImage);
	...
	delete TempBitmap;
	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainProp_DecoLayer_Pressed.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	TempBitmap	= new WxBitmap(TempImage);
	NewDecoLayerButton->SetBitmapSelected(*TempBitmap);
	delete TempBitmap;

	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainProp_Delete.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	TempBitmap = new WxBitmap(TempImage);
	...
	delete TempBitmap;
	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainProp_Delete_Pressed.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	TempBitmap	= new WxBitmap(TempImage);
	DeleteSelectedButton->SetBitmapSelected(*TempBitmap);
	delete TempBitmap;

	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEditor_ShiftLayerUp.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	TempBitmap = new WxBitmap(TempImage);
	...
	delete TempBitmap;
	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEditor_ShiftLayerUp_Pressed.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	TempBitmap	= new WxBitmap(TempImage);
	ShiftLayerUpButton->SetBitmapSelected(*TempBitmap);
	delete TempBitmap;

	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEditor_ShiftLayerDown.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	TempBitmap = new WxBitmap(TempImage);
	...
	delete TempBitmap;
	TempImage.LoadFile(*FString::Printf(TEXT("%swxres\\TerrainEditor_ShiftLayerDown_Pressed.bmp"), appBaseDir()), wxBITMAP_TYPE_BMP);
	TempBitmap	= new WxBitmap(TempImage);
...
////@begin MyDialog content construction
    ...
    ToolRow4Sizer->Add(ToolButtons[ETETB_Custom1].Button, 0, wxALIGN_CENTER_VERTICAL|wxALL, 1);
    ...
    SettingGroupFlexSizerTop->Add(ColorLabel, 5, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL|wxADJUST_MINSIZE, 0);
	SettingGroupFlexSizerTop->Add(ColorSwatch.Button, 5, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 0);
	...
	SettingGroupFlexSizerMiddle->Add(Settings[ETETS_Strength].Combo, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 0);
	...
	SettingGroupFlexSizerMiddle->Add(Settings[ETETS_Radius].Combo, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 0);
	...
	SettingGroupFlexSizerMiddle->Add(Settings[ETETS_Falloff].Combo, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 0);
    ...
    ViewSettingsGroupFlexSizer->Add(ViewSettingsSolid.Button, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxALL, 2);
    ViewSettingsGroupFlexSizer->Add(ViewSettingsSolidLabel, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxALL|wxADJUST_MINSIZE, 2);
...
void WxTerrainEditor::FillCurrentlyEditingData()
{
}
...
void WxTerrainEditor::FillInfoArray()
{
	...
	for (INT InfoIndex = 0; InfoIndex < InfoBlocks.Num(); InfoIndex++)
	{
		...
		case TLT_Layer:
			{
				FTerrainLayer*	Layer	= Info->GetLayer();
				OpenMap.Set((DWORD)Layer, Info->GetOpen());
			}
			break;
		case TLT_DecoLayer:
			{
				FTerrainDecoLayer*	DecoLayer	= Info->GetDecoLayer();
				OpenMap.Set((DWORD)DecoLayer, Info->GetOpen());
			}
			break;
		case TLT_TerrainMaterial:
			{
				FTerrainFilteredMaterial* Material = Info->GetFilteredMaterial();
				OpenMap.Set((DWORD)Material, Info->GetOpen());
			}
			break;
		case TLT_FilteredMaterial:
			{
	...
	if (CurrentTerrain)
	{
		...
		if (Terrain->Layers.Num() > 0)
		{
			for (INT LayerIndex = 0; LayerIndex < Terrain->Layers.Num(); LayerIndex++)
			{
				...
				bOpenable	= TRUE;
				bOpen		= FALSE;
				bOpenPtr	= OpenMap.Find((DWORD)Layer);
				if (bOpenPtr)
				{
					bOpen	= *bOpenPtr;
				}
				...
				Info->SetupBlock(TLT_Layer, LayerIndex, Layer, NULL, NULL, NULL, NULL, NULL, 
				...
				if (LayerSetup)
				{
					...
					for (INT MatIndex = 0; MatIndex < LayerSetup->Materials.Num(); MatIndex++)
					{
						...
						bOpen		= FALSE;
						bOpenPtr	= OpenMap.Find((DWORD)Material);
						if (bCanOpen && bOpenPtr)
						{
							bOpen	= *bOpenPtr;
						}
						Info->SetupBlock(TLT_FilteredMaterial, MatIndex, NULL, Material, NULL, NULL, NULL, NULL,
							FALSE, TRUE, FALSE, FALSE, bCanOpen, bOpen, TRUE, FALSE, FALSE, FALSE, TRUE, bDispMap, 
							LayerInfoBlock);
						Info->SetDraw(LayerInfoBlock->GetOpen());

						if (Material->Material && bShowFoliageMeshes)
						{
							for (INT FoliageIndex = 0; FoliageIndex < Material->Material->FoliageMeshes.Num(); FoliageIndex++)
							{
								FTerrainFoliageMesh* FoliageMesh = &(Material->Material->FoliageMeshes(FoliageIndex));

								SetInfoArraySize(CurrentCount);
								Info	= &InfoBlocks(CurrentCount - 1);
								CurrentCount++;

								Info->SetupBlock(TLT_Foliage, FoliageIndex, NULL, NULL, FoliageMesh, NULL, NULL, NULL, 
									TRUE, TRUE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, TRUE, FALSE, 
									TFMInfo);
								Info->SetDraw(TFMInfo->GetOpen());
							}
						}
					}
				}
		...
		if (Terrain->DecoLayers.Num() > 0)
		{
			for (INT DecoLayerIndex = 0; DecoLayerIndex < Terrain->DecoLayers.Num(); DecoLayerIndex++)
			{
				...
				bOpenable	= TRUE;
				bOpen		= FALSE;
				bOpenPtr	= OpenMap.Find((DWORD)DecoLayer);
				if (bOpenPtr)
				{
					bOpen	= *bOpenPtr;
				}
				...
				Info->SetupBlock(TLT_DecoLayer, DecoLayerIndex, NULL, NULL, NULL, DecoLayer, NULL, NULL, 
				...
				if (bShowDecoarationMeshes)
				{
					for (INT DecoIndex = 0; DecoIndex < DecoLayer->Decorations.Num(); DecoIndex++)
					{
						...
						Info->SetupBlock(TLT_Decoration, DecoIndex, NULL, NULL, NULL, NULL, Decoration, NULL, 
...
void WxTerrainEditor::SetBrush(EBrushButton Brush)
{
	...
	if (Brush < ETEBB_MAX)
	{
		...
		Settings[ETETS_Strength].Combo->SetValue(wxString(*FString::Printf(TEXT("%d"), BrushButtons[Brush].Strength)));
		Settings[ETETS_Radius].Slider->SetValue(BrushButtons[Brush].Radius);
		Settings[ETETS_Radius].Combo->SetValue(wxString(*FString::Printf(TEXT("%d"), BrushButtons[Brush].Radius)));
		Settings[ETETS_Falloff].Slider->SetValue(BrushButtons[Brush].Falloff);
		Settings[ETETS_Falloff].Combo->SetValue(wxString(*FString::Printf(TEXT("%d"), BrushButtons[Brush].Falloff)));
...
//	case ETETB_FlattenSpecific:															break;
...
void WxTerrainEditor::RefreshLayers()
{
}
...
void WxTerrainEditor::LoadData()
{
	...
	if (ToolSettings)
	{
		...
		Settings[ETETS_Strength].Combo->SetValue(wxString(*Value));

		Settings[ETETS_Radius].Slider->SetValue(ToolSettings->RadiusMin);
		Value	= FString::Printf(TEXT("%d"), (INT)(ToolSettings->RadiusMin));
		Settings[ETETS_Radius].Combo->SetValue(wxString(*Value));
	
		Settings[ETETS_Falloff].Slider->SetValue(ToolSettings->RadiusMax - ToolSettings->RadiusMin);
		Value	= FString::Printf(TEXT("%d"), (INT)(ToolSettings->RadiusMax - ToolSettings->RadiusMin));
		Settings[ETETS_Falloff].Combo->SetValue(wxString(*Value));
...
void WxTerrainEditor::SaveData()
{
	...
	ToolSettings->RadiusMin	= appAtoi(Settings[ETETS_Radius].Combo->GetValue().c_str());
	ToolSettings->RadiusMax	= ToolSettings->RadiusMin + appAtoi(Settings[ETETS_Falloff].Combo->GetValue().c_str());
	ToolSettings->Strength	= appAtof(Settings[ETETS_Strength].Combo->GetValue().c_str());
...
{
	FString	DecreasePrompt = FString::Printf(*LocalizeUnrealEd("TerrainEdit_ConfirmDecrease"));
...
/**
 *	Use the item currently selected in the GenericBrowser.
 *
		...
		if (Info)
		{
			...
			if (RequiredClass)
			{
				...
				if (Obj)
				{
					...
					case TLT_Foliage:
						{
							// Grab the parent material...
							if (ParentInfo)
							{
								FTerrainFilteredMaterial*	FilteredMaterial	= ParentInfo->GetFilteredMaterial();
								if (FilteredMaterial)
								{
									INT	Index	= Info->GetArrayIndex();
									if (Index != -1)
									{
										FTerrainFoliageMesh* FoliageMesh	= &(FilteredMaterial->Material->FoliageMeshes(Index));
										FoliageMesh->StaticMesh	= Cast<UStaticMesh>(Obj);
										bRefreshTerrain	= TRUE;
									}
									else
									{
							...
							if (Index != -1)
							{
								...
								if (ObjMaterial || ObjMaterialInst)
								{
									if (FilteredMaterial->Material)
									{
										...
										UMaterialInstance* NewMatInst = NULL;
										if (ObjMaterialInst)
										{
											NewMatInst = Cast<UMaterialInstance>(ObjMaterialInst);
...
UBOOL WxTerrainEditor::CheckAddValidity(ETerrainLayerType Type)
{
	...
	{
		//@todo. Localize this
		appMsgf(AMT_OK, TEXT("%s: No terrain selected."), GetTerrainLayerTypeString(Type));
		return FALSE;
	}
...
UBOOL WxTerrainEditor::BeginTransaction(const TCHAR* Transaction)
{
	...
	GEditor->Trans->Begin(Transaction);
 ...
 *			FALSE			if failed
 */
UBOOL WxTerrainEditor::CreateNewItem(ETerrainLayerType eType, FString& ObjectName, void*& CreatedItem, UBOOL bPrompt)
{
	if (CurrentTerrain == NULL)
	{
		return FALSE;
	...
	UPackage* Package = Cast<UPackage>(CurrentTerrain->GetOutermost());
	if (Package)
	{
 ...
 */
UTerrainLayerSetup* WxTerrainEditor::CreateNewLayer(FString& ObjectName, UBOOL bPrompt)
{
	void* CreatedItem;
	if (CreateNewItem(TLT_Layer, ObjectName, CreatedItem, bPrompt) == TRUE)
	{
 ...
 */
UTerrainMaterial* WxTerrainEditor::CreateNewTerrainMaterial(FString& ObjectName, UBOOL bPrompt)
{
	void* CreatedItem;
	if (CreateNewItem(TLT_TerrainMaterial, ObjectName, CreatedItem, bPrompt) == TRUE)
	{
