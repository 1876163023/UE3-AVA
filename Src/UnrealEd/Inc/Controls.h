...
public:
	...
	wxStaticText *TxtPkgLabel;
	wxComboBox *TxtPkgCombo;
	wxStaticText *TxtGrpLabel;
	wxTextCtrl *TxtGrpEdit;
	wxBitmapButton *TxtBrowseButton;
	
private:
	void OnBrowseTxtGroup( wxCommandEvent& In );
