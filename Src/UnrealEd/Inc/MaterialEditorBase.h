 ...
 */
class WxMaterialEditorBase : public wxFrame
{
public:
	...
	WxMaterialEditorBase(wxWindow* InParent, wxWindowID InID, UMaterialInstance* InMaterialInstance);
...
protected:
	 ...
	 *
	 */
	void SetPreviewMaterial(UMaterialInstance* InMaterialInstance);
