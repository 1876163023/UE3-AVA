...
private:
	...
	void OnShowAmbientcubes( wxCommandEvent& In );

	//<@ ava specific ; 2007. 1.8 changmin
	void OnShowSamples( wxCommandEvent& In );
	void OnShowLeafColors( wxCommandEvent& In );
	void OnShowSolidBspOnly( wxCommandEvent& In );
	//>@ ava
