...
public:
	...
	UBOOL DrawOpenEdges;
	UINT NumTriangles, NumOpenEdges, NumDoubleSidedShadowTriangles, NumUVChannels;
...
private:
	...
	void UI_ShowRadiosityGeometry( wxUpdateUIEvent& In );
	void OnShowRadiosityGeometry( wxCommandEvent& In );
	void OnGenerateLightmapCoords( wxCommandEvent& In );
	void OnRemoveRadiosityGeometry( wxCommandEvent &In );
	//<@ ava
