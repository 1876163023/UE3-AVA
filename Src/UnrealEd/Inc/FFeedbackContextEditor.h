...
public:
	 ...
	 */
	virtual void MapCheck_Add(MapCheckType InType, void* InActor, const TCHAR* InMessage, MapCheckAction InRecommendedAction=MCACTION_NONE, const TCHAR* InUDNPage=TEXT(""));
