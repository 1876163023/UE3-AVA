...
public:
    ...
    NO_DEFAULT_CONSTRUCTOR(UMaterialEditorMeshComponent)
};
...
class UGenericBrowserType_DSPPreset : public UGenericBrowserType
{
public:
    //## BEGIN PROPS GenericBrowserType_DSPPreset
    //## END PROPS GenericBrowserType_DSPPreset

    DECLARE_CLASS(UGenericBrowserType_DSPPreset,UGenericBrowserType,0,UnrealEd)
	virtual void Init();
	virtual UBOOL ShowObjectEditor( UObject* InObject );	
	virtual void DoubleClick( UObject* InObject );
};
...
{
public:
    //## BEGIN PROPS GenericBrowserType_MaterialInstance
    //## END PROPS GenericBrowserType_MaterialInstance
...
class UGenericBrowserType_ReverbProperty : public UGenericBrowserType
{
public:
    //## BEGIN PROPS GenericBrowserType_ReverbProperty
    //## END PROPS GenericBrowserType_ReverbProperty

    DECLARE_CLASS(UGenericBrowserType_ReverbProperty,UGenericBrowserType,0,UnrealEd)
	virtual void Init();
	virtual UBOOL ShowObjectEditor( UObject* InObject );	
	virtual void DoubleClick( UObject* InObject );
};
...
class UGenericBrowserType_UIAnimation : public UGenericBrowserType
{
public:
    //## BEGIN PROPS GenericBrowserType_UIAnimation
    //## END PROPS GenericBrowserType_UIAnimation

    DECLARE_CLASS(UGenericBrowserType_UIAnimation,UGenericBrowserType,0,UnrealEd)
	virtual void Init();
	virtual UBOOL ShowObjectEditor( UObject* InObject );
};
...
class UInterpTrackRotatorPropHelper : public UInterpTrackHelper
{
public:
    //## BEGIN PROPS InterpTrackRotatorPropHelper
    //## END PROPS InterpTrackRotatorPropHelper

    DECLARE_CLASS(UInterpTrackRotatorPropHelper,UInterpTrackHelper,0,UnrealEd)
	/** Checks track-dependent criteria prior to adding a new track.
	* Responsible for any message-boxes or dialogs for selecting track-specific parameters.
	* Called on default object.
	*
...
class UMaterialEditorInstance : public UObject
{
public:
    //## BEGIN PROPS MaterialEditorInstance
    ...
    //## END PROPS MaterialEditorInstance

    DECLARE_CLASS(UMaterialEditorInstance,UObject,0,UnrealEd)
	// UObject interface.
...
public:
    ...
    DECLARE_CLASS(UEditorUISceneClient,UUISceneClient,0|CLASS_Transient|CLASS_Config,UnrealEd)
	/* =======================================
...
DECLARE_NATIVE_TYPE(UnrealEd,UGenericBrowserType_DSPPreset);
...
DECLARE_NATIVE_TYPE(UnrealEd,UGenericBrowserType_ReverbProperty);
...
DECLARE_NATIVE_TYPE(UnrealEd,UGenericBrowserType_UIAnimation);
...
DECLARE_NATIVE_TYPE(UnrealEd,UInterpTrackRotatorPropHelper);
...
DECLARE_NATIVE_TYPE(UnrealEd,UMaterialEditorInstance);
...
#define AUTO_INITIALIZE_REGISTRANTS_UNREALED \
	...
	UGenericBrowserType_DSPPreset::StaticClass(); \
	...
	UGenericBrowserType_ReverbProperty::StaticClass(); \
	...
	UGenericBrowserType_UIAnimation::StaticClass(); \
	...
	UInterpTrackRotatorPropHelper::StaticClass(); \
	...
	UMaterialEditorInstance::StaticClass(); \
...
VERIFY_CLASS_SIZE_NODIE(UGenericBrowserType_DSPPreset)
...
VERIFY_CLASS_SIZE_NODIE(UGenericBrowserType_ReverbProperty)
...
VERIFY_CLASS_SIZE_NODIE(UGenericBrowserType_UIAnimation)
...
VERIFY_CLASS_SIZE_NODIE(UInterpTrackRotatorPropHelper)
...
VERIFY_CLASS_OFFSET_NODIE(U,MaterialEditorInstance,PhysMaterial)
VERIFY_CLASS_OFFSET_NODIE(U,MaterialEditorInstance,BrightnessColor)
VERIFY_CLASS_SIZE_NODIE(UMaterialEditorInstance)
...
VERIFY_CLASS_OFFSET_NODIE(U,ThumbnailManager,ThumbnailBackground)
