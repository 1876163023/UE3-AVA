...
struct FPhATViewportClient: public FEditorLevelViewportClient
{
	...
	ULineBatchComponent*		LineBatcher; // used by novodex to draw debug visualization info
...
/*-----------------------------------------------------------------------------
	WxPhAT
-----------------------------------------------------------------------------*/
class WxPhAT : public wxFrame, public FNotifyHook, public FSerializableObject, public FDockingParent
{
public:
	...
	*/
	...
	void DrawConstraint(INT ConstraintIndex, FLOAT Scale, FPrimitiveDrawInterface* PDI, UBOOL bDrawAsPoint);
