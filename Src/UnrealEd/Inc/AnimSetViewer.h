...
public:
	...
	//! Extra Mesh 3개 추가.
	USkeletalMeshComponent*	PreviewSkelCompAux4;
	USkeletalMeshComponent*	PreviewSkelCompAux5;
	USkeletalMeshComponent*	PreviewSkelCompAux6;
	...
	//! Extra Mesh 3개 추가(Combo).
	wxComboBox*				SkelMeshAux4Combo;
	wxComboBox*				SkelMeshAux5Combo;
	wxComboBox*				SkelMeshAux6Combo;
