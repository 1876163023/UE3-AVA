...
public:
	...
	void	SetupBlock(ETerrainLayerType InType, INT InArrayIndex, 
				...
				FTerrainFoliageMesh* InFoliageMesh,
	...
	FTerrainFoliageMesh*		GetFoliageMesh()		{	return FoliageMesh;			}
...
protected:
	...
	union
	{
		...
		FTerrainFoliageMesh*		FoliageMesh;
...
public:
	...
	enum NewOptions
	{
		...
		/** NewFoliage		- put the 'New Foliage' option in the menu		*/
		OPT_NEWFOLIAGE				= 0x00000004,
		...
		/** NewFoliage		- put the 'New Foliage' option in the menu		*/
		OPT_NEWFOLIAGE_BEFORE		= 0x00000080,
		/** NewDecoLayer	- put the 'New DecoLayer' option in the menu	*/
		...
		/** NewMaterial		- put the 'New Material' option in the menu		*/
		OPT_NEWMATERIAL_AFTER		= 0x00001000,
		/** NewFoliage		- put the 'New Foliage' option in the menu		*/
		OPT_NEWFOLIAGE_AFTER		= 0x00002000,
		/** NewDecoLayer	- put the 'New DecoLayer' option in the menu	*/
		OPT_NEWDECOLAYER_AFTER		= 0x00004000,
		/** NewDecoration	- put the 'New Decoration' option in the menu	*/
		OPT_NEWDECORATION_AFTER		= 0x00008000,
	};
	...
	enum AddOptions
	{
		...
		/** AddSelectedFoliage												*/
		OPT_ADDSELECTED_FOLIAGE_BEFORE		= 0x00001000,
		OPT_ADDSELECTED_FOLIAGE				= 0x00002000,
		OPT_ADDSELECTED_FOLIAGE_AFTER		= 0x00004000,
...
public:
	...
	UTexture2D*	GetFoliageIcon()			{	return FoliageIcon;				}
	UTexture2D*	GetHeightMapIcon()			{	return HeightMapIcon;			}
	UTexture2D*	GetProceduralOverlayIcon()	{	return ProceduralOverlayIcon;	}
	UTexture2D*	GetFoliageOverlayIcon()		{	return FoliageOverlayIcon;		}
	UTexture2D*	GetFoliageOverlay2Icon()	{	return FoliageOverlayIcon2;		}
...
protected:
	...
	UTexture2D*				FoliageIcon;
	UTexture2D*				HeightMapIcon;
	UTexture2D*				ProceduralOverlayIcon;
	UTexture2D*				FoliageOverlayIcon;
	UTexture2D*				FoliageOverlayIcon2;
};
...
protected:
	...
	struct FColorSwatchInfo : public WxButtonCollection
	{
		FColor		Color;
		wxImage*	Image;
	};

	struct FSliderComboCollection
	{
		wxStaticText*		Label;
		wxSlider*			Slider;
		wxComboBox*			Combo;
	...
	UBOOL							bTerrainSolidOverlayActive;
	FColor							TerrainSolidColor;
	UBOOL							bTerrainWireOverlayActive;
	FColor							TerrainWireColor;
	...
	wxStaticText*			ViewSettingsSolidLabel;
	WxButtonCollection		ViewSettingsSolid;
...
public:
	...
	/**
	 *	Return the selected 'child' block (terrain material, foliage, decoration)
	 */
...
protected:
	 ...
	 *	@param	In	wxCommandEvent 
	 */
	void		OnTerrainSolid(wxCommandEvent& In);
	/**
	 ...
	 *	@param	In	wxCommandEvent 
	 */
	void		OnSettingsColorButton(wxCommandEvent& In);
	/**
	 ...
	 *	@param	In	wxCommandEvent 
	 */
	void		OnSettingsCombo(wxCommandEvent& In);
	/**
	 *	Called when a Settings combo text is edited
	 *
	 *	@param	In	wxCommandEvent 
	 */
	void		OnSettingsComboText(wxCommandEvent& In);
	/**
	 ...
	 *	@param	In	wxCommandEvent
	 */
	void		OnNewFoliage(wxCommandEvent& In);
	/**
	 ...
	 *	@param	In	wxCommandEvent
	 */
	void		OnAddSelectedFoliage(wxCommandEvent& In);
	/**
	 ...
	 *			FALSE			if failed
	 */
	UBOOL CreateNewItem(ETerrainLayerType eType, FString& ObjectName, void*& CreatedItem, UBOOL bPrompt = TRUE);
	 ...
	 */
	UTerrainLayerSetup* CreateNewLayer(FString& ObjectName, UBOOL bPrompt = TRUE);
	 ...
	 */
	UTerrainMaterial* CreateNewTerrainMaterial(FString& ObjectName, UBOOL bPrompt = TRUE);
...
public:
	...
	UBOOL							GetShowFoliageMeshes()			{	return bShowFoliageMeshes;		}
