...
public:
	...
	UStaticMeshComponent*		BackgroundCube;
	UMaterialInstanceConstant*	BackgroundMatInst;
...
protected:
	UMaterial*		IconMatRenderNormal;
	UMaterial*		IconMatRenderCross;
	UMaterial*		IconMatRenderPoint;
	UMaterial*		IconMatRenderNone;
	UMaterial*		IconMatCurveEdit;
	UMaterial*		IconMat3DDrawEnabled;
	UMaterial*		IconMat3DDrawDisabled;
	UMaterial*		IconMatModuleEnabled;
	UMaterial*		IconMatModuleDisabled;
...
public:
	...
	FMaterialInstance*	GetIcon(Icons eIcon);
	FMaterialInstance*	GetModuleDisabledBackground();
...
public:
	enum Mode
	{
		...
		EVERYTHING			= EMITTER_ONLY | SELECTEDMODULE_ONLY | TYPEDATAS_ONLY | SPAWNS_ONLY | UPDATES_ONLY
	};
