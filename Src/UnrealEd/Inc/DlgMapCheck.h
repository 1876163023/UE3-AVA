...
public:
	 ...
	 */
	void AddItem(MapCheckType InType, AActor* InActor, const TCHAR* InMessage, MapCheckAction InRecommendedAction, const TCHAR* InUDNPage=TEXT(""));
...
protected:
	...
	TArray<FErrorWarningInfo>	ErrorWarningInfoList;
