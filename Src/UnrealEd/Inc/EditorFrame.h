...
private:
	...
	*/
	...
	void MenuBuildPlayInEditor_MannedPrecomputing( wxCommandEvent& In );
	void MenuBakeEnvCubes( wxCommandEvent& In );
	...
	void MenuPlayFromHereInEditor_Precompute( wxCommandEvent& In );
	...
	void PushViewStart(wxCommandEvent& In);
	void PushViewStop(wxCommandEvent& In);
