/*=============================================================================
	...
	Copyright 梢2005-2006 Epic Games, Inc. All Rights Reserved.
=============================================================================*/
...
public:
	...
	/**
	 * list of avaiable "containers" for generating a root set to be used by the "in-use" filtering
	 */
...
private:
	...
	*/
	...
	void SetAsCompressedSamples(UBOOL bCompressedSample);
	...
	*/
	...
	void OnSetAsCompressedSamples(wxCommandEvent& InEvent);
	void OnSetAsUncompressedSamples(wxCommandEvent& InEvent);
	...
	/**
	 * Event handler for "Set Package..." context menu option
	 */
...
public:
	...
	*/
	 ...
	 */
	void ImportFiles( const wxArrayString& InFiles, const TArray<UFactory*> &InFactories );
...
private:
	...
	void OnCheckTrashcan( wxCommandEvent& In );			/** 2007/01/03 윤태식, Trashcan내에 패키지를 사용중인지 체크 */
	...
	void OnObjectEditNodes(wxCommandEvent& In);
	void OnObjectCustomCommand( wxCommandEvent& In );

	//<@ ava specific ; 2007. 8. 24 changmin
	void Ava_OnSelectSurfaceMatchingSelectedMaterial( wxCommandEvent& In );
	//>@ ava
