...
void (UObject::*GNatives[EX_Max]) _ParamList_ScriptFunctionImpl; // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL );
INT GNativeDuplicate=0;

void (UObject::*GCasts[CST_Max]) _ParamList_ScriptFunctionImpl; // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL );
...
//! for debugging.
static UBOOL GScriptBreak=FALSE;
static void DumpScriptCallStack(const TCHAR *pStackTrace = NULL);
#endif
...
void UObject::execDebugInfo _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL ) //DEBUGGER
{
...
void UObject::execUndefined _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execLocalVariable _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{	
	...
	if(pPropertyLefthand && pPropAddrLefthand && GProperty && GPropAddr && ((pPropertyLefthand->PropertyFlags & CPF_Cipher) || (GProperty->PropertyFlags & CPF_Cipher))) {
		BYTE value  = 0;
		if(GProperty->PropertyFlags & CPF_Cipher) {
			value = ((CipherByte*)GPropAddr)->decrypt();
		}
		else {
			value = *(BYTE*)GPropAddr;
		}

		if(pPropertyLefthand->PropertyFlags & CPF_Cipher) {
			((CipherByte*)pPropAddrLefthand)->encrypt(value);
		}
		else {
			*(BYTE*)pPropAddrLefthand = value;
		}		
		return;
	}
	#endif
...
void UObject::execInstanceVariable _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	GProperty = (UProperty*)Stack.ReadObject();
...
void UObject::execDefaultVariable _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	GProperty = (UProperty*)Stack.ReadObject();
...
void UObject::execLocalOutVariable _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // (FFrame& Stack, RESULT_DECL )
{
	checkSlow(Stack.Object == this);
...
void UObject::execDefaultParmValue _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	checkSlow(Stack.Object==this);
...
void UObject::execInterfaceContext _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execClassContext _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execArrayElement _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execDynArrayElement _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	// Get array index expression.
	INT Index=0;
	Stack.Step( Stack.Object, &Index );
...
void UObject::execDynArrayLength _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	GProperty = NULL;
	Stack.Step( this, NULL );
	GPropObject = this;
...
void UObject::execDynArrayInsert _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	GPropObject = this;
	GProperty = NULL;
	Stack.Step( this, NULL );
...
void UObject::execDynArrayAdd _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{	
	GProperty = NULL;
	GPropObject = this;
	Stack.Step( this, NULL );
...
void UObject::execDynArrayAddItem _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{	
	GProperty = NULL;
	GPropObject = this;
	Stack.Step( this, NULL );
...
void UObject::execDynArrayInsertItem _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{	
	GProperty = NULL;
	GPropObject = this;
	Stack.Step( this, NULL );
...
void UObject::execDynArrayRemoveItem _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	GProperty = NULL;
	GPropObject = this;
	Stack.Step( this, NULL );
...
void UObject::execDynArrayRemove _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{	
	GProperty = NULL;
	GPropObject = this;
	Stack.Step( this, NULL );
...
void UObject::execDynArrayFind _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execDynArrayFindStruct _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	// the script compiler doesn't allow calling Find on a dynamic array unless it's being assigned to something, so we should _always_ have a Result buffer
	checkSlow(Result);
...
void UObject::execBoolVariable _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{ 
	// Get bool variable.
	BYTE B = *Stack.Code++;
	...
	#ifdef EnableCipherData
	(this->*GNatives[B])( Stack, NULL, 0x0, 0x0 );
	#else
...
void UObject::execStructMember _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execEndOfScript _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execNothing _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	// Do nothing.
}
...
void UObject::execReturnNothing _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
 ...
 */
void UObject::execIteratorPop _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	// Do nothing
}
IMPLEMENT_FUNCTION( UObject, EX_IteratorPop, execIteratorPop );

void UObject::execEmptyParmValue _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execNativeParm _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	UProperty* Property = (UProperty*)Stack.ReadObject();
	if( Result )
	{
...
void UObject::execEndFunctionParms _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execStop _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	Stack.Code = NULL;
}
...
void UObject::execSwitch _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	// Get switch size.
	BYTE bSize = *Stack.Code++;
...
void UObject::execCase _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	INT wNext = Stack.ReadWord();
	if( wNext != MAXWORD )
	{
...
void UObject::execJump _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	CHECK_RUNAWAY;
...
void UObject::execJumpIfNot _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	CHECK_RUNAWAY;
...
void UObject::execConditional _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	// Get test expression
	UBOOL CondValue = 0;
...
void UObject::execAssert _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	// Get line number.
...
void UObject::execGotoLabel _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	CHECK_RUNAWAY;
...
void UObject::execLet _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	...
	if (GRuntimeUCFlags & RUC_ArrayLengthSet)
	{
		...
		#ifdef EnableCipherData
		Stack.Step( Stack.Object, GPropAddr, GProperty, GPropAddr ); // Evaluate expression into variable.
		#else
...
void UObject::execLetBool _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	GPropAddr = NULL;
	GProperty = NULL;
	GPropObject = NULL;
...
void UObject::execSelf _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execContext _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	// Get object variable.
...
void UObject::execVirtualFunction _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execFinalFunction _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execGlobalFunction _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execDelegateFunction _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execDelegateProperty _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execLetDelegate _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	// Get variable address.
	GPropAddr = NULL;
	GProperty = NULL;
...
void UObject::execStructCmpEq _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	UStruct* Struct  = (UStruct*)Stack.ReadObject();
	checkSlow(Struct);
...
void UObject::execStructCmpNe _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	UStruct* Struct = (UStruct*)Stack.ReadObject();
	checkSlow(Struct);
...
void UObject::execIntConst _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	*(INT*)Result = Stack.ReadInt();
}
IMPLEMENT_FUNCTION( UObject, EX_IntConst, execIntConst );

void UObject::execFloatConst _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	*(FLOAT*)Result = Stack.ReadFloat();
}
IMPLEMENT_FUNCTION( UObject, EX_FloatConst, execFloatConst );

void UObject::execStringConst _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execUnicodeStringConst _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
#if XBOX
...
void UObject::execObjectConst _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	*(UObject**)Result = (UObject*)Stack.ReadObject();
}
IMPLEMENT_FUNCTION( UObject, EX_ObjectConst, execObjectConst );

void UObject::execNameConst _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	*(FName*)Result = Stack.ReadName();
}
IMPLEMENT_FUNCTION( UObject, EX_NameConst, execNameConst );

void UObject::execByteConst _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	*(BYTE*)Result = *Stack.Code++;

	// {{ 20080222 dEAthcURe|CD
	#ifdef EnableCipherData
	if(pPropertyLefthand && pPropAddrLefthand && pPropertyLefthand->PropertyFlags & CPF_Cipher) {
		BYTE val = *(BYTE*)Result;
		((CipherByte*)Result)->encrypt(val);		
	}
	#endif
	// }} 20080222 dEAthcURe|CD
}
...
void UObject::execIntZero _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	*(INT*)Result = 0;
}
IMPLEMENT_FUNCTION( UObject, EX_IntZero, execIntZero );

void UObject::execIntOne _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	*(INT*)Result = 1;
}
IMPLEMENT_FUNCTION( UObject, EX_IntOne, execIntOne );

void UObject::execTrue _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	*(INT*)Result = 1;
}
IMPLEMENT_FUNCTION( UObject, EX_True, execTrue );

void UObject::execFalse _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	*(DWORD*)Result = 0;
}
IMPLEMENT_FUNCTION( UObject, EX_False, execFalse );

void UObject::execNoObject _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	*(UObject**)Result = NULL;
}
IMPLEMENT_FUNCTION( UObject, EX_NoObject, execNoObject );

void UObject::execIntConstByte _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execDynamicCast _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execMetaCast _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execPrimitiveCast _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	INT B = *(Stack.Code)++;
	#ifdef EnableCipherData
	(Stack.Object->*GCasts[B])( Stack, Result, pPropertyLefthand, pPropAddrLefthand );
	#else
...
void UObject::execInterfaceCast _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	#ifdef EnableCipherData
	(Stack.Object->*GCasts[CST_ObjectToInterface])(Stack, Result, 0x0, 0x0);
	#else
...
void UObject::execByteToInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	UProperty* pPrevProperty = GProperty;
	BYTE* pPrevPropAddr = GPropAddr;
	BYTE B=0;
...
void UObject::execByteToBool _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	BYTE B=0;
	Stack.Step( Stack.Object, &B );
	*(DWORD*)Result = B ? 1 : 0;
...
void UObject::execByteToFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	BYTE B=0;
	Stack.Step( Stack.Object, &B );
	*(FLOAT*)Result = B;
...
void UObject::execByteToString _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_BYTE(B);
...
void UObject::execIntToByte _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{	
	INT I=0;
	Stack.Step( Stack.Object, &I );	
	*(BYTE*)Result = I;

	// {{ 20080219 dEAthcURe|CD
	#ifdef EnableCipherData
	if(pPropertyLefthand && pPropertyLefthand->PropertyFlags & CPF_Cipher) {
		((CipherByte*)Result)->encrypt(I);		
	}	
	#endif
	// }} 20080219 dEAthcURe|CD
}
...
void UObject::execIntToBool _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	INT I=0;
	Stack.Step( Stack.Object, &I );
	*(INT*)Result = I ? 1 : 0;
...
void UObject::execIntToFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	INT I=0;
	Stack.Step( Stack.Object, &I );
	*(FLOAT*)Result = I;
...
void UObject::execIntToString _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(I);
...
void UObject::execBoolToByte _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	UBOOL B=0;
	Stack.Step( Stack.Object, &B );
	*(BYTE*)Result = B & 1;
	...
	if(pPropertyLefthand && pPropertyLefthand->PropertyFlags & CPF_Cipher) {
		BYTE value = B & 1;		
		((CipherByte*)Result)->encrypt(value);		
	}
	#endif
	// }} 20080219 dEAthcURe|CD
}
...
void UObject::execBoolToInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	UBOOL B=0;
	Stack.Step( Stack.Object, &B );
	*(INT*)Result = B & 1;
...
void UObject::execBoolToFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	UBOOL B=0;
	Stack.Step( Stack.Object, &B );
	*(FLOAT*)Result = B & 1;
...
void UObject::execBoolToString _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_UBOOL(B);
...
void UObject::execFloatToByte _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	FLOAT F=0.f;
...
void UObject::execFloatToInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	FLOAT F=0.f;
	Stack.Step( Stack.Object, &F );
...
void UObject::execFloatToBool _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	FLOAT F=0.f;
	Stack.Step( Stack.Object, &F );
...
void UObject::execFloatToString _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(F);
...
void UObject::execObjectToBool _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	UObject* Obj=NULL;
...
void UObject::execObjectToInterface _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execObjectToString _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execInterfaceToString _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execInterfaceToBool _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INTERFACE(InterfaceValue);
...
void UObject::execInterfaceToObject _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INTERFACE(InterfaceValue);
	*(UObject**)Result=InterfaceValue.GetObject();
}
...
void UObject::execNameToBool _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	FName N=NAME_None;
...
void UObject::execNameToString _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_NAME(N);
...
void UObject::execStringToName _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(String);
...
void UObject::execStringToByte _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(Str);
...
void UObject::execStringToInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(Str);
...
void UObject::execStringToBool _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(Str);
...
void UObject::execStringToFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(Str);
...
void UObject::execNot_PreBool _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_UBOOL(A);
	P_FINISH;
...
void UObject::execEqualEqual_BoolBool _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_UBOOL(A);
	P_GET_UBOOL(B);
	P_FINISH;
...
void UObject::execNotEqual_BoolBool _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_UBOOL(A);
	P_GET_UBOOL(B);
	P_FINISH;
...
void UObject::execAndAnd_BoolBool _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_UBOOL(A);
	P_GET_SKIP_OFFSET(W);
...
void UObject::execXorXor_BoolBool _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_UBOOL(A);
	P_GET_UBOOL(B);
	P_FINISH;
...
void UObject::execOrOr_BoolBool _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_UBOOL(A);
	P_GET_SKIP_OFFSET(W);
	if( !A )
...
void UObject::execMultiplyEqual_ByteByte _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	#ifdef EnableCipherData // 계산결과 검증필요
	P_GET_BYTE_REF(A);
	UProperty* pPropertyA = GProperty;
	P_GET_BYTE(B);
	UProperty* pPropertyB = GProperty;
	BYTE* pB = GPropAddr;
	P_FINISH;

	BYTE aVal = A;
	if(pA && (pPropertyA->PropertyFlags & CPF_Cipher)) {
		aVal = ((CipherByte*)pA)->decrypt();
	};
	BYTE bVal = B;
	if(pB && (pPropertyB->PropertyFlags & CPF_Cipher)) {
		bVal = ((CipherByte*)pB)->decrypt();
	};
	BYTE rVal = aVal * bVal;
	A = rVal;
	if(pA && (pPropertyA->PropertyFlags & CPF_Cipher)) {
		((CipherByte*)pA)->encrypt(rVal);
	}
	*(BYTE*)Result = rVal;
	#else
	P_GET_BYTE_REF(A);
...
void UObject::execMultiplyEqual_ByteFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	#ifdef EnableCipherData // 계산결과 검증필요
	P_GET_BYTE_REF(A);
	UProperty* pPropertyA = GProperty;
	...
	BYTE rVal = BYTE(appTrunc(aVal * B));	
	A = rVal;	
	if(pA && (pPropertyA->PropertyFlags & CPF_Cipher)) {
		((CipherByte*)pA)->encrypt(rVal);
	}
...
void UObject::execDivideEqual_ByteByte _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	#ifdef EnableCipherData // 계산결과 검증필요
	P_GET_BYTE_REF(A);
	UProperty* pPropertyA = GProperty;	
...
void UObject::execAddEqual_ByteByte _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	#ifdef EnableCipherData // 계산결과 검증필요
	P_GET_BYTE_REF(A);
	UProperty* pPropertyA = GProperty;	
...
void UObject::execSubtractEqual_ByteByte _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	#ifdef EnableCipherData // 계산결과 검증필요
	P_GET_BYTE_REF(A);
	UProperty* pPropertyA = GProperty;	
...
void UObject::execAddAdd_PreByte _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_BYTE_REF(A);
	P_FINISH;
	...
	// {{ 20080219 dEAthcURe|CD
	#ifdef EnableCipherData
	if((GProperty->PropertyFlags & CPF_Cipher) && GPropAddr) {
		CipherByte* pByte = (CipherByte*)GPropAddr;
		BYTE value = pByte->decrypt();
		value++;
		*(BYTE*)Result = value;
		pByte->encrypt(value);
	}
...
void UObject::execSubtractSubtract_PreByte _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_BYTE_REF(A);
	P_FINISH;
...
void UObject::execAddAdd_Byte _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_BYTE_REF(A);
	P_FINISH;
...
void UObject::execSubtractSubtract_Byte _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_BYTE_REF(A);
	P_FINISH;
...
void UObject::execComplement_PreInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_FINISH;
...
void UObject::execGreaterGreaterGreater_IntInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_GET_INT(B);
	P_FINISH;
...
void UObject::execSubtract_PreInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_FINISH;
...
void UObject::execMultiply_IntInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_GET_INT(B);
	P_FINISH;
...
void UObject::execDivide_IntInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_GET_INT(B);
	P_FINISH;
...
void UObject::execAdd_IntInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_GET_INT(B);
	P_FINISH;
...
void UObject::execSubtract_IntInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_GET_INT(B);
	P_FINISH;
...
void UObject::execLessLess_IntInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_GET_INT(B);
	P_FINISH;
...
void UObject::execGreaterGreater_IntInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_GET_INT(B);
	P_FINISH;
...
void UObject::execLess_IntInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_GET_INT(B);
	P_FINISH;
...
void UObject::execGreater_IntInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);	
	P_GET_INT(B);	
	P_FINISH;	
...
void UObject::execLessEqual_IntInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_GET_INT(B);
	P_FINISH;
...
void UObject::execGreaterEqual_IntInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_GET_INT(B);
	P_FINISH;
...
void UObject::execEqualEqual_IntInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{	
	P_GET_INT(A);	
	P_GET_INT(B);	
	P_FINISH;
...
void UObject::execNotEqual_IntInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_GET_INT(B);
	P_FINISH;
...
void UObject::execAnd_IntInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_GET_INT(B);
	P_FINISH;
...
void UObject::execXor_IntInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_GET_INT(B);
	P_FINISH;
...
void UObject::execOr_IntInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_GET_INT(B);
	P_FINISH;
...
void UObject::execMultiplyEqual_IntFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT_REF(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execDivideEqual_IntFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT_REF(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execAddEqual_IntInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT_REF(A);
	P_GET_INT(B);
	P_FINISH;
...
void UObject::execSubtractEqual_IntInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT_REF(A);
	P_GET_INT(B);
	P_FINISH;
...
void UObject::execAddAdd_PreInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT_REF(A);
	P_FINISH;
...
void UObject::execSubtractSubtract_PreInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT_REF(A);
	P_FINISH;
...
void UObject::execAddAdd_Int _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT_REF(A);
	P_FINISH;
...
void UObject::execSubtractSubtract_Int _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT_REF(A);
	P_FINISH;
...
void UObject::execRand _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_FINISH;

	*(INT*)Result = appTrunc(appRand()/(FLOAT)((UINT)RAND_MAX+1) * A);
}
IMPLEMENT_FUNCTION( UObject, 167, execRand );

void UObject::execMin _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_GET_INT(B);
	P_FINISH;
...
void UObject::execMax _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_GET_INT(B);
	P_FINISH;
...
void UObject::execClamp _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(V);
	P_GET_INT(A);
	P_GET_INT(B);
...
void UObject::execToHex _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(A);
	P_FINISH;
...
void UObject::execSubtract_PreFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_FINISH;
...
void UObject::execMultiplyMultiply_FloatFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execMultiply_FloatFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execDivide_FloatFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execPercent_FloatFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execAdd_FloatFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execSubtract_FloatFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execLess_FloatFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execGreater_FloatFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execLessEqual_FloatFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execGreaterEqual_FloatFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execEqualEqual_FloatFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execNotEqual_FloatFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execComplementEqual_FloatFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execMultiplyEqual_FloatFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT_REF(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execDivideEqual_FloatFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT_REF(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execAddEqual_FloatFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT_REF(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execSubtractEqual_FloatFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT_REF(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execAbs _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_FINISH;
...
void UObject::execSin _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_FINISH;
...
void UObject::execAsin _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_FINISH;
...
void UObject::execCos _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_FINISH;
...
void UObject::execAcos _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_FINISH;
...
void UObject::execTan _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_FINISH;
...
void UObject::execAtan _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
    P_GET_FLOAT(B); //amb
	P_FINISH;
...
void UObject::execExp _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_FINISH;
...
void UObject::execLoge _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_FINISH;
...
void UObject::execSqrt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_FINISH;
...
void UObject::execSquare _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_FINISH;
...
void UObject::execFRand _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_FINISH;
...
void UObject::execFMin _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execFMax _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execFClamp _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(V);
	P_GET_FLOAT(A);
	P_GET_FLOAT(B);
...
void UObject::execLerp _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_GET_FLOAT(B);
	P_GET_FLOAT(V);
...
void UObject::execFCubicInterp _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(P0);
	P_GET_FLOAT(T0);
	P_GET_FLOAT(P1);
...
void UObject::execFInterpTo _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(Current);
	P_GET_FLOAT(Target);
...
void UObject::execRotationConst _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execVectorConst _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execPointDistToLine _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(Point);
	P_GET_VECTOR(Line);
	P_GET_VECTOR(Origin);
...
void UObject::execGetDotDistance _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execGetAngularDistance _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execGetAngularFromDotDist _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execStringToVector _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(Str);
...
void UObject::execStringToRotator _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(Str);
...
void UObject::execVectorToBool _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	FVector V(0,0,0);
...
void UObject::execVectorToString _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(V);
...
void UObject::execVectorToRotator _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	FVector V(0,0,0);
	Stack.Step( Stack.Object, &V );
...
void UObject::execRotatorToBool _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	FRotator R(0,0,0);
...
void UObject::execRotatorToVector _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	FRotator R(0,0,0);
	Stack.Step( Stack.Object, &R );
...
void UObject::execRotatorToString _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_ROTATOR(R);
...
void UObject::execSubtract_PreVector _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_FINISH;
...
void UObject::execMultiply_VectorFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_GET_FLOAT (B);
	P_FINISH;
...
void UObject::execMultiply_FloatVector _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT (A);
	P_GET_VECTOR(B);
	P_FINISH;
...
void UObject::execMultiply_VectorVector _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_GET_VECTOR(B);
	P_FINISH;
...
void UObject::execDivide_VectorFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_GET_FLOAT (B);
	P_FINISH;
...
void UObject::execAdd_VectorVector _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_GET_VECTOR(B);
	P_FINISH;
...
void UObject::execSubtract_VectorVector _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_GET_VECTOR(B);
	P_FINISH;
...
void UObject::execLessLess_VectorRotator _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_GET_ROTATOR(B);
	P_FINISH;
...
void UObject::execGreaterGreater_VectorRotator _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_GET_ROTATOR(B);
	P_FINISH;
...
void UObject::execEqualEqual_VectorVector _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_GET_VECTOR(B);
	P_FINISH;
...
void UObject::execNotEqual_VectorVector _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_GET_VECTOR(B);
	P_FINISH;
...
void UObject::execDot_VectorVector _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_GET_VECTOR(B);
	P_FINISH;
...
void UObject::execCross_VectorVector _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_GET_VECTOR(B);
	P_FINISH;
...
void UObject::execMultiplyEqual_VectorFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR_REF(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execMultiplyEqual_VectorVector _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR_REF(A);
	P_GET_VECTOR(B);
	P_FINISH;
...
void UObject::execDivideEqual_VectorFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR_REF(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execAddEqual_VectorVector _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR_REF(A);
	P_GET_VECTOR(B);
	P_FINISH;
...
void UObject::execSubtractEqual_VectorVector _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR_REF(A);
	P_GET_VECTOR(B);
	P_FINISH;
...
void UObject::execVSize _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_FINISH;
...
void UObject::execVSize2D _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_FINISH;
...
void UObject::execVSizeSq _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_FINISH;
...
void UObject::execVSizeSq2D _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_FINISH;
...
void UObject::execNormal _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_FINISH;
...
void UObject::execVLerp _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_GET_VECTOR(B);
	P_GET_FLOAT(V);
...
void UObject::execVSmerp _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_GET_VECTOR(B);
	P_GET_FLOAT(V);
...
void UObject::execVInterpTo _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execVRand _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_FINISH;
...
void UObject::execRotRand _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execMirrorVectorByNormal _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_GET_VECTOR(B);
	P_FINISH;
...
// ================================================================
void UObject::execProjectOnTo _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR( X );
	P_GET_VECTOR( Y );
	P_FINISH;
...
//	Last Modified: 03/06/04 (superville)
// ================================================================
void UObject::execIsZero _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_FINISH;
...
void UObject::execEqualEqual_RotatorRotator _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_ROTATOR(A);
	P_GET_ROTATOR(B);
	P_FINISH;
...
void UObject::execNotEqual_RotatorRotator _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_ROTATOR(A);
	P_GET_ROTATOR(B);
	P_FINISH;
...
void UObject::execMultiply_RotatorFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_ROTATOR(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execMultiply_FloatRotator _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_FLOAT(A);
	P_GET_ROTATOR(B);
	P_FINISH;
...
void UObject::execDivide_RotatorFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_ROTATOR(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execMultiplyEqual_RotatorFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_ROTATOR_REF(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execDivideEqual_RotatorFloat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_ROTATOR_REF(A);
	P_GET_FLOAT(B);
	P_FINISH;
...
void UObject::execAdd_RotatorRotator _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_ROTATOR(A);
	P_GET_ROTATOR(B);
	P_FINISH;
...
void UObject::execSubtract_RotatorRotator _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_ROTATOR(A);
	P_GET_ROTATOR(B);
	P_FINISH;
...
void UObject::execAddEqual_RotatorRotator _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_ROTATOR_REF(A);
	P_GET_ROTATOR(B);
	P_FINISH;
...
void UObject::execSubtractEqual_RotatorRotator _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_ROTATOR_REF(A);
	P_GET_ROTATOR(B);
	P_FINISH;
...
void UObject::execGetAxes _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_ROTATOR(A);
	P_GET_VECTOR_REF(X);
	P_GET_VECTOR_REF(Y);
...
void UObject::execGetUnAxes _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_ROTATOR(A);
	P_GET_VECTOR_REF(X);
	P_GET_VECTOR_REF(Y);
...
void UObject::execOrthoRotation _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(X);
	P_GET_VECTOR(Y);
	P_GET_VECTOR(Z);
...
void UObject::execNormalize _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_ROTATOR(Rot);
	P_FINISH;
...
void UObject::execRLerp _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_ROTATOR(A);
	P_GET_ROTATOR(B);
	P_GET_FLOAT(Alpha);
...
void UObject::execRSmerp _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_ROTATOR(A);
	P_GET_ROTATOR(B);
	P_GET_FLOAT(Alpha);
...
void UObject::execRInterpTo _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execNormalizeRotAxis _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(Angle);
	P_FINISH;
...
void UObject::execRDiff _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_ROTATOR(A);
	P_GET_ROTATOR(B);
	P_FINISH;
...
void UObject::execClockwiseFrom_IntInt _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(IntA);
	P_GET_INT(IntB);
	P_FINISH;
...
void UObject::execQuatProduct _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execQuatDot _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STRUCT(FQuat, A);
	P_GET_STRUCT(FQuat, B);
	P_FINISH;
...
void UObject::execQuatInvert _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STRUCT(FQuat, A);
	P_FINISH;
...
void UObject::execQuatRotateVector _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STRUCT(FQuat, A);
	P_GET_VECTOR(B);
	P_FINISH;
...
void UObject::execQuatFindBetween _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(A);
	P_GET_VECTOR(B);
	P_FINISH;
...
void UObject::execQuatFromAxisAndAngle _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_VECTOR(Axis);
	P_GET_FLOAT(Angle);
	P_FINISH;
...
void UObject::execQuatFromRotator _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_ROTATOR(A);
	P_FINISH;
...
void UObject::execQuatToRotator _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STRUCT(FQuat, A);
	P_FINISH;
...
void UObject::execQuatSlerp _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STRUCT(FQuat, A);
	P_GET_STRUCT(FQuat, B);
	P_GET_FLOAT(Alpha);
...
void UObject::execAdd_QuatQuat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STRUCT(FQuat, A);
	P_GET_STRUCT(FQuat, B);
	P_FINISH;
...
void UObject::execSubtract_QuatQuat _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STRUCT(FQuat, A);
	P_GET_STRUCT(FQuat, B);
	P_FINISH;
...
void UObject::execEatReturnValue _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execConcat_StrStr _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(A);
	P_GET_STR(B);
	P_FINISH;
...
void UObject::execAt_StrStr _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(A);
	P_GET_STR(B);
	P_FINISH;
...
void UObject::execLess_StrStr _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(A);
	P_GET_STR(B);
	P_FINISH;
...
void UObject::execGreater_StrStr _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(A);
	P_GET_STR(B);
	P_FINISH;
...
void UObject::execLessEqual_StrStr _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(A);
	P_GET_STR(B);
	P_FINISH;
...
void UObject::execGreaterEqual_StrStr _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(A);
	P_GET_STR(B);
	P_FINISH;
...
void UObject::execEqualEqual_StrStr _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(A);
	P_GET_STR(B);
	P_FINISH;
...
void UObject::execNotEqual_StrStr _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(A);
	P_GET_STR(B);
	P_FINISH;
...
void UObject::execComplementEqual_StrStr _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(A);
	P_GET_STR(B);
	P_FINISH;
...
void UObject::execConcatEqual_StrStr _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR_REF(A);
	P_GET_STR(B);
	P_FINISH;
...
void UObject::execAtEqual_StrStr _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR_REF(A);
	P_GET_STR(B);
	P_FINISH;
...
void UObject::execSubtractEqual_StrStr _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR_REF(A);
	P_GET_STR(B);
	P_FINISH;
...
void UObject::execLen _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(S);
	P_FINISH;
...
void UObject::execInStr _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(S);
	P_GET_STR(A);
...
void UObject::execMid _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(A);
	P_GET_INT(I);
...
void UObject::execLeft _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(A);
	P_GET_INT(N);
	P_FINISH;
...
void UObject::execRight _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(A);
	P_GET_INT(N);
	P_FINISH;
...
void UObject::execCaps _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(A);
	P_FINISH;
...
void UObject::execLocs _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(A);
	P_FINISH;
...
void UObject::execChr _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INT(i);
	P_FINISH;
...
void UObject::execAsc _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(S);
	P_FINISH;
...
void UObject::execRepl _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(Src);
	P_GET_STR(Match);
	P_GET_STR(With);
...
void UObject::execParseStringIntoArray _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execEqualEqual_NameName _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_NAME(A);
	P_GET_NAME(B);
	P_FINISH;
...
void UObject::execNotEqual_NameName _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_NAME(A);
	P_GET_NAME(B);
	P_FINISH;
...
void UObject::execEqualEqual_ObjectObject _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execNotEqual_ObjectObject _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_OBJECT(UObject,A);
	P_GET_OBJECT(UObject,B);
	P_FINISH;
...
void UObject::execEqualEqual_InterfaceInterface _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INTERFACE(A);
	P_GET_INTERFACE(B);
	P_FINISH;
...
void UObject::execNotEqual_InterfaceInterface _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_INTERFACE(A);
	P_GET_INTERFACE(B);
	P_FINISH;
...
void UObject::execLogInternal _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(S);
...
void UObject::execWarnInternal _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(S);
	P_FINISH;
...
void UObject::execLocalize _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
#define HIGH_NATIVE(n) \
	void UObject::execHighNative##n _ParamList_ScriptFunctionImpl /* 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL ) */ \
{ \
	BYTE B = *Stack.Code++; \
	(this->*GNatives[ n*0x100 + B ])( Stack, Result, 0x0, 0x0 ); \
} \
...
void UObject::execNew _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	// Get parameters.
...
void UObject::execClassIsChildOf _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execGotoState _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execPushState _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_NAME(newState);
...
void UObject::execPopState _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execDumpStateStack _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_FINISH;
	if (StateFrame != NULL &&
...
void UObject::execEnable _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_NAME(N);
...
void UObject::execDisable _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_NAME(N);
	P_FINISH;
...
void UObject::execSaveConfig _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_FINISH;
	SaveConfig();
}
...
void UObject::execStaticSaveConfig _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_FINISH;
...
void UObject::execGetPerObjectConfigSections _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execGetEnum _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
UBOOL GDoingExportDLO = FALSE;
TArray<UObject*> GDLOObjects;

void UObject::execDynamicLoadObject _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(Name);
	...
	INT OldNumObjects = GObjObjects.Num();	
#endif

	UObject* CreatedObject = StaticLoadObject( Class, NULL, *Name, NULL, LOAD_NoWarn | (bMayFail?LOAD_Quiet:0), NULL );

#if defined(LOG_DYNAMIC_LOAD_OBJECT) || LOOKING_FOR_PERF_ISSUES
	// 뭔가 로드 되었다!
	if (OldNumObjects != GObjObjects.Num())
	{
		debugf( NAME_PerfWarning, TEXT( "DynamicLoadObject is occurring for: %s"), *Name ); 
	}	
#endif

	if (CreatedObject && GDoingExportDLO)
	{
		GDLOObjects.AddUniqueItem( CreatedObject );
	}

	*(UObject**)Result = CreatedObject;
}
IMPLEMENT_FUNCTION( UObject, INDEX_NONE, execDynamicLoadObject );

void UObject::execFindObject _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_STR(Name);
	P_GET_OBJECT(UClass,Class);
	P_FINISH;
...
void UObject::execIsInState _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execIsChildState _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execGetStateName _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_FINISH;
...
void UObject::execGetFuncName _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_FINISH;
...
void UObject::execScriptTrace _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_GET_UBOOL_OPTX(bFuncCallStack, FALSE);
	P_GET_UBOOL_OPTX(bScriptBreak, FALSE);
	P_FINISH;

	//! function call stack 을 같이 출력한다.(2008/02/20 고광록)
#if ENABLE_SCRIPT_TRACING
	GScriptBreak = bScriptBreak;
	if ( bFuncCallStack )
		DumpScriptCallStack(*Stack.GetStackTrace());
	else
#endif
...
void UObject::execSetUTracing _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execIsUTracing _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	P_FINISH;
#if ENABLE_SCRIPT_TRACING
...
void UObject::execIsA _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execPathName _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::execIterator _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{}
IMPLEMENT_FUNCTION( UObject, EX_Iterator, execIterator );

void UObject::execDynArrayIterator _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
	// grab the array
	GPropObject = this;
	GProperty = NULL;
...
#define USE_USCRIPT_CALLSTACK_TRACE

#ifdef USE_USCRIPT_CALLSTACK_TRACE

#define MAX_CALLSTACK_DEPTH 1024
FName GUScriptCallStack[MAX_CALLSTACK_DEPTH*3];
INT GUScriptCallStackTop = 0;

void appScriptStackWalkAndDump( ANSICHAR* HumanReadableString )
{
	for (INT i=0; i<GUScriptCallStackTop; i+=3)
	{	
		if (i >= MAX_CALLSTACK_DEPTH*3)
		{
			strcat( HumanReadableString, "Stack overflow\r\n" );
		}
		else
		{
			FString Temp = FString::Printf( TEXT("%s, %s, %s\r\n"), *GUScriptCallStack[i].ToString(), *GUScriptCallStack[i+1].ToString(), *GUScriptCallStack[i+2].ToString() );		
			strcat( HumanReadableString, TCHAR_TO_ANSI( *Temp ) );
		}		
	}
}

void DumpScriptCallStack(const TCHAR *pStackTrace)
{
	const INT IgnoreCount = 3;
	FString Text;

	Text = FString::Printf(TEXT("dump script function call: depth(%d)\n"), GUScriptCallStackTop > 0 ? (GUScriptCallStackTop-IgnoreCount)/3 : 0);

	// ScriptTrace를 제외하기 위해서 (GUScriptCallStackTop-IgnoreCount)
	for (INT i=0; i<GUScriptCallStackTop-IgnoreCount; i+=3)
	{	
		if (i >= MAX_CALLSTACK_DEPTH*3)
		{
		...
		// (class), (object.name), (function)
		Text += FString::Printf( TEXT("\t%s, %s, %s\n"), GUScriptCallStack[i].GetName(), *GUScriptCallStack[i+1].ToString(), GUScriptCallStack[i+2].GetName() );
	}
	debugf(TEXT("%s%s"), *Text, pStackTrace != NULL ? pStackTrace : TEXT(""));
...
void UObject::CallFunction( FFrame& Stack, RESULT_DECL, UFunction* Function )
{
...
#ifdef USE_USCRIPT_CALLSTACK_TRACE
	if ( !(Function->FunctionFlags&FUNC_Operator) )
	{
		if (GUScriptCallStackTop < MAX_CALLSTACK_DEPTH * 3)
		{
			GUScriptCallStack[ GUScriptCallStackTop++ ] = GetClass()->GetFName();
			GUScriptCallStack[ GUScriptCallStackTop++ ] = GetFName();
			GUScriptCallStack[ GUScriptCallStackTop++ ] = Function->GetFName();
		}
	}	
#endif
	...
	if( Function->iNative )
	{
		...
		#ifdef EnableCipherData
		(this->*Function->Func)( Stack, Result, 0x0, 0x0 );
		#else
...
//
void UObject::ProcessInternal _ParamList_ScriptFunctionImpl // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL )
{
...
void UObject::ProcessEvent( UFunction* Function, void* Parms, void* UnusedResult )
{
	...
	// Scope required for scoped script stats.
	{
		...
		#ifdef EnableCipherData
		(this->*Function->Func)(NewStack, (BYTE*)Parms + Function->ReturnValueOffset, 0x0, 0x0);
		#else
