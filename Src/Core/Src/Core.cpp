...
TCHAR					GGPUIni[1024]					= TEXT("");					/* GPU ini file */
TCHAR					GNetIni[1024]					= TEXT("");					/* Net ini file */
...
// PerfHUD에 연결되면 기본을 TRUE로 변경
UBOOL					GEmitDrawEvents					= FALSE;

// PerfHUD 등이 연결되어 있을 때
UBOOL					GGPUPerfAnalyzerLoaded			= FALSE;
#endif
...
DECLARE_MEMORY_STAT2(TEXT("Irradiance Cache Memory"),STAT_IrradianceCacheMemory,STATGROUP_Memory, MCR_Physical, FALSE);
