...
// {{ 20070319 dEAthcURe|HM
//#ifdef EnableHostMigration // 비활성상태로둘것
#define CPF_HmSerialize				DECLARE_UINT64(0x0000002000000000)
//#endif // 비활성상태로둘것
// }} 20070319 dEAthcURe|HM

// {{ 20080218 dEAthcURe|CD
//#ifdef EnableCipherData // 비활성상태로둘것
#define CPF_Cipher                  DECLARE_UINT64(0x0000004000000000)
//#endif
// }} 20080218 dEAthcURe|CD
...
// {{ 20070202 dEAthcURe
#define UsePreloading <- 20070205 dEAthcURe 이걸 살리면 map preloading이 활성화됨

#ifdef UsePreloading
#define RF_Preload					DECLARE_UINT64(0x8000000000000000) // [+] 20070201 dEAthcURe
#endif
// }} 20070202 dEAthcURe
...
class UObject
{
	...
	static INT GhmId; // 20070731 dEAthcURe|HM todo: actor hmIdx에도 적용할것
	static TArray<UObject*>			GObjObjects; // dEAthcURe|HM
...
public:
	...
	// {{ 20070202 dEAthcURe
	#ifdef UsePreloading
	static void clearPreloadFlag(void);
	#endif
	// }} 20070202 dEAthcURe
...
public :
	...
	*/
	...
	void ProcessInternal _ParamList_ScriptFunctionDef; // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL, UProperty* pPropertyLefthand = 0x0, BYTE* pPropAddrLefthand = 0x0);
	...
	#define DECLARE_FUNCTION(func) void func _ParamList_ScriptFunctionDef // 20080221 dEAthcURe|CD // ( FFrame& Stack, RESULT_DECL, UProperty* pPropertyLefthand = 0x0, BYTE* pPropAddrLefthand = 0x0 )
