...
enum EBulkDataFlags
{
	...
	BULKDATA_SerializeCompressed				= (BULKDATA_SerializeCompressedZLIB | BULKDATA_SerializeCompressedLZO),
...
struct FUntypedBulkData
{
	...
	friend class UCookedBulkDataInfoContainer;
...
private:
	...
	/**
	 * Serialization helper - BulkSerialize invokes this operator
	 */
	friend FArchive& operator<<( FArchive& Ar, FUntypedBulkData& BulkData )
	{
		BulkData.Serialize( Ar, NULL );
		return Ar;
	}
