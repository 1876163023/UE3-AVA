...
/** Turning this on enables the hardware intrinsic code path in the engine.
When set to 0, a pure C++ FPU implementation is used instead. */
...
#elif WITH_D3DX
			D3DXVec3Minimize( (D3DXVECTOR3*)&Min, (const D3DXVECTOR3*)&Min, (const D3DXVECTOR3*)&Other );
			D3DXVec3Maximize( (D3DXVECTOR3*)&Max, (const D3DXVECTOR3*)&Max, (const D3DXVECTOR3*)&Other );
#else
...
#elif WITH_D3DX
			D3DXVec3Minimize( (D3DXVECTOR3*)&Min, (const D3DXVECTOR3*)&Min, (const D3DXVECTOR3*)&Other.Min );
			D3DXVec3Maximize( (D3DXVECTOR3*)&Max, (const D3DXVECTOR3*)&Max, (const D3DXVECTOR3*)&Other.Max );
#else
...
public:
	...
	{
		FP32Value = (FP32Value >= -KINDA_SMALL_NUMBER && FP32Value <= KINDA_SMALL_NUMBER) ? 0 : FP32Value;
