...
struct FFileIOStats
{
	 ...
	 */
	void AddRequest( INT StatsHandle, INT Size, INT Offset, DOUBLE Duration, EFileIOType RequestType );
...
protected:
	 ...
	 */
	void DumpSummary( const FFileIOSummary& Summary, SIZE_T FileSize );
...
struct FScopedFileIORequestStats
{
	...
	FScopedFileIORequestStats( INT InStatsHandle, INT InSize, INT InOffset, EFileIOType InRequestType )
