...
#include "Licensee/BaseInclude.h"
...
/**
 * DO_GUARD_SLOW is enabled for debug builds which enables checkSlow, debugfSlow, ...
 **/
#ifdef _DEBUG
...
/**
 * Whether to use the novodex physics engine.
 **/
#ifndef WITH_NOVODEX
...
#ifndef USE_NULL_RHI // allow project settings to override
...
#define WITH_SPEEDTREE (EPIC_INTERNAL && !CONSOLE)
#endif
...
#define SUPPORT_SUPPRESSED_LOGGING _DEBUG
#endif
