...
#ifdef UsePreloading
#define GARBAGE_COLLECTION_KEEPFLAGS	(GIsEditor ? RF_Native | RF_Standalone : RF_Native | RF_Preload) // 20070205 dEAthcURe
#else
...
struct FGCReferenceTokenStream
{
	 ...
	 */
	void AddStream( const FGCReferenceTokenStream& Other );
