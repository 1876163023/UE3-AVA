 ...
 * part of Text.
 */
static final function string Split(coerce string Text, coerce string SplitStr)
{
	local int pos;
...
/**
 * Returns the simple name of the specified object, ie CheckObject::GetName().
 */
...
native static final function ScriptTrace( optional bool bFuncCallStack, optional bool bScriptBreak );
