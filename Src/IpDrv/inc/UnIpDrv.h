...
#if _MSC_VER
#if XBOX
	#define SOCKET_API TEXT("XeWinSock")
#else
...
#ifndef XBOX
	#include <winsock2.h> // 20060916 dEAthcURe #include <winsock.h> 
	#include <mswsock.h> // 20060916 
	#include <conio.h>
#endif
#endif
...
/** Network communication between UE3 executable and the "Unreal Remote" tool. */
extern class FDebugCommunication*		GDebugComm;
...
#include "DebugCommunication.h"			// FDebugCommunication defs
