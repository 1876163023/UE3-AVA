...
#else
	// UnrealEngine3 Bump Basis
	const Vector g_localBumpBasis[NUM_BUMP_VECTS] = {
		Vector( 0.0f, 0.81649661064147949f, OO_SQRT_3 ),
		Vector( -0.7071068286895752f,  -0.40824821591377258f, OO_SQRT_3 ),
		Vector( 0.70710676908493042f,  -0.40824833512306213f, OO_SQRT_3 )	
	};
#endif
