...
#define MAX_DISP_LIGHTMAP_DIM_WITHOUT_BORDER	1024
#define MAX_DISP_LIGHTMAP_DIM_INCLUDING_BORDER	1027
//!} 2006-05-03	Çã Ã¢ ¹Î
...
//#define	MAX_MAP_TEXINFO		32288
#define	MAX_MAP_TEXINFO		200000
...
#define	MAX_MAP_VERTS				( 300000 )
#define MAX_MAP_VERTNORMALS			( 300000 ) 
#define MAX_MAP_VERTNORMALINDICES	( 300000 )

//#define	MAX_MAP_FACES		65536
#define MAX_MAP_FACES		( INT_MAX )
//!} 2006-04-27	Çã Ã¢ ¹Î
...
#define	MAX_MAP_EDGES		600000
#define	MAX_MAP_SURFEDGES	600000
//!} 2006-05-03	Çã Ã¢ ¹Î
...
enum emittype_t
{
	...
	//!{ 2006-04-06	Çã Ã¢ ¹Î
	emit_ue3point,		// unreal pointlight
	emit_ue3spot,
	//!} 2006-04-06	Çã Ã¢ ¹Î
	//!{ 2006-07-26	Çã Ã¢ ¹Î
	emit_hdrEnvmapSkylight,
	emit_hdrEnvmapHotspots,
	//!} 2006-07-26	Çã Ã¢ ¹Î
};
