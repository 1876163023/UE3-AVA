...
extern	CUtlVector<byte> dlightdata;		// light map
extern	CUtlVector<byte> dlightdata2;		// light map - sun direct light
extern	CUtlVector<byte> bouncedlightdata;	// bouncing sample
extern	CUtlVector<byte> dshadowdata;

//!{ 2006-05-12	Çã Ã¢ ¹Î
// input
extern	int					num_blackmesh_vertexes;
extern	CUtlVector<Vector>	blackmesh_vertexes;
extern	CUtlVector<Vector>	blackmesh_tangent_x;
extern	CUtlVector<Vector>	blackmesh_tangent_y;
extern	CUtlVector<Vector>	blackmesh_tangent_z;

// temporary
extern	CUtlVector<Vector>	blackmesh_vertexlight_float_vector_data;
extern	CUtlVector<Vector>	blackmesh_realtime_vertexlighting;
extern	CUtlVector<Vector>	blackmesh_bouncing_data;
extern	CUtlVector<float>	blackmesh_vertexlight_weight_data;


// output
extern	CUtlVector<byte>	blackmesh_vertexlightdata;		// size = rgbe(=4) * numbumpvect(=4) * numvertices
extern	CUtlVector<byte>	blackmesh_worldvertexlightdata;		// size = rgbe(=4) * numbumpvect(=4) * numvertices
//!} 2006-05-12	Çã Ã¢ ¹Î
...
extern	CUtlVector<dplane_t>	dplanes;

extern	int			    numvertexes;
//extern	dvertex_t	    dvertexes[MAX_MAP_VERTS];
extern	CUtlVector<dvertex_t>	dvertexes;
...
extern	CUtlVector<int>	g_vertnormalindices;

extern	int				g_numvertnormals;	
//extern	Vector			g_vertnormals[MAX_MAP_VERTNORMALS];
extern	CUtlVector<Vector>	g_vertnormals;
...
extern	CUtlVector<dtexdata_t>	dtexdata;
...
extern	CUtlVector<dface_t>	dorigfaces;
...
extern	CUtlVector<dface_t>	dfaces;

extern	int			    numedges;
//extern	dedge_t		    dedges[MAX_MAP_EDGES];
extern	CUtlVector<dedge_t>	dedges;
...
extern	CUtlVector<int>	dsurfedges;
