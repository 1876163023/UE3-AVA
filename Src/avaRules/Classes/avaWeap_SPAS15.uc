class avaWeap_SPAS15 extends avaWeap_BaseRifle;
...
defaultproperties
{
	...
	Kickback_WhenMoving = (UpBase=9.84,LateralBase=1.44,UpModifier=0.6,LateralModifier=1.8,UpMax=26.4,LateralMax=7.2,DirectionChange=3)
	Kickback_WhenFalling = (UpBase=12.3,LateralBase=1.8,UpModifier=0.75,LateralModifier=2.25,UpMax=33,LateralMax=9,DirectionChange=3)
	Kickback_WhenDucking = (UpBase=6.56,LateralBase=0.96,UpModifier=0.4,LateralModifier=1.2,UpMax=17.6,LateralMax=4.8,DirectionChange=3)
	Kickback_WhenSteady = (UpBase=8.2,LateralBase=1.2,UpModifier=0.5,LateralModifier=1.5,UpMax=22,LateralMax=6,DirectionChange=3)
	...
	Spread_WhenFallingA = (param1=-0.0305,param2=0.17)
	Spread_WhenMovingA = (param1=-0.0305,param2=0.17)
	Spread_WhenDuckingA = (param1=-0.0305,param2=0.17)
	Spread_WhenSteadyA = (param1=-0.0305,param2=0.17)
