class avaWeap_Glock extends avaWeap_BasePistol;

// GLOCK21c 경찰용, 약하고 사용이 용이한 총으로 수정
...
defaultproperties
{
	...
	Kickback_WhenMoving = (UpBase=3,LateralBase=0.6,UpModifier=0.54,LateralModifier=0.36,UpMax=14.4,LateralMax=4.8,DirectionChange=3)
	Kickback_WhenFalling = (UpBase=3.75,LateralBase=0.75,UpModifier=0.675,LateralModifier=0.45,UpMax=18,LateralMax=6,DirectionChange=3)
	Kickback_WhenDucking = (UpBase=2,LateralBase=0.4,UpModifier=0.36,LateralModifier=0.24,UpMax=9.6,LateralMax=3.2,DirectionChange=3)
	Kickback_WhenSteady = (UpBase=2.5,LateralBase=0.5,UpModifier=0.45,LateralModifier=0.3,UpMax=12,LateralMax=4,DirectionChange=3)
