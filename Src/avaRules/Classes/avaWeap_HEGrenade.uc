class avaWeap_HEGrenade extends avaWeap_Grenade;
...
defaultproperties
{
	...
	AttachmentClass=class'avaAttachment_HEGrenade'

	WeaponProjectiles(0)=class'avaProj_HEGrenade'
	WeaponProjectiles(1)=class'avaProj_HEGrenade'
