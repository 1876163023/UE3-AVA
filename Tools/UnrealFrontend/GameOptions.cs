...
namespace UnrealFrontend
{
    ...
    public class NumericUpDownGameOption : GameOption
    {
        protected NumericUpDown Control;

        public NumericUpDownGameOption( NumericUpDown InCheckBox, GameOption.EOptionType InType, string InOptionName, int DefaultValue )
            : base( InOptionName, InType )
        {
            // keep a ref to the control
            Control = InCheckBox;
