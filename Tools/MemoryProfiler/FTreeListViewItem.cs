...
namespace MemoryProfiler
{
	...
	public class FTreeListViewItem
	{
		...
		public class FTreeListViewItemNodeCollection : IList<FTreeListViewItem>
		{
			...
			/**
			 * Initializes the relevent fields of an item that has just been added to the collection.
			 * 
			...
			/**
			 * Clears the relevent fields of an item that has been removed from the collection.
			 * 
