<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UTPC.aspx.cs" Inherits="UTPC" Debug="true" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Trigger a UT Build from the PC branch</title>
</head>
<body>
...
<center>
    ...
    <div>
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="XX-Large"
            Height="56px" Text="Epic Build System - Trigger Cook" Width="640px" ForeColor="Blue"></asp:Label><br /><br />
        ...
        <br />
            ...
            <SelectParameters>
            <asp:QueryStringParameter Name="MinAccess" Type="Int32" DefaultValue="13000" />
            <asp:QueryStringParameter Name="MaxAccess" Type="Int32" DefaultValue="13600" />
            </SelectParameters>
            </asp:SqlDataSource>
...
<asp:QueryStringParameter Name="DisplayDetailID" Type="Int32" DefaultValue="500" />
</SelectParameters>
 </asp:SqlDataSource>
