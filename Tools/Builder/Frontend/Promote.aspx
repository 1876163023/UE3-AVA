...
<center>
    ...
    <div>
        <asp:Label ID="Label_Title" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="XX-Large"
            Height="56px" Text="Epic Build System - Promote Build" Width="640px" ForeColor="Blue"></asp:Label><br /><br />
        ...
        <br />
            ...
            Height="36px" Text="Promote Build from UnrealEngine3 branch" Width="640px" ForeColor="BlueViolet"></asp:Label>
          <table>
        ...
        <asp:Repeater ID="ChildRepeater" runat="server" DataSource=<%# ( ( DataRowView )Container.DataItem ).Row.GetChildRows( "PseudoRelation" ) %> OnItemCommand="BuilderDBRepeater_PromoteItemCommand_UE3" >
			<itemtemplate>
                ...
                <asp:Label ID="Label_Subtitle2" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="X-Large"
            Height="36px" Text="Promote Build from UnrealEngine3-Delta branch" Width="640px" ForeColor="BlueViolet"></asp:Label>

        <table>
        <asp:Repeater ID="UnrealEngine3DeltaRepeater" runat="server">
        <ItemTemplate>
        <tr><td>
        <asp:Label ID="Label" runat="server" Font-Bold="True" Height="26px" ForeColor="Blue" Text=<%# DataBinder.Eval(Container.DataItem, "[\"BuildLabel\"]") %> Width="384px" />
        </td><td>
       
        <asp:Repeater ID="ChildRepeater" runat="server" DataSource=<%# ( ( DataRowView )Container.DataItem ).Row.GetChildRows( "PseudoRelation" ) %> OnItemCommand="BuilderDBRepeater_PromoteItemCommand_UE3Delta" >
			<itemtemplate>
                <asp:Button ID="Button_Promote" runat="server" Font-Bold="True" Height="26px" ForeColor="DarkGreen" Width="224px" 
                CommandName=<%# DataBinder.Eval(Container.DataItem, "[\"CommandID\"]") %>
                CommandArgument=<%# DataBinder.Eval(Container.DataItem, "[\"BuildLabel\"]") %>
