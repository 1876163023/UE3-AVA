...
namespace Controller
{
    class LabelInfo
    {
        ...
        private bool LocalValidLabel = false;
        public bool ValidLabel
        {
            get { return ( LocalValidLabel ); }
            set { LocalValidLabel = value; }
        }
        ...
        public void CreateLabelDescription()
        {
            ...
            DescriptionBuilder.Append( "[BUILDER] '" + BuildType + "' built from changelist: " + Changelist.ToString() + "\r\n\r\n" );

            DescriptionBuilder.Append( "Engine version: " + BuildVersion.Build.ToString() + "\r\n\r\n" );

            DescriptionBuilder.Append( "Configurations built:\r\n" );
            if( Games.Count > 0 )
            {
                ...
                {
                    DescriptionBuilder.Append( "\t" + Config.ToString() + "\r\n" );
                }
            }
            else
            {
            ...
            DescriptionBuilder.Append( "\r\nVisual Studio version: " + Parent.MSVCVersion + " with DirectX " + Parent.DXVersion + "\r\n" );
            DescriptionBuilder.Append( "\r\nXDK version: " + Parent.XDKVersion + " and PS3 SDK: " + Parent.PS3SDKVersion + " were used.\r\n" );
        ...
        public void Init( P4 SCC, ScriptParser Builder )
        {
            ...
            {
                Parent.Log( "Label '" + GetLabelName() + "' failed to be successfully created.", Color.Red );
            }
        }
    }
}
