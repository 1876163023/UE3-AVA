...
call C:\Build_UE3\UnrealEngine3\binaries\%1.com precompileshaders platform=pc_sm2 -refcache -unattended -skipmaps -ALLOW_PARALLEL_PRECOMPILESHADERS -forceshadermodel2 LOG=Launch.log
