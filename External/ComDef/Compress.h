...
unsigned short compress_rle   (unsigned char *source, unsigned char *dest, unsigned short source_size);
unsigned short expand_rle     (const unsigned char *source, unsigned char *dest, unsigned short source_size);
void xor_extract (const unsigned char * in_buf1,const unsigned char * in_buf2, int in_size, unsigned char * out_buf);
